\begin{textsample}{NEG Dim 2 – 2002 – Score 1.00 – 2002/t000426.txt}  \label{ex:f2_neg_041}
What I want to talk about is, as background, is the idea that cars are art.
This is actually quite meaningful to me, because car designers tend to be a little bit low on the totem pole â we don ' t do coffee table books with just one lamp inside of it â and cars are thought so much as a product that it ' s a little bit difficult to get into the aesthetic side under the same sort of terminology that one would discuss art.
And so cars, as art, brings it into an emotional plane â if you accept that â that you have to deal with on the same level you would with art with a capital A.
...
We have to solve the pollution, we have to solve the congestion â but that ' s not what interests me in this speech.
What interests me in this speech is cars.
Automobiles may be what you use, but cars are what we are, in many ways.
And as long as we can solve the problems of automobiles, and I believe we can, with fuel cells or hydrogen, like BMW is really hip on, and lots of other things, then I think we can look past that and try and understand why this hook is in many of us â of this car-y-ness â and what that means, what we can learn from it.
That ' s what I want to get to.
Cars are not a suit of clothes ; cars are an avatar.
Cars are an expansion of yourself : they take your thoughts, your ideas, your emotions, and they multiply it â your anger, whatever.
It ' s an avatar.
...
Cars are a sculpture â did you know this?
...
And that tension, that discovery, that push for something new â and at the same time, that sense of obligation to the regards of craftsmanship â that ' s as strong in cars as it is in anything.
...
Real quickly â Michelangelo once said he ' s there to"discover the figure within,"OK?
There we go, the automobile.
That was 100 years right there â did you catch that?
...
Now this little quote about sculpture from Henry Moore, I believe that that"pressure within"that Moore ' s talking about â at least when it comes to cars â comes right back to this idea of the mean.
...
That ' s what we ' re searching for â when we ' re working our craft, we are really trying to find that truth out there.
...
We ' ve pretty much accepted the fact, though, that we are the women in the organization at BMW â BMW is a very manly type business, â men, men, men ; it ' s engineers.
...
Toothbrush, cool.
It really only gets serious when you look at something like this.
OK?
...
We have to have a shared intimacy, a shared vision â that means we have to work as one family ; we have to understand ourselves that way.
...
We have a shared center ; we have a shared focus â that car stays at the middle of all our relationships.
...
Now many people know Deep Blue from IBM â we actually stole it from them because we figured if anybody read our faxes they ' d think we ' re talking about computers.
It turned out it was quite clever because Deep Blue, in a company like BMW, has a hook â"Deep Blue,"wow, cool name.
...
Then they would work apart, come together, and they would produce together a monumental set of diverse opinions that didn ' t pollute each other ' s ideas â but at the same time came together and resolved the problems.
Hopefully, really understand the customer at its heart, where the customer is, live with them in America.
So â sent the team off, and actually something different happened.
...
And â at least they told me it was her house, I guess it was at one time, she had a party there or something.
But anyway, this was the house, and they all lived there.
Now this is 24 / 7 living, half-a-dozen people who ' d left their â some had left their wives behind and families behind, and they literally lived in this house for the entire six months the project was in America, but the first three months were the most intensive.
And one of the young women in the project, she was a fantastic lady, she actually built her room in the bathroom.
The bathroom was so big, she built the bed over the bathtub â it ' s quite fascinating.
On the other hand, I didn ' t know anything about this.
OK?
Nothing.
...
So my concept of what a design studio was probably â I wasn ' t up to speed on where these guys were.
...
Well, what I didn ' t know was, and what we found out was â these guys, they can ' t even like talk to each other under those conditions.
...
And so we had our first meeting, after three months, in Tiburon, which is just up the road from here â you know Tiburon?
And the idea was after the first three months of this independent research they would present it all to Dr.
Goschel â who is now my boss, and at that time he was co-mentor on the project â and they would present their results.
...
I mean, I ' m going to see so much work, it ' s so intense â I know probably Las Vegas meant a lot about it, and I ' m not really sure where the Grand Canyon came in either â but somehow all this is going to come together, and I ' m going to see some really great product.
...
And they hadn ' t done anything because â kind of, like in car business, engineers are there to solve problems, and we were asking them to create a problem.
...
And the engineers told the designers,"If you go in with all your stuff, we ' ll walk out, we ' ll walk right out of the project."So I didn ' t know any of this, and we got a presentation that had an agenda, looked like this.
...
Because of course they didn ' t tell us that they had three station wagons full of drawings, model concepts, pictures â everything I wanted, they ' d locked up in the cars, because they had shown solidarity with the engineers â and they ' d decided not to show me anything, in order to give the chance for problem solving a chance to start, because they hadn ' t realized, of course, that they couldn ' t do problem creating.
So we went to lunch â And I ' ve got to tell you, this was one seriously quiet lunch.
...
This cannot be."So I told them this story.
...
One of those was the idea of a crossover coupes â you see it downstairs, the X Coupe â they had a lot of fun with that.
