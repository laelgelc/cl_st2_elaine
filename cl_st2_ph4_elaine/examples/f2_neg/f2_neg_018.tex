\begin{textsample}{NEG Dim 2 – 2003 – Score 1.00 – 2003/t000319.txt}  \label{ex:f2_neg_018}
...
This is just a road.
And it ' s not very big : it ' s about 250 meters on one side, 400 on the other.
...
Does it matter to the midden workers what the patrollers are doing?"And I was working in the context of a view of ant colonies in which each ant was somehow dedicated to its task from birth and sort of performed independently of the others, knowing its place on the assembly line.
And instead I wanted to ask,"How are the different task groups interdependent?"So I did experiments where I changed one thing.
...
And what I wanted to know was,"OK, here ' s a situation where extra nest maintenance workers were recruited — is this going to have any effect on the workers performing other tasks?"Then we repeated all those experiments with the ants marked.
...
I know that they don ' t do that.
...
The simplest idea is that when an ant is in a small colony — and an ant in a large colony can use the same rule, like"I expect to meet another forager every three seconds."But in a small colony, it ' s likely to meet fewer foragers, just because there are fewer other foragers there to meet.
