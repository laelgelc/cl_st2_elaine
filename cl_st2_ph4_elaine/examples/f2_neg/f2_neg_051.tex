\begin{textsample}{NEG Dim 2 – 2017 – Score 1.00 – 2017/t002693.txt}  \label{ex:f2_neg_051}
...
All of our thoughts and actions these days, through photos and videos â even our fitness activities â are stored as digital data.
...
One of those is Ătzi the Iceman.
Turns out, he ' s Austrian.
He was found high, well-preserved, in the mountains between Italy and Austria, and it turns out that he has living genetic relatives here in Austria today.
So one of you could be a cousin of Ătzi.
...
We also included a \$50 Amazon gift card â don ' t get too excited, it ' s already been spent, someone decoded it â as well as an operating system, one of the first movies ever made and a Pioneer plaque.
Some of you might have seen this.
It has a depiction of a typical â apparently â male and female, and our approximate location in the Solar System, in case the Pioneer spacecraft ever encounters extraterrestrials.
...
Writing and reading data from DNA is obviously a lot more time-consuming than just saving all your files on a hard drive â for now.
...
Instead of asking the current generation â us â what might be important in the future, we could store everything in DNA.
