\begin{textsample}{NEG Dim 3 – 2002 – Score -2.00 – 2002/t000269.txt}  \label{ex:f3_neg_007}
Welcome.
...
So, the answer is \textbf{bio-mimicry} : just copy nature directly.
...
It ' s a see-through treadmill with a see-through treadmill belt, so we can watch the animal ' s feet, and \textbf{videotape} them through the treadmill belt, to see how they move.
...
It can do this in 14 \textbf{milliseconds}.
It ' s unbelievable.
...
% matched lemmas: bio-mimicry, millisecond, videotape
\end{textsample}
