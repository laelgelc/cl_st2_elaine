\begin{textsample}{NEG Dim 3 – 2005 – Score -2.00 – 2005/t000437.txt}  \label{ex:f3_neg_036}
...
But we ' d like to know the synthesis \textbf{symbolized} at the very top.
The micro-world of the quantum is understood.
On the right hand side, gravity holds sway.
Einstein explained that.
But the unfinished business for 21st-century science is to link together cosmos and micro-world with a unified theory — \textbf{symbolized}, as it were, gastronomically at the top of that picture.
...
There ' s one challenge \textbf{symbolized} at the top, but there ' s another challenge to science \textbf{symbolized} at the bottom.
...
On that \textbf{schematic} picture, a sort of time-lapse picture, we ' re halfway.
...
We ' ve been familiar for 40 years with this image : the fragile beauty of land, ocean and clouds, contrasted with the \textbf{sterile} moonscape on which the astronauts left their footprints.
...
% matched lemmas: schematic, sterile, symbolize
\end{textsample}
