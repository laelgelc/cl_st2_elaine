\begin{textsample}{NEG Dim 3 – 2010 – Score -3.00 – 2010/t002839.txt}  \label{ex:f3_neg_025}
...
But I know it when I see it."I ' m going to come back to that in a moment.
...
But also, by the way, the coffee is hot, the liquid is \textbf{sterile} ; you ' re not likely to get cholera that way.
...
But our friends who are condensed matter physicists managed to come up, some 50 years ago, with a very nice device, shown under that bell jar, which is a \textbf{transistor}.
A \textbf{transistor} is nothing more than a wall switch.
...
So the second layer of simplicity was the \textbf{transistor} in the Internet.
So, since the \textbf{transistor} is so simple, you can put lots of them together.
And you put lots of them together and you come with something called integrated circuits.
And a current integrated circuit might have in each one of these chips something like a billion \textbf{transistors}, all of which have to work perfectly every time.
...
In Boston...
Boston is a little bit like Namibia in its cell phone coverage, so that we ' re not accustomed to that all the time, but some of the time.
...
All right, let me then finish off with four general statements, an example and two \textbf{aphorisms}.
...
There ' s no way of predicting the Internet based on the first \textbf{transistor}.
...
Part of my interest in this, I have to say, is that I would like to — how do I put this politely? — change the way, or maybe eviscerate, the capital structure of the U.
S. health care system, which I think is fundamentally broken.
So, let me close — Let me close with my two \textbf{aphorisms}.
One of them is from Mr.
Einstein, and he says,"Everything should be made as simple as possible, but not simpler."And I think that ' s a very good way of thinking about the problem.
...
No.
CA : That was a simple, powerful answer.
GW : Yes.
...
I mean, the systems work, and we have to find out how to manufacture them and do things of this kind, but the basic technology works.
...
% matched lemmas: aphorism, sterile, transistor
\end{textsample}
