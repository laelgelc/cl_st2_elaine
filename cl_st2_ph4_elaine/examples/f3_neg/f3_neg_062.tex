\begin{textsample}{NEG Dim 3 – 2022 – Score -1.00 – 2022/t003585.txt}  \label{ex:f3_neg_062}
...
Now picture trying to make that snowman when the ball of snow is as big as you are and you ' re standing on your head.
...
The latency, or the time it takes for a dragonfly to respond once it sees the prey turn, is about 50 \textbf{milliseconds}.
...
It takes a single neuron about 10 \textbf{milliseconds} to add up all its inputs and respond.
