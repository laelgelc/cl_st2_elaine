\begin{textsample}{NEG Dim 3 – 2008 – Score -2.00 – 2008/t000283.txt}  \label{ex:f3_neg_020}
You know, I ' ve talked about some of these projects before â about the human genome and what that might mean, and discovering new sets of genes.
...
Now we ' re trying to ask,"Can we regenerate life or can we create new life out of this digital universe?"This is the map of a small organism, Mycoplasma genitalium, that has the smallest genome for a species that can self-replicate in the laboratory, and we ' ve been trying to just see if we can come up with an even smaller genome.
We ' re able to knock out on the order of 100 genes out of the 500 or so that are here.
When we look at its metabolic map, it ' s relatively simple compared to ours â trust me, this is simple â but when we look at all the genes that we can knock out one at a time, it ' s very unlikely that this would yield a living cell.
...
There are tens of thousands of machines around the world that make small pieces of DNA â 30 to 50 letters in length â and it ' s a degenerate process, so the longer you make the piece, the more errors there are.
...
But we wanted to go much larger : we wanted to build the entire bacterial chromosome â it ' s over 580, 000 letters of genetic code â so we thought we ' d build them in cassettes the size of the viruses so we could actually vary the cassettes to understand what the actual components of a living cell are.
...
Think of this : we have a four- letter genetic code â A, C, G and T.
...
When we get into these really large pieces over 100, 000 base pairs, they won ' t any longer grow readily in E. coli â it exhausts all the modern tools of molecular biology â and so we turned to other mechanisms.
We knew there ' s a mechanism called homologous \textbf{recombination} that biology uses to repair DNA that can put pieces together.
Here ' s an example of it : there ' s an organism called Deinococcus radiodurans that can take three millions \textbf{rads} of radiation.
...
We purified a chromosome from one microbial species â roughly, these two are as distant as human and mice â we added a few extra genes so we could select for this chromosome, we digested it with enzymes to kill all the proteins, and it was pretty stunning when we put this in the cell â and you ' ll appreciate our very sophisticated graphics here.
...
We use over five billion tons of coal, 30 billion-plus barrels of oil â that ' s a hundred million barrels a day.
...
Sunlight and CO2 is one method... but in our discovery around the world, we have all kinds of other methods.
...
So, in a short period of time, we think that we might be able to increase what the basic question is of"What is life?"We truly, you know, have modest goals of replacing the whole petrol-chemical industry â Yeah.
If you can ' t do that at TED, where can you? â become a major source of energy...
...
% matched lemmas: rad, recombination
\end{textsample}
