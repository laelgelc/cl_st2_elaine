\begin{textsample}{NEG Dim 3 – 2005 – Score -3.00 – 2005/t000427.txt}  \label{ex:f3_neg_034}
...
We started in Bermuda for our test project, then moved up to Halifax, working down the U.
S.
East Coast, the Caribbean Sea, the Panama Canal, through to the Galapagos, then across the Pacific, and we ' re in the process now of working our way across the Indian Ocean.
...
We filter through some simple \textbf{apparatuses} ; we collect on the order of a billion microbes from just a day filtering on top of a building in New York City.
...
People immediately jump to concerns about biological warfare, and I had recent testimony before a Senate committee, and a special committee the U.
S. government has set up to review this area.
...
And there ' s only two countries, the U.
S. and the former Soviet Union, that had major efforts on trying to create biological warfare agents.
...
We start with these fragments, and then we have a homologous \textbf{recombination} system that reassembles those into a chromosome.
This is derived from an organism, deinococcus radiodurans, that can take three million \textbf{rads} of radiation and not be killed.
...
This is a glass beaker after about half a million \textbf{rads} of radiation.
The glass started to burn and crack, while the microbes sitting in the bottom just got happier and happier.
Here ' s an actual picture of what happens : the top of this shows the genome after 1. 7 million \textbf{rads} of radiation.
...
Within a short while, I think there ' s going to be a new field called"Combinatorial Genomics,"because with these new synthesis capabilities, these vast gene array repertoires and the homologous \textbf{recombination}, we think we can design a robot to make maybe a million different chromosomes a day.
...
% matched lemmas: apparatus, rad, recombination
\end{textsample}
