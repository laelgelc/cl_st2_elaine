\begin{textsample}{NEG Dim 3 – 2013 – Score -2.00 – 2013/t002101.txt}  \label{ex:f3_neg_031}
...
A lot of people say,"I really don ' t know what people are going to pick, so I think the average will be 50."They ' re not being really strategic at all."And I ' ll pick two-thirds of 50.
...
And these are all areas which are fairly reliably known to be part of what ' s called a"theory of mind"circuit, or"mentalizing circuit."That is, it ' s a circuit that ' s used to imagine what other people might do.
...
So the uninformed player ' s challenge is to say,"Is this guy really being fair or are they giving me a very low offer in order to get me to think that there ' s only one or two dollars available to split?"in which case they might reject it and not come to a deal.
...
Very complicated.
The right brain \textbf{schematic} is the uninformed person, and the left is the informed.
...
That is, the informed brain seems to be deciding,"We ' re probably not going to make a deal here."And then later there ' s activity in the uninformed brain.
...
The chimp is going to see, watch carefully, they ' re going to see 200 \textbf{milliseconds} ' exposure — that ' s fast, that ' s eight movie frames — of numbers one, two, three, four, five.
...
You can see they ' re very blas{\EmojiFont �}{\EmojiFont �} and kind of effortless.
...
% matched lemmas: millisecond, schematic
\end{textsample}
