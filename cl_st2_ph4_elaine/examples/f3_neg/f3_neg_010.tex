\begin{textsample}{NEG Dim 3 – 2003 – Score -5.00 – 2003/t000364.txt}  \label{ex:f3_neg_010}
...
As a youngster, I was very interested in model airplanes, \textbf{ornithopters}, autogyros, helicopters, gliders, power planes, indoor models, outdoor models, everything, which I just thought was a lot of fun, and wondered why most other people didn ' t share my same enthusiasm with them.
And then, navy pilot training, and, after college, I got into \textbf{sailplane} flying, power plane flying, and considered the \textbf{sailplanes} as a sort of hobby and fun, but got tangled up with some great professor types, who convinced me and everybody else in the field that this was a good way to get into really deep science.
...
We realized that if you just cleaned up our \textbf{Gossamer} Condor a little bit, the power to fly would be decreased a little bit, and if you decrease the power required a little, the pilot can fly a much longer period of time.
And Brian Allen was able, in a miraculous flight, to get the \textbf{Gossamer} Albatross across the English Channel, and we won the 100, 000-pound, 200, 000-dollar prize for that.
...
Narrator : With a wingspan of 247 feet, this makes her larger than a Boeing 747.
...
With \textbf{on-board} GPS, it can navigate autonomously, and it is rugged enough to self-land without damage.
...
We ' re going to end our visit with Paul MacCready ' s flying circus by meeting his son, Tyler, who, with his two brothers, helped build the \textbf{Gossamer} Condor, 25 years ago.
...
% matched lemmas: gossamer, on-board, ornithopter, sailplane
\end{textsample}
