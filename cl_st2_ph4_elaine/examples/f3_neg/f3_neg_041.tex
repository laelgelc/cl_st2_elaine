\begin{textsample}{NEG Dim 3 – 2007 – Score -1.00 – 2007/t000229.txt}  \label{ex:f3_neg_041}
The Internet, the Web as we know it, the kind of Web â the things we ' re all talking about â is already less than 5, 000 days old.
...
And if I told you it was all coming for free, you would say, this is simply â you ' re dreaming.
...
And so one of the things that I think we ' re learning â if you think about, like, Wikipedia, it ' s something that was simply impossible.
...
So, I have a kind of a simple story, and it suggests that what we want to think about is this thing that we ' re making, this thing that has happened in 5, 000 days â that ' s all these computers, all these handhelds, all these cell phones, all these laptops, all these servers â basically what we ' re getting out of all these connections is we ' re getting one machine.
...
And there ' s almost no other machine that we ' ve ever made that runs the number of hours, the number of days. 5, 000 days without interruption â that ' s just unbelievable.
...
So here ' s the specifications, just as if you were to make up a spec sheet for it : 170 quadrillion \textbf{transistors}, 55 trillion links, emails running at two \textbf{megahertz} itself, 31 kilohertz text messaging, 246 exabyte storage.
That ' s a big disk.
That ' s a lot of storage, memory.
Nine exabyte RAM.
...
A quadrillion \textbf{transistors} is almost the same as the number of neurons in your brain.
So to a first approximation, we have these things â twenty petahertz synapse firings.
Of course, the memory is really huge.
But to a first approximation, the size of this machine is the size â and its complexity, kind of â to your brain.
Because in fact, that ' s how your brain works â in kind of the same way that the Web works.
...
And that ' s what we ' re going to do in the next 5, 000 days â we ' re going to give this machine a body.
...
The second thing is that â some people call this the cloud, and you ' re kind of touching the cloud with this.
...
And if you imagine what, say, just as an example, what Google Labs has in terms of experiments with Google Docs, Google Spreadsheets, blah, blah, blah â all these things are going to become Web based.
...
So every item, every artifact that we make, will have embedded in it some little sliver of Web-ness and connection, and it will be part of this machine, so that our environment â kind of in that ubiquitous computing sense â our environment becomes the Web.
Everything is connected.
Now, with RFIDs and other things â whatever technology it is, it doesn ' t really matter.
...
That is where we ' re going â this union, this convergence of the atomic and the digital.
And so one of the consequences of that, I believe, is that where we have this sort of spectrum of media right now â TV, film, video â that basically becomes one media platform.
...
The reason why things are free is so that you can manipulate them, not so that they are"free"as in"beer,"but"free"as in"freedom."And the network effects rule, meaning that the more you have, the more you get.
The first fax machine â the person who bought the first fax machine was an idiot, because there was nobody to fax to.
...
McLuhan was saying,"Machines are the extensions of the human senses."And I ' m saying,"Humans are now going to be the extended senses of the machine,"in a certain sense.
...
And I have to warn you, that what we ' ll talk about is â I ' m going to give my explanation of a term you ' re hearing, which is a"semantic Web."So first of all, the first stage that we ' ve seen of the Internet was that it was going to link computers.
...
And what you had to do was â if you wanted to participate in this, you had to share packets of information.
...
Now we have pages â the unit has been resolved into pages, so one page links to another page.
...
You couldn ' t deny â if someone wanted to link to you, you couldn ' t stop them.
...
So every idea is basically being supported â or every item, or every noun â is being supported by the entire Web.
...
And so, giving an example of this thing, I live in Pacifica, rather than â right now Pacifica is just sort of a name on the Web somewhere.
...
It ' s going to link directly to â it will know, the Web will be able to read itself and know that that actually is a place, and that whenever it sees that word,"Pacifica,"it knows that it actually has a place, latitude, longitude, a certain population.
...
That ' s what we ' re moving into â where it sort of knows these things down to that level.
A semantic Web, Web 3. 0, giant global graph â we ' re kind of trying out what we want to call this thing.
...
And as the Internet of things â where I ' m linking directly to the particular things of my seat on the plane â that that physical thing becomes part of the Web.
...
We ' re so dependent on this that I have now gotten to the point where I don ' t even try to remember things â I ' ll just Google it.
It ' s easier to do that.
And we kind of object at first, saying,"Oh, that ' s awful."But if we think about the dependency that we have on this other technology, called the alphabet, and writing, we ' re totally dependent on it, and it ' s transformed culture.
...
The next 5, 000 days, it ' s not just going to be the Web but only better â it ' s going to be something different.
...
It ' s a"One."And I don ' t know what else to call it, than the One.
...
% matched lemmas: megahertz, transistor
\end{textsample}
