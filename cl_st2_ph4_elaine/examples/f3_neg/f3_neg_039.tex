\begin{textsample}{NEG Dim 3 – 2012 – Score -1.00 – 2012/t002449.txt}  \label{ex:f3_neg_039}
Good morning.
...
So an \textbf{on-board} processor essentially looks at what motions need to be executed and combines these motions, and figures out what commands to send to the motors — 600 times a second.
