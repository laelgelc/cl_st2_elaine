\begin{textsample}{NEG Dim 5 – 2013 – Score -1.00 – 2013/t001950.txt}  \label{ex:f5_neg_040}
...
Nowadays, Adam and Eve would probably act differently. [ @Adam Last nite was a blast! loved dat apple LOL ] [ @Eve yep.. babe, know what happened to my pants tho? ] We do reveal so much more information about ourselves online than ever before, and so much information about us is being collected by organizations.
...
By the time the \textbf{subject} reached the last page on the survey, the page had been dynamically updated with the 10 best matching photos which the recognizer had found, and we asked the \textbf{subjects} to indicate whether he or she found themselves in the photo.
Do you see the \textbf{subject}?
Well, the computer did, and in fact did so for one out of three \textbf{subjects}.
...
We started from social media data, we combined it statistically with data from U.
S. government social security, and we ended up predicting social security numbers, which in the United States are extremely sensitive information.
...
Of course, the accuracy keeps getting worse. [ 27 \% of \textbf{subjects} ' first 5 SSN digits identified ] But in fact, we even decided to develop an iPhone app which uses the phone ' s internal camera to take a shot of a \textbf{subject} and then upload it to a cloud and then do what I just described to you in real time : looking for a match, finding public information, trying to infer sensitive information, and then sending back to the phone so that it is overlaid on the face of the \textbf{subject}, an example of augmented reality, probably a creepy example of augmented reality.
...
In another experiment, we presented to our \textbf{subjects} information about a potential job candidate.
We included in this information some references to some funny, absolutely legal, but perhaps slightly embarrassing information that the \textbf{subject} had posted online.
Now interestingly, among our \textbf{subjects}, some had posted comparable information, and some had not.
Which group do you think was more likely to judge harshly our \textbf{subject}?
...
Imagine that you are the H.
R. director of a certain organization, and you receive r{\EmojiFont �}{\EmojiFont �}sum{\EmojiFont �}{\EmojiFont �}s, and you decide to find more information about the candidates.
...
If you think so, then you are not like the U.
S. employers who are, in fact, part of our experiment, meaning we did exactly that.
We created Facebook profiles, manipulating traits, then we started sending out r{\EmojiFont �}{\EmojiFont �}sum{\EmojiFont �}{\EmojiFont �}s to companies in the U.
S., and we detected, we monitored, whether they were searching for our candidates, and whether they were acting on the information they found on social media.
And they were.
...
So in yet another experiment, this one with students, we asked them to provide information about their campus behavior, including pretty sensitive questions, such as this one. [ Have you ever cheated in an exam? ] Now to one group of \textbf{subjects}, we told them,"Only other students will see your answers."To another group of \textbf{subjects}, we told them,"Students and faculty will see your answers."Transparency.
Notification.
And sure enough, this worked, in the sense that the first group of \textbf{subjects} were much more likely to disclose than the second.
It makes sense, right?
But then we added the misdirection.
We repeated the experiment with the same two groups, this time adding a delay between the time we told \textbf{subjects} how we would use their data and the time we actually started answering the questions.
...
Of course, these technologies imply a shifting of cost and revenues between data holders and data \textbf{subjects}, which is why, perhaps, you don ' t hear more about them.
...
You can find echoes of this interpretation in John Milton ' s"Paradise Lost."In the garden, Adam and Eve are materially content.
They ' re happy.
They are satisfied.
...
We get free content.
We get to play Angry Birds.
We get targeted apps.
