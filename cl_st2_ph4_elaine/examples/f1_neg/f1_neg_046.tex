\begin{textsample}{NEG Dim 1 – 1984 – Score 8.00 – 1984/t000297.txt}  \label{ex:f1_neg_046}
...
And what you can do — oops, I didn ' t mean to do that — what you can do is actually feed \textbf{back} to the user the feeling of the physical properties.
...
And that ' s a much more elaborate one than you dribble \textbf{back}.
...
I can get \textbf{back} to the illustration, but in this case it ' s not a single frame, but it ' s actually a movie of someone coming into the frame and doing the repair that ' s described in the text.
...
I can go \textbf{back} to the beginning... and play the movie at full speed.
...
That child was very articulate and showed \textbf{us} and even dealt with the things he couldn ' t do automatically with that manual.
