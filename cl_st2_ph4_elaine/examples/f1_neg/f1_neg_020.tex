\begin{textsample}{NEG Dim 1 – 2021 – Score -1.00 – 2021/t004053.txt}  \label{ex:f1_neg_020}
...
But every time I do a talk, somebody comes backstage or follows me offstage and says,"You know, I ' m so inspired by what you say.
It ' s so great, it makes so much sense.
But we can ' t.""We can ' t because we ' re regulated.""We can ' t because our CFO says we can ' t do it.""We can ' t because we ' re in Europe.""We can ' t because we ' re a service industry.""We can ' t because we ' re a nonprofit."And then last year came the pandemic.
And the pandemic changed everything all over the world.
Service people started realizing that they had to suit up and wear masks and take temperatures and wash their hands.
...
And that when we used to say,"Well, this is my work home and this is my family home, and those are two completely different things,"for many of \textbf{us}, it ' s exactly the same thing.
You ' re no longer at home and at work.
For many of \textbf{us}, work is at home and the home is -- and it ' s confusing, and it ' s creating a whole different level of complexity and coordination so that we understand that it ' s easier actually to work when we can separate the work that we do as a team from the work that we do in our family.
Furthermore, in order to be able to do all that, we have to recognize that we ' re all adults.
...
So in order for people to deliver the right results, in order for people ' s hard work to matter, it has to be in the context of what success looks like for your organization.
So if we start to think about context, it ' s really important that we think about how we teach that.
...
And there ' s a really critically important part of making that work, and that ' s communication.
...
So that communication, that skill around being a great communicator is something that each of \textbf{us} needs to get better at.
One of the things we have to do is think about what the right discipline is for that.
...
We ' ve got to check in with the people on the shop floor to make sure they ' re hearing what they need to hear because it ' s not going to automatically happen.
One of the ideas I have is just jot down at the end of every day a sentence of what worked and what didn ' t work.
And you don ' t have to look at it for a month.
But when you look \textbf{back}, over a month, you want to look for,"Wow, that was surprising.
...
Maybe it ' s an email."So we have to rethink all of the ways, not just the work we ' re doing, but the ways we ' re doing it.
So now I ' m starting to hear a lot of nostalgia around the way it used to be.
There are things we aren ' t doing now that don ' t matter.
Maybe we don ' t need to go \textbf{back} for five levels of approval.
Maybe we don ' t need to go \textbf{back} and do that annual performance review.
...
Let ' s not lose it.
We want to create a new organization, new workforce, that ' s excited about taking all of the things that we ' ve learned using that muscle, going forward.
One of the most important things that we can do is realize the things that we aren ' t doing now.
The stuff that we ' ve stopped doing and not go \textbf{back} and do it again.
What if we don ' t go \textbf{back}?
