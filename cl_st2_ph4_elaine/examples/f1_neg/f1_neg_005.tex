\begin{textsample}{NEG Dim 1 – 2001 – Score 1.00 – 2001/t000092.txt}  \label{ex:f1_neg_005}
...
The good Lord in his infinite wisdom didn ' t create \textbf{us} all equal as far as intelligence is concerned, any more than we ' re equal for size, appearance.
Not everybody could earn an A or a B, and I didn ' t like that way of judging, and I did know how the alumni of various schools \textbf{back} in the ' 30s judged coaches and athletic teams.
...
But it seemed that we didn ' t win each individual game by the margin that some of our alumni had predicted — And quite frequently I really felt that they had \textbf{backed} up their predictions in a more materialistic manner.
But that was true \textbf{back} in the 30s, so I understood that.
...
And I knew how Mr.
Webster defined it, as the accumulation of material possessions or the attainment of a position of power or prestige, or something of that sort, worthy accomplishments perhaps, but in my opinion, not necessarily indicative of success.
...
Then I ran across this simple verse that said,"At God ' s \textbf{footstool} to confess, a poor soul knelt, and bowed his head. ' I failed! ' he cried.
...
Maybe it ' s because Dad used to read to \textbf{us} at night, by coal oil lamp — we didn ' t have electricity in our farm home.
And Dad would read poetry to \textbf{us}.
...
It ' s something like this : And I had blocks in the pyramid, and the cornerstones being \textbf{industriousness} and enthusiasm, working hard and enjoying what you ' re doing, coming up to the apex, according to my definition of success.
...
It ' s you and I who make our fates — we open up or close the gates on the road ahead or the road behind."Reminds me of another set of threes that my dad tried to get across to \textbf{us} : Don ' t whine.
Don ' t complain.
Don ' t make excuses.
...
My idea is that you can lose when you outscore somebody in a game, and you can win when you ' re \textbf{outscored}.
I ' ve felt that way on certain occasions, at various times.
And I just wanted them to be able to hold their head up after a game.
I used to say that when a game is over, and you see somebody that didn ' t know the outcome, I hope they couldn ' t tell by your actions whether you \textbf{outscored} an opponent or the opponent \textbf{outscored} you.
...
I ' d want him to be \textbf{unselfish}, and look for the pass first and not shoot all the time.
...
The other one, his next year, played 32 minutes in a national championship game, Did a tremendous job for \textbf{us}.
...
And so they played pretty good defense for \textbf{us}.
...
% matched lemmas: back, footstool, industriousness, outscore, unselfish, us
\end{textsample}
