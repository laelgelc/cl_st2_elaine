\begin{textsample}{NEG Dim 1 – 1990 – Score 4.00 – 1990/t000287.txt}  \label{ex:f1_neg_006}
...
The piece on the left â and that ultimately led to the piece on the right â happened when the kid that was working on this took one of those long strings of stuff and folded it up to put it in the wastebasket.
...
I got into fish.
I mean, the story I tell is that I got mad at postmodernism â at po-mo â and said that fish were 500 million years earlier than man, and if you ' re going to go \textbf{back}, we might as well go \textbf{back} to the beginning.
...
Now, if you saw a picture of this as it was published in Architectural Record â they didn ' t show the context, so you would think,"God, what a pushy guy this is."But a friend of mine spent four hours wandering around here looking for this restaurant.
Couldn ' t find it.
So...
...
I don ' t want the tower."So he came \textbf{back} with a simpler building, but he put some funny details on it, and he moved it closer to my building.
And so I decided to put him in a depression.
I put him in a hole and made a kind of a hole that he sits in.
And so then he put two bridges â this all happened on the fax, going \textbf{back} and forth over a couple of weeks ' period.
...
And this is a laser laboratory at the University of Iowa, in which the fish comes \textbf{back} as an abstraction in the \textbf{back}.
...
It ' s made of metal and the brown stuff is Fin-Ply â it ' s that formed lumber from Finland.
...
And the bed is \textbf{back} in this space, with windows looking out onto the lake.
...
And \textbf{back} in here, in this already treed park, we ' re doing a very dense building called the American Center, which has a theater, apartments, dance school, an art museum, restaurants and all kinds of â it ' s a very dense program â bookstores, etc.
...
And from the building in the \textbf{back}, you see it as an iceberg floating by in the hills.
...
And it ' s not a great building, but I approached it optimistically, that we would make a compositional relationship between \textbf{us} that would strengthen both of \textbf{us}.
...
The acoustician in the competition gave \textbf{us} criteria, which led to this compartmentalized scheme, which we found out after the competition would not work at all.
But everybody liked these forms and liked the space, and so that ' s one of the problems of a competition.
You have to then try and get that \textbf{back} in some way.
And we studied many models.
This was our original model.
These were the three buildings that were the ideal â the Concertgebouw, Boston and Berlin.
...
Our client doesn ' t want balconies, so â and when we met our new acoustician, he told \textbf{us} this was the right shape or this was the right shape.
...
In this case we ' re opening it \textbf{back} up and getting skylights in the four corners.
