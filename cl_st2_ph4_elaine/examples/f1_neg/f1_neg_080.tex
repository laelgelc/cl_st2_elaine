\begin{textsample}{NEG Dim 1 – 1994 – Score 15.00 – 1994/t002458.txt}  \label{ex:f1_neg_080}
Because I usually take the role of trying to explain to people how wonderful the new technologies that are coming along are going to be, and I thought that, since I was among friends here, I would tell you what I really think and try to look \textbf{back} and try to understand what is really going on here with these amazing jumps in technology that seem so fast that we can barely keep on top of it.
...
And they don ' t tell \textbf{us} much.
...
Because I think the only way to understand this is to really step \textbf{back} and take a long time scale look at things.
...
So if you go \textbf{back} about two and a half billion years, the Earth was this big, sterile hunk of rock with a lot of chemicals floating around on it.
...
In fact the recipe for \textbf{us}, our genes, is exactly that same code and that same way of writing.
...
So this allows \textbf{us} now to begin to start functioning as a single organism.
...
And it all connects \textbf{us} together into something that is much bigger and much faster and able to evolve than what we were before.
...
We ' re seeing this process feeding \textbf{back} on itself.
...
And it lets \textbf{us} produce things of much more complexity than normal engineering lets \textbf{us} produce.
And yet, we don ' t quite understand the options of it.
So in a sense, it ' s getting ahead of \textbf{us}.
We ' re now using those programs to make much faster computers so that we ' ll be able to run this process much faster.
So it ' s feeding \textbf{back} on itself.
The thing is becoming faster and that ' s why I think it seems so confusing.
Because all of these technologies are feeding \textbf{back} on themselves.
We ' re taking off.
...
But I think that there really is something coming along after \textbf{us}.
I think it ' s very haughty of \textbf{us} to think that we ' re the end product of evolution.
And I think all of \textbf{us} here are a part of producing whatever that next thing is.
