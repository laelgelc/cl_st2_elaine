\begin{textsample}{NEG Dim 1 – 2002 – Score 4.00 – 2002/t000079.txt}  \label{ex:f1_neg_064}
...
And the first story is called"The Faulty Switch."Another beautifully designed new building ruined by the sound of a common wall light switch.
...
The click is the modern triumphal clarion proceeding \textbf{us} through life, announcing our entry into every lightless room.
...
The next story is called"In Praise of the Taxpayer."That so many of the city ' s most venerable taxpayers have survived yet another commercial building boom, is cause for celebration.
...
Although they make no claim to architectural beauty, they are, in their perfect \textbf{temporariness}, a delightful alternative to the large-scale structures that might someday take their place.
...
Over the next 200 years we see the infant Christ go from a sitting to a standing position on the Virgin ' s lap, and then \textbf{back} again.
...
The ventriloquist must first make \textbf{us} believe that a small boy is sitting on his lap.
...
% matched lemmas: back, temporariness, us
\end{textsample}
