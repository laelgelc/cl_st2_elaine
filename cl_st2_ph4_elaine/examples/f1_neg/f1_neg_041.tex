\begin{textsample}{NEG Dim 1 – 2015 – Score 1.00 – 2015/t001488.txt}  \label{ex:f1_neg_041}
...
We ' ve discovered antibiotics and vaccines to protect \textbf{us} from infections, many treatments for cancer, antiretrovirals for HIV, statins for heart disease and much more.
...
The US government spends 10 times more every year on cancer research than on Alzheimer ' s despite the fact that Alzheimer ' s costs \textbf{us} more and causes a similar number of deaths each year as cancer.
...
This is just an initial positive result, but research like this shows \textbf{us} that Alzheimer ' s is a disease that we can understand and we can cure.
