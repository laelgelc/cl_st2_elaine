\begin{textsample}{POS Dim 6 – 2013 – Score 6.00 – 2013/t002089.txt}  \label{ex:f6_pos_036}
...
Timidly, we ' ve been higher on the \textbf{diagonal} in other situations, but it ' s okay.
It ' s good.
It ' s good.
It ' s good.
...
But then there was another wonderfully pretentious article that came out in The New Republic, so pretentious, by Liel Leibovitz, and it said,"MoMA has mistaken video games for art."Again."The museum is putting Pac-Man alongside Picasso."Again."That misses the point."Excuse me.
...
It ' s truly a way to think of how to preserve and show \textbf{artifacts} that will more and more become part of our lives in the future.
...
I mean, that \textbf{interface} is beautiful.
...
It ' s about rolling a \textbf{ball} and picking up as many objects as you can in a finite amount of time and hopefully you ' ll be able to make it into a planet.
...
They also preserve \textbf{artifacts} for posterity.
...
And so is space, the \textbf{spatial} aspect of games.
...
But the \textbf{spatial} evolution in video games is extremely important.
Time.
...
You see them here \textbf{displayed} alongside other examples of design, furniture and other parts, but there ' s no paraphernalia, no nostalagia, only the screen and a little shelf with the controllers.
...
% matched lemmas: artifact, ball, diagonal, display, interface, spatial
\end{textsample}
