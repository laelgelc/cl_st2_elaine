\begin{textsample}{POS Dim 6 – 1998 – Score 2.00 – 1998/t000200.txt}  \label{ex:f6_pos_016}
...
And we began making \textbf{various} odd planes and creatures.
...
The message from all these vehicles is that ideas and technology can be harnessed to produce \textbf{remarkable} gains in doing more with less â gains that can help us attain a desirable balance between technology and nature.
...
In the video you saw that nine-pound or eight-pound Pointer airplane surveillance drone that Keenan has developed and just done a \textbf{remarkable} job.
...
There are just milestones along the way of some \textbf{remarkable} things.
...
% matched lemmas: remarkable, various
\end{textsample}
