\begin{textsample}{POS Dim 6 – 2007 – Score 5.00 – 2007/t000276.txt}  \label{ex:f6_pos_019}
...
The best A.
I. in the planet would find it complex and confusing, and my little dog Watson would find it simple and understandable but would miss the point.
...
It ' s trying to perceive images into objects rather than seeing what ' s there."And to prove it, she says,"The exact size and shape of these tabletops is the same, and I ' m going to prove it to you."She does this with cardboard, but since I have an expensive computer here I ' ll just rotate this little guy around and...
...
Well, what artists do is to measure.
...
And the Talmud saw this a long time ago, saying,"We see things not as they are, but as we are."I certainly would like to know what happened to the person who had that insight back then, if they actually followed it to its ultimate conclusion.
...
It ' s a waking dream, and understanding that that is what we actually exist in is one of the biggest epistemological barriers in human history.
...
And these are in the form of sensory apparatus — telescopes, microscopes — reasoning apparatus — \textbf{various} ways of thinking — and, most importantly, in the ability to change perspective on things.
...
And in fact, what Murray was talking about yesterday in the fractal beauty of nature — of having the descriptions at \textbf{various} levels be rather similar — all goes down to the idea that the elementary particles are both sticky and standoffish, and they ' re in violent motion.
...
So they had created these \textbf{artifacts}.
...
But the whole point of this thing is for them to look at this chart and fill it out."What have you noticed about what you did?"And so six-year-old Lauren there noticed that the first one took one, and the second one took three more and the total was four on that one, the third one took five more and the total was nine on that one, and then the next one.
...
And then the teacher, Gillian Ishijima, had the kids bring all of their projects up to the front of the room and put them on the floor, and everybody went batshit :"Holy shit!
They ' re the same!"No matter what the shapes were, the growth law is the same.
...
What do I get there?"We get a visual pattern of what these nine-year-olds called acceleration.
...
Teacher : So put"sponge \textbf{ball}"...
Student 4l : [ I decided to ] do the shot put and the sponge \textbf{ball} because they ' re two totally different weights, and if you drop them at the same time, maybe they ' ll drop at the same speed.
Teacher : Drop.
Class : Whoa!
AK : So obviously, Aristotle never asked a child about this particular point because, of course, he didn ' t bother doing the experiment, and neither did St.
Thomas Aquinas.
...
We can take a \textbf{movie} of what ' s going on, but even if we single stepped this \textbf{movie}, it ' s tricky to see what ' s going on.
And so what we can do is we can lay out the frames side by side or stack them up.
So when the children see this, they say,"Ah!
Acceleration,"remembering back four months when they did their cars sideways, and they start measuring to find out what kind of acceleration it is.
...
We ' ve done that already."And how shall we look and verify that we actually have it?
So you can ' t tell much from just making the \textbf{ball} drop there, but if we drop the \textbf{ball} and run the \textbf{movie} at the same time, we can see that we have come up with an accurate physical model.
Galileo, by the way, did this very cleverly by running a \textbf{ball} backwards down the strings of his lute.
...
But if I oppose gravity, here we go...
Oops!
One more.
Yeah, there we go.
Yeah, OK?
...
I believe this has to be done with a new kind of user \textbf{interface}, and this new kind of user \textbf{interface} could be done with an expenditure of about 100 million dollars.
...
And Einstein said,"Things should be as simple as possible, but not simpler."Thank you.

% matched lemmas: artifact, ball, interface, movie, various
\end{textsample}
