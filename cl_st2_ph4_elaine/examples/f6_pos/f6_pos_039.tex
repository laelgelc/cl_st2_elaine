\begin{textsample}{POS Dim 6 – 2010 – Score 4.00 – 2010/t002780.txt}  \label{ex:f6_pos_039}
...
We ' re the first generation â thanks to science â to be informed that we may be undermining the stability and the ability of planet Earth to support human development as we know it.
...
On this journey, I ' d like to bring, apart from yourselves, a good friend, a stakeholder, who ' s always absent when we deal with the negotiations on environmental issues, a stakeholder who refuses to compromise â planet Earth.
So I thought I ' d bring her with me today on stage, to have her as a witness of a \textbf{remarkable} journey, which humbly reminds us of the period of grace we ' ve had over the past 10, 000 years.
This is the living conditions on the planet over the last 100, 000 years.
It ' s a very important period â it ' s roughly half the period when we ' ve been fully modern humans on the planet.
...
The second pressure on the planet is, of course the climate agenda â the big issue â where the policy interpretation of science is that it would be enough to stabilize greenhouse gases at 450 ppm to avoid average temperatures exceeding two degrees, to avoid the risk that we may be destabilizing the West Antarctic Ice Sheet, holding six meters â level rising, the risk of destabilizing the Greenland Ice Sheet, holding another seven meters â sea level rising.
...
The forth pressure is surprise, the notion and the evidence that we need to abandon our old paradigm, that ecosystems behave linearly, predictably, controllably in our â so to say â linear systems, and that in fact, surprise is universal, as systems tip over very rapidly, abruptly and often irreversibly.
This, dear friends, poses a human pressure on the planet of momentous scale.
We may, in fact, have entered a new geological era â the Anthropocene, where humans are the predominant driver of change at a planetary level.
...
You can take virtually any parameter that matters for human well-being â nitrous oxide, methane, deforestation, overfishing land degredation, loss of species â they all show the same pattern over the past 200 years.
...
Now, as if this was not enough â to just bend the curves and understanding the accelerated pressure on the planet â we also have to recognize the fact that systems do have multiple stable states, separated by thresholds â \textbf{illustrated} here by this \textbf{ball} and cup diagram, where the depth of the cup is the resilience of the system.
Now, the system may gradually â under pressure of climate change, erosion, biodiversity loss â lose the depth of the cup, the resilience, but appear to be healthy and appear to suddenly, under a threshold, be tipping over.
Upff.
Sorry.
...
The Arctic â a beautiful system â a regulating biome at the planetary level, taking the knock after knock on climate change, appearing to be in a good state.
...
But we also include, what we call, the slow variables, the systems that, under the hood, regulate and buffer the capacity of the resilience of the planet â the interference of the big nitrogen and phosphorus cycles on the planet, land use change, rate of biodiversity loss, freshwater use, functions which regulate biomass on the planet, carbon sequestration, diversity.
And then we have two parameters which we were not able to quantify â air pollution, including warming gases and air-polluting sulfates and nitrates, but also chemical pollution.
...
All for one."You degrade forests, you go beyond the boundary on land, you undermine the ability of the climate system to stay stable.
...
In the ' 60s already, through the green revolution and the Haber-Bosch process of fixing nitrogen from the atmosphere â you know, human ' s today take out more nitrogen from the atmosphere than the whole biosphere does naturally as a whole.
We don ' t transgress the climate boundary until the early ' 90s, actually, right after Rio.
And today, we are in a situation where we estimate that we ' ve transgressed three boundaries, the rate of biodiversity loss, which is the sixth extinction period in the history of humanity â one of them being the extinctions of the dinosaurs â nitrogen and climate change.
...
Sweden, the country I come from, has other examples, where wetlands in southern Sweden were seen as â as in many countries â as flood-prone polluted nuisance in the peri-urban regions.
...
Everybody talks about carbon taxes â it won ' t work â emission schemes, but for example, one policy measure, feed-in tariffs on the energy system, which is already applied, from China doing it on offshore wind systems, all the way to the U.
S. where you give the guaranteed price for investment in renewable energy, but you can subsidize electricity to poor people.
You get people out of poverty.
You solve the climate issue with regards to the energy sector, while at the same time, stimulating innovation â examples of things that can be out scaled quickly at the planetary level.
So there is â no doubt â opportunity here, and we can list many, many examples of transformative opportunities around the planet.
...
% matched lemmas: ball, illustrate, remarkable
\end{textsample}
