\begin{textsample}{POS Dim 6 – 2017 – Score 4.00 – 2017/t001083.txt}  \label{ex:f6_pos_059}
...
CA : There ' s a great \textbf{movie} to be made here somewhere.
I don ' t know what it is and I don ' t know that it ends well, but it ' s a great \textbf{movie}.
...
EM : Well, this \textbf{illustrates} the picture of the future that I think is how things will evolve.
...
CA : So these roof tiles, some of them have in them basically solar power, the ability to — EM : Yeah.
...
We haven ' t even spoken about your newest thing, which we don ' t have time to do, but you want to save humanity from bad AI, and so you ' re going to create this really cool brain-machine \textbf{interface} to give us all infinite memory and telepathy and so forth.
...
The fact that you do that, Elon Musk, is a really \textbf{remarkable} thing.
...
% matched lemmas: illustrate, interface, movie, remarkable
\end{textsample}
