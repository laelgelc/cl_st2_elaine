\begin{textsample}{POS Dim 6 – 2006 – Score 4.00 – 2006/t000498.txt}  \label{ex:f6_pos_009}
...
There ' s nothing that makes you feel more â the blessing and the honor of working in a program like that â than to know that something that horrible no longer exists.
So I ' m going to tell you â so I ' m going to show you some dirty pictures.
...
Someone saw me on television ; they called me up ; and they asked me if I ' d like to be in a \textbf{movie} and to play a young doctor for a bunch of rock and roll stars who were traveling in a bus ride from San Francisco to England.
And I said, yes, I would do that, so I became the doctor in an absolutely awful \textbf{movie} called"Medicine Ball Caravan."Now, you know from the ' 60s, you ' re either on the bus or you ' re off the bus ; I was on the bus.
...
This little girl is Rahima Banu, and she was the last case of killer smallpox in the world.
...
In the year that Larry Page and Sergey Brin â with whom I have a certain affection and a new affiliation â in the year in which they were born, two million people died of smallpox.
...
By day nine â you look at this picture and you ' re horrified ; I look at this picture and I say,"Thank God,"because it ' s clear that this is only an ordinary case of smallpox, and I know this child will live.
...
So, how we eradicated smallpox was â mass vaccination wouldn ' t work.
...
It was the largest campaign in United Nations history, until the Iraq war. 150, 000 people from all over the world â doctors of every race, religion, culture and nation, who fought side by side, brothers and sisters, with each other, not against each other, in a common cause to make the world better.
...
And David Heymann, who ' s watching this on the webcast â David, keep on going.
We ' re close!
...
Instead of finding out what we thought was the case â that blindness was caused mostly by glaucoma and trachoma â we were astounded to find out that blindness was caused instead by cataract.
You can ' t cure or prevent what you don ' t know is there.
In your TED packages there ' s a DVD,"Infinite Vision,"about Dr.
V and the Aravind Eye Hospital.
...
Bird flu.
I stand here as a representative of all terrible things â this might be the worst.
...
The moment WHO says we ' ve moved to category four â this will not be like Katrina.
...
I asked them â these are all fluologists and specialists in influenza â and I asked them the questions you ' d like to ask them : What do you think the likelihood is that there ' ll be a pandemic?
...
Now, if we had an"undo"button, and we could go back and isolate it and grab it when it first started â if we could find it early, and we had early detection and early response, and we could put each one of those viruses in jail â that ' s the only way to deal with something like a pandemic.
...
And that simulation that I showed you that you thought was bird flu â that was SARS.
...
John, who I hope is in the audience some place â over there â who ' s the founder of GPHIN.
Hello, Ron!
And TED has flown Ron here from Ottawa, where GPHIN is located, because not only did GPHIN find SARS early, but you may have seen last week that Iran announced that they had bird flu in Iran, but GPHIN found the bird flu in Iran not February 14 â but last September.
...
Smallpox â early detection, early response.
Blindness, polio â early detection, early response.
Pandemic bird flu â early detection, early response.
It is a litany.
...
So, my TED wish is for you to help build a global system â an early-warning system â to protect us against humanity ' s worst nightmares.
...
Chris Anderson : An amazing \textbf{presentation}.
...
I love it.
LB : Well, as Ron St.
John â I hope you ' ll go and meet him in the dinner afterwards and talk to him.
When he started GPHIN â In 1997, there was an outbreak of bird flu â H5N1.
It was in Hong Kong.
And a \textbf{remarkable} doctor in Hong Kong responded immediately, by slaughtering 1. 5 million chickens and birds, and they stopped that outbreak in its tracks.
Immediate detection, immediate response.
Then a number of years went by, and there were a lot of rumors about bird flu.
Ron and his team in Ottawa began to crawl the web â only crawling 20, 000 different websites, mostly periodicals â and they read about and heard about a concern, of a lot of children who had high fever and symptoms of bird flu.
...
Now, what ' s really important is that, before there was GPHIN, 100 percent of all the world ' s reports of bad things â whether you ' re talking about famine or you ' re talking about bird flu or you ' re talking about Ebola â 100 percent of all those reports came from nations.
The moment these guys in Ottawa â on a budget of 800, 000 dollars a year â got cracking, 75 percent of all the reports in the world came from GPHIN, 25 percent of all the reports in the world came from all the other 180 nations.
...
% matched lemmas: movie, presentation, remarkable
\end{textsample}
