\begin{textsample}{POS Dim 6 – 2007 – Score 5.00 – 2007/t000238.txt}  \label{ex:f6_pos_018}
Well, good morning.
...
PH : You know, so much was worked out : the first real-time interaction, the video \textbf{display}, pointing a gun.
...
A new technology has confounded radio men and \textbf{movie} moguls and they ' re quite certain that television is about to do them in.
...
Marshall McLuhan : If the audience can become involved in the actual process of making the ad, then it ' s happy.
...
This was a \textbf{remarkable} place, at a \textbf{remarkable} time.
...
The method we \textbf{illustrate} in this video uses a pre-made videodisc but creates custom HyperCard stacks.
...
They think of the old medium, because the old medium is always the content of the new medium, as \textbf{movies} tend to be the content of TV, and as books used to be the content, novels used to be the content of \textbf{movies}.
...
% matched lemmas: display, illustrate, movie, remarkable
\end{textsample}
