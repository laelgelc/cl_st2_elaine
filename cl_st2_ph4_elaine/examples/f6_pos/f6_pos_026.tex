\begin{textsample}{POS Dim 6 – 2004 – Score 4.00 – 2004/t000098.txt}  \label{ex:f6_pos_026}
...
And yet, when we look forward in the brain we see really \textbf{remarkable} advance.
...
And by this age we see a \textbf{remarkable} evolution in its capacity to control movement.
...
Now this boy can bounce a soccer \textbf{ball} on his head.
...
Every one of us has a different set of acquired skills and abilities that all derive out of the plasticity, the adaptability of this really \textbf{remarkable} adaptive machine.
...
If we look at the selectivity of responses in the cortex of the monkey, we see that the monkey has actually changed the \textbf{filter} characteristics which represents input from the skin of the fingertips that are engaged.
...
And children operating in \textbf{various} language behaviors, or in \textbf{various} reading behaviors, you see for the most extent, for most children, their neuronal responses, complexly abnormal before you start, are normalized by the training.
...
% matched lemmas: ball, filter, remarkable, various
\end{textsample}
