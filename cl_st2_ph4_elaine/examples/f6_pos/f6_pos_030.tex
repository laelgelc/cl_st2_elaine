\begin{textsample}{POS Dim 6 – 2009 – Score 5.00 – 2009/t002933.txt}  \label{ex:f6_pos_030}
...
And to really \textbf{illustrate} this point, what I ' d like to do is to show you how technology has dealt with a very simple, a very common, an everyday question.
...
Each point on the surface of the sphere is mapped through the bottom \textbf{pole}, onto a flat surface, where it is then recorded.
...
So, in computer graphics and computer user \textbf{interface} design, there is a term called affordances.
...
And it would take a full university course to \textbf{illustrate} it.
Astrolabes have an incredible history.
They are over 2, 000 years old.
The concept of stereographic projection originated in 330 B.
C.
And the astrolabes come in many different sizes and shapes and forms.
There is portable ones.
There is large \textbf{display} ones.
And I think what is common to all astrolabes is that they are beautiful works of art.
There is a quality of craftsmanship and precision that is just astonishing and \textbf{remarkable}.
...
So, it ' s — I think astrolabes are just \textbf{remarkable} devices.
...
% matched lemmas: display, illustrate, interface, pole, remarkable
\end{textsample}
