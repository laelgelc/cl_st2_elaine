\begin{textsample}{POS Dim 6 – 2012 – Score 4.00 – 2012/t002265.txt}  \label{ex:f6_pos_042}
...
C.
R.
Licklider ' s human-computer symbiosis, perhaps better termed"intelligence augmentation,"I.
A.
...
Foldit, a game created by computer scientists, \textbf{illustrates} the value of the approach.
...
It \textbf{displays} the names of the thousands of victims using a beautiful concept called"meaningful adjacency."It places the names next to each other based on their relationships to one another : friends, families, coworkers.
...
When you do this, you ' ll quickly realize that you spent all of your time on the \textbf{interface} between man and machine, specifically on designing away the friction in the interaction.
...
How do I process this data?"These are necessary but insufficient questions.
...
When PayPal was first starting as a business, their biggest challenge was not,"How do I send money back and forth online?"It was,"How do I do that without being defrauded by organized crime?"Why so challenging?
...
He was caught by dedicated, resourceful, brilliant people in partnerships with \textbf{various} technologies.
...
Instead, people will have to look at data and search for insight, and as Licklider foresaw long ago, the key to great results here is the right type of cooperation, and as Kasparov realized, that means minimizing friction at the \textbf{interface}.
...
In October, 2007, U.
S. and coalition forces raided an al Qaeda safe house in the city of Sinjar on the Syrian border of Iraq.
...
They answered questions like,"Who recruited you?""What ' s your hometown?""What occupation do you seek?"In that last question, a surprising insight was revealed.
...
The U.
S.
Army had detailed knowledge for only a small section of the country.
...
% matched lemmas: display, illustrate, interface, various
\end{textsample}
