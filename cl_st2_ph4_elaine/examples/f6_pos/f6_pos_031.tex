\begin{textsample}{POS Dim 6 – 2009 – Score 4.00 – 2009/t000123.txt}  \label{ex:f6_pos_031}
I want to start out by asking you to think back to when you were a kid, playing with blocks.
As you figured out how to reach out and grasp, pick them up and move them around, you were actually learning how to think and solve problems by understanding and manipulating \textbf{spatial} relationships. \textbf{Spatial} reasoning is deeply connected to how we understand a lot of the world around us.
So, as a computer scientist inspired by this utility of our interactions with physical objects — along with my adviser Pattie, and my collaborator Jeevan Kalanithi — I started to wonder — what if when we used a computer, instead of having this one mouse \textbf{cursor} that was a like a digital fingertip moving around a flat desktop, what if we could reach in with both hands and grasp information physically, arranging it the way we wanted?
...
There are effects that you can control live, like reverb and \textbf{filter}.
...
Video : DM : And now I ' ll attach the \textbf{filter} to the drums, so I can control the effect live.
Video : DM : I can speed up the whole sequence by tilting the tempo one way or the other.
Video : DM : And now I ' ll attach the \textbf{filter} to the bass for some more expression.
...
Thank you.
So, as you can see, my passion is for making new human-computer \textbf{interfaces} that are a better match to the ways our brains and bodies work.
...
% matched lemmas: cursor, filter, interface, spatial
\end{textsample}
