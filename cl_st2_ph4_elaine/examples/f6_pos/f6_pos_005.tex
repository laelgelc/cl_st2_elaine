\begin{textsample}{POS Dim 6 – 2002 – Score 5.00 – 2002/t000095.txt}  \label{ex:f6_pos_005}
...
That ' s the \textbf{substrate} that we ' re exploiting today.
...
Frantz Fanon, who was a psychiatrist from Martinique, said,"Each generation must, out of relative obscurity, discover its mission and fulfill or betray it."What is our mission?
...
Maybe scientists are ingenious, but they ' re not creative."And then we have this tendency, the career counselors and \textbf{various} people say things like,"Artists are not analytical.
...
Infrastructure, museums, theaters, \textbf{movie} houses across the country are disappearing.
We have more television stations with less to watch, we have more money spent on rewrites to get old television programs in the \textbf{movies}.
...
I figured I ' d have to do that ad, because I ' m an entrepreneur, and"entrepreneur"says"somebody who does what they want to do, because they ' re not broke enough that they have to get a real job."But that ' s the work I ' m doing, BioSentient Corporation, trying to figure out : How do we integrate these things?
...
High school physics lesson before you leave : high school physics teacher used to hold up a \textbf{ball}.
She would say,"This \textbf{ball} has potential energy.
...
But nothing ' s going to happen until we risk putting those ideas into action.
...
% matched lemmas: ball, movie, substrate, various
\end{textsample}
