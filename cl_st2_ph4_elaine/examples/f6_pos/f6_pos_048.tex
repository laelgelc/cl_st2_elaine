\begin{textsample}{POS Dim 6 – 2014 – Score 6.00 – 2014/t001860.txt}  \label{ex:f6_pos_048}
...
The curves have that kind of mathematical smoothness that the B{\EmojiFont �}{\EmojiFont �}zier formula imposes.
...
A lie at TED.
I ' m really sorry.
Both of these were made on a computer, same software, same B{\EmojiFont �}{\EmojiFont �}zier curves, same font format.
...
That ' s all.
Zuzana wanted hers to look like that.
I wanted mine to look like that.
End of story.
...
So do you look at these and say,"Poor Matthew, he had to submit to a problem, and by God it shows in the results."I hope not.
...
This is from the mid- ' 70s early trials of Bell Centennial typeface I designed for the U.
S. phone books, and it was my first experience of digital type, and quite a baptism.
...
These strange \textbf{artifacts} are designed to compensate for the undesirable effects of scale and production process.
At the outset, AT\&T had wanted to set the phone books in Helvetica, but as my friend Erik Spiekermann said in the Helvetica \textbf{movie}, if you ' ve seen that, the letters in Helvetica were designed to be as similar to one another as possible.
...
I did an analysis of the data, and found that a \textbf{typical} serif face you see on the left needed nearly twice as much data as a sans serif in the middle because of all the points required to define the elegantly curved serif brackets.
The numbers at the bottom of the slide, by the way, they represent the amount of data needed to store each of the fonts.
So the sans serif, in the middle, sans the serifs, was much more economical, 81 to 151."Aha,"I thought."The engineers have a problem.
Designer to the rescue."I made a serif type, you can see it on the right, without curved serifs.
...
So I went to the head of engineering with my numbers, and I said proudly,"I have solved your problem.""Oh,"he said."What problem?"And I said,"Well, you know, the problem of the huge data you require for serif fonts and so on.""Oh,"he said."We solved that problem last week.
We wrote a compaction routine that reduces the size of all fonts by an order of magnitude.
You can have as many fonts on your system as you like.""Well, thank you for letting me know,"I said.
Foiled again.
...
We want to respond.
We want to be pushed into exploring something new.
...
They wanted a small core set of fonts that were not adapted but designed for the screen to face up to the problems of screen, which were their coarse resolution \textbf{displays}.
...
Here you see the outline of a letter, the cap H, which is the thin black line, the contour, which is how it is stored in memory, \textbf{superimposed} on the bitmap, which is the grey area, which is how it ' s \textbf{displayed} on the screen.
...
Microsoft were absolutely right, it took a good 10 years, but screen \textbf{displays} now do have improved \textbf{spatial} resolution, and very much improved photometric resolution thanks to anti-aliasing and so on.
So now that their mission is accomplished, has that meant the demise of the screen fonts that I designed for coarser \textbf{displays} back then?
...
% matched lemmas: artifact, display, movie, spatial, superimpose, typical
\end{textsample}
