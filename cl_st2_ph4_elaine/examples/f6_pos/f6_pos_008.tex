\begin{textsample}{POS Dim 6 – 2006 – Score 5.00 – 2006/t000500.txt}  \label{ex:f6_pos_008}
I ' ve been at MIT for 44 years.
I went to TED I.
There ' s only one other person here, I think, who did that.
All the other TEDs â and I went to them all, under Ricky ' s regime â I talked about what the Media Lab was doing, which today has almost 500 people in it.
And if you read the press, last week it actually said I quit the Media Lab.
I didn ' t quit the Media Lab, I stepped down as chairman â which was a kind of ridiculous title, but someone else has taken it on â and one of the things you can do as a professor is you stay on as a professor.
...
So with those as the principles â some of you may know Seymour Papert.
This is back in 1982, when we were working in Senegal.
Because some people think that the \$100 laptop just happened a year ago, or two years ago, or we were struck by lightning â this actually has gone back a long time, and in fact, back to the ' 60s.
...
And these are two anecdotes â one was in Cambodia, in a village that has no electricity, no water, no television, no telephone, but has broadband Internet now.
And these kids, their first English word is"Google"and they only know Skype.
They ' ve never heard of telephony.
They just use Skype.
And they go home at night â they ' ve got a broadband connection in a hut that doesn ' t have electricity.
The parents love it, because when they open up the laptops, it ' s the brightest light source in the house.
And talk about where metaphors and reality mix â this is the actual school.
In parallel with this, Seymour Papert got the governor of Maine to legislate one laptop per child in the year 2002.
Now at the time, I think it ' s fair to say that 80 percent of the teachers were â let me say, apprehensive.
...
They ' re reporting five things : drop of truancy to almost zero, attending parent-teacher meetings â which nobody did and now almost everybody does â drop in discipline problems, increase in student participation.
Teachers are now saying it ' s kind of fun to teach.
Kids are engaged â they have laptops! â and then the fifth, which interests me the most, is that the servers have to be turned off at certain times at night because the teachers are getting too much email from the kids asking them for help.
So when you see that kind of thing â this is not something that you have to test.
...
It ' s because you can go to a manufacturer â and I will leave the name out â but we wanted a small \textbf{display}, doesn ' t have to have perfect color uniformity.
...
We ' re interested in big \textbf{displays}, bright \textbf{displays}.
You ' re not part of our strategic plan."And I said,"That ' s kind of too bad, because we need 100 million units a year."And they said,"Oh, well, maybe we could become part of your strategic plan."And that ' s why scale counts.
...
Now once people start looking at this, they say,"Ah, this is a laptop project."Well, no, it ' s not a laptop project.
It ' s an education project.
And the fun part â and I ' m quite focused on it â I tell people I used to be a light bulb, but now I ' m a laser â I ' m just going to get that thing built, and it turns out it ' s not so hard.
Because laptop economics are the following : I say 50 percent here â it ' s more like 60, 60 percent of the cost of your laptop is sales, marketing, distribution and profit.
...
Then you have \textbf{display} and everything else.
Now the \textbf{display} on your laptop costs, in rough numbers, 10 dollars a \textbf{diagonal} inch.
...
It ' s the rest â that little brown box â that is pretty fascinating, because the rest of your laptop is devoted to itself.
...
Why are we all sitting there?"And somebody â to remain nameless â called our laptop a"gadget"recently.
...
The dual mode \textbf{display} â the idea is to have a \textbf{display} that both works outdoors â isn ' t it fun using your cell phone outdoors in the sunlight?
...
At least you can decide whether it goes left or â Chris Anderson : Before you do it, for the people down in simulcast â Nicholas Negroponte : Sorry!
I forgot.
CA : Just show it off a bit.
So wherever the camera is â OK, good point.
Thank you, Chris.
...
Etc., etc. â is that enough for simulcast?
OK, sorry.
...
They can decide â it ' s the federal government in each case.
...
Everybody says it ' s a \$100 laptop â you can ' t do it.
...
And one of the ways â just one â but one of the ways to help in the case of the gray market is to make something that is so utterly unique â It ' s a little bit like the fact that automobiles â thousands of automobiles are stolen every day in the United States.
...
The economics of this is to start with the federal governments and then later, to subsequently go to other â whether it ' s child-to-child funding, so a child in this country buys one for a child in the developing world, maybe of the same gender, maybe of the same age.
...
And everybody says â I say â it ' s an education project.
...
% matched lemmas: diagonal, display
\end{textsample}
