\begin{textsample}{POS Dim 6 – 1998 – Score 3.00 – 1998/t000118.txt}  \label{ex:f6_pos_014}
...
So, what we did for the first two and a half years was four things : We did an extensive review of the literature in related fields, like cognitive psychology, \textbf{spatial} cognition, gender studies, play theory, sociology, primatology.
...
If at any time during the game we want to learn more about the characters, we can go into this hidden hallway, and I ' ll quickly just show you the \textbf{interface}.
...
% matched lemmas: interface, remarkable, spatial
\end{textsample}
