\begin{textsample}{POS Dim 6 – 2007 – Score 6.00 – 2007/t000199.txt}  \label{ex:f6_pos_017}
I dabble in design.
...
And what I ' m going to do today is I ' m going to give you a preview of the next exhibition that I ' m working on, which is called"Design and the Elastic Mind."The world that I decided to focus on this particular time is the world of science and the world of technology.
...
And before I launch into the \textbf{display} of some of the slides and into the preview, I would like to point out this beautiful detail about scientists and design.
You can say that the relationship between science and design goes back centuries.
You can of course talk about Leonardo da Vinci and many other Renaissance men and women — and there ' s a gigantic history behind it.
...
Together with Adam Bly, who is the founder of Seed magazine — that ' s now a multimedia company, you might know it — we founded about a year ago a monthly salon for designers and scientists, and it ' s quite beautiful.
...
Very interesting.
This is a typeface designer from Israel who has designed — he calls them"typosperma."He ' s thinking — of course it ' s all a concept — of injecting typefaces into spermatozoa, I don ' t know how to say it in English — spermatazoi — in order to make them become — to almost have a song or a whole poem written with every ejaculation.
...
We were discussing with Keith Shrubb* this morning the fact that many scientists tend not to use anything beautiful in their \textbf{presentations}, otherwise they ' re afraid of being considered dumb blondes.
So they pick the worst background from any kind of PowerPoint \textbf{presentation}, the worst typeface.
It ' s only recently that this kind of marriage between design and science is producing some of the first"pretty"— if we can say so — scientific \textbf{presentations}.
...
The more computers, the stronger the signal, and children work on the \textbf{interface} so that it ' s all based on doing things together, tasks together.
...
And this is the work of several designers that really enhance the idea of solitude and expansion by means of \textbf{various} techniques.
...
And here I ' m showing a picture that was in Wired Magazine — you know, the \textbf{Artifacts} of the Future section that I love so much — that shows you can have your desktop 3D printer and print your own basketball.
...
So, \textbf{various} ways to map and tag are also the work of many designers nowadays.
...
It ' s Dunne and Raby,"All the Robots."Those are a series of robots that are meant to be taken care of.
...
But they ' re in reality very, very beautiful sculpted \textbf{artifacts} that contain the whole desktop and computer memory of somebody who passed away.
...
This is Auger-Loizeau,"AfterLife."It ' s the idea that some people don ' t believe in an afterlife.
...
% matched lemmas: artifact, display, interface, presentation, various
\end{textsample}
