\begin{textsample}{POS Dim 6 – 1998 – Score 2.00 – 1998/t000134.txt}  \label{ex:f6_pos_015}
...
Perhaps it ' s not a very insightful observation, but that really started me on a path to be able to do a kind of theme and variations based on a work by Piero, in this case that \textbf{remarkable} painting that ' s in the Uffizi,"The Duke of Montefeltro,"who faces his consort, Battista.
...
I do a lot of work for the School of Visual Arts, where I teach, and the director of this school — a \textbf{remarkable} man named Silas Rhodes — often gives you a piece of text and he says,"Do something with this."And so he did.
...
It ' s not folded, that ' s a photograph and it ' s cut on the \textbf{diagonal}.
...
% matched lemmas: diagonal, remarkable
\end{textsample}
