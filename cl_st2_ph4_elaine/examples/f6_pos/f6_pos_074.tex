\begin{textsample}{POS Dim 6 – 2024 – Score 4.00 – 2024/t003212.txt}  \label{ex:f6_pos_074}
Let me show you something.
To be precise, I ' m going to show you nothing.
...
Although sunshine did \textbf{filter} 1, 000 meters beneath the surface of ocean, a light permeated from hydrothermal vents to seafloor, brimming with life, there was not a single eye to be found in these ancient waters.
...
And on this plot, you ' re seeing the annual improvement and milestone models.
...
At that time, I pushed my luck and said,"Andrej, can we make computers to do the reverse?"And Andrej said,"Ha ha, that ' s impossible."Well, as you can see from this post, recently the impossible has become possible.
...
But even without the enormous number of GPUs, my student and our collaborators have developed a generative video model called Walt months before Sora.
...
What a cat-astrophe.
And if past is prologue, we will learn from these mistakes and create a future we imagine.
...
When we act upon this world in 3D space and time, we learn, and we learn to see and do better.
Nature has created this virtuous cycle of seeing and doing powered by"\textbf{spatial} intelligence."To \textbf{illustrate} to you what your \textbf{spatial} intelligence is doing constantly, look at this picture.
Raise your hand if you feel like you want to do something.
In the last split of a second, your brain looked at the geometry of this glass, its place in 3D space, its relationship with the table, the cat and everything else.
And you can predict what ' s going to happen next.
The urge to act is innate to all beings with \textbf{spatial} intelligence, which links perception with action.
...
The recent milestones in \textbf{spatial} intelligence is teaching computers to see, learn, do and learn to see and do better.
This is not easy.
It took nature millions of years to evolve \textbf{spatial} intelligence, which depends on the eye taking light, project 2D images on the retina and the brain to translate these data into 3D information.
...
What nature did to us implicitly in our individual minds, \textbf{spatial} intelligence technology can hope to do for our collective consciousness.
As the progress of \textbf{spatial} intelligence accelerates, a new era in this virtuous cycle is taking place in front of our eyes.
...
But instead of collecting static images, we develop simulation environments powered by 3D \textbf{spatial} models so that the computers can have infinite varieties of possibilities to learn to act.
...
Using large language model-based input, my students and our collaborators are among the first teams that can show a robotic arm performing a variety of tasks based on verbal instructions, like opening this drawer or unplugging a charged phone.
...
Today, that light is reaching the digital minds. \textbf{Spatial} intelligence is allowing machines to interact not only with one another, but with humans, and with 3D worlds, real or virtual.
...
Or alert care teams when a patient is at physical risk, such as falling.
...
Thank you.
The emergence of vision half a billion years ago turned a world of darkness upside down.
...
But I believe the full potential of this digital Cambrian explosion won ' t be fully realized until we power our computers and robots with \textbf{spatial} intelligence, just like what nature did to all of us.
...
But if we do this right, the computers and robots powered by \textbf{spatial} intelligence will not only be useful tools but also trusted partners to enhance and augment our productivity and humanity while respecting our individual dignity and lifting our collective prosperity.
...
% matched lemmas: filter, illustrate, spatial
\end{textsample}
