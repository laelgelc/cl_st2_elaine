\begin{textsample}{POS Dim 6 – 2010 – Score 4.00 – 2010/t002822.txt}  \label{ex:f6_pos_040}
...
But we too rarely \textbf{articulate} and defend and argue about those big moral questions in our politics.
...
And Justice Stevens, writing for the majority, said he had read all about the history of golf, and the essential point of the game is to get very small \textbf{ball} from one place into a hole in as few strokes as possible, and that walking was not essential, but incidental.
...
Here ' s how he put it."To say that something is essential is ordinarily to say that it is necessary to the achievement of a certain object.
...
After all, there ' s no running or jumping, and the \textbf{ball} stands still.
...
% matched lemmas: articulate, ball, illustrate
\end{textsample}
