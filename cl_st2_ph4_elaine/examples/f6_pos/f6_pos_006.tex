\begin{textsample}{POS Dim 6 – 2002 – Score 4.00 – 2002/t000269.txt}  \label{ex:f6_pos_006}
Welcome.
...
I want to try to share just a little bit of that with you in this \textbf{presentation}.
...
Think about the \textbf{typical} kind of robot that you see.
...
Okay.
The point is it ' s really hard to tell, isn ' t it?
...
Here ' s the gecko running up a vertical surface.
...
There ' s the bulldozer version.
Now, it doesn ' t use \textbf{pressure-sensitive} glue.
...
If you need a message, if nature ' s not enough, if you care about search and rescue, or mine clearance, or medicine, or the \textbf{various} things we ' re working on, we must preserve nature ' s designs, otherwise these secrets will be lost forever.
Thank you.

% matched lemmas: presentation, pressure-sensitive, typical, various
\end{textsample}
