\begin{textsample}{POS Dim 6 – 2005 – Score 4.00 – 2005/t000437.txt}  \label{ex:f6_pos_004}
...
I ' m going to show you a \textbf{movie} simulation 16 powers of 10 faster than real time, which shows a patch of the universe where the expansions have subtracted out.
...
Well, we can trace things back to the earlier stages of the Big Bang, but we still don ' t know what \textbf{banged} and why it \textbf{banged}.
...
So there could be another universe just a millimeter away from ours, but we ' re not aware of it because that millimeter is measured in some fourth \textbf{spatial} dimension, and we ' re imprisoned in our three.
...
Many people suspect that just as we ' ve gone from believing in one solar system to zillions of solar systems, one galaxy to many galaxies, we have to go to many Big Bangs from one Big Bang, perhaps these many Big Bangs \textbf{displaying} an immense variety of properties.
...
% matched lemmas: bang, display, movie, spatial
\end{textsample}
