\begin{textsample}{POS Dim 6 – 2019 – Score 4.00 – 2019/t000918.txt}  \label{ex:f6_pos_064}
As a roboticist, I get asked a lot of questions."When we will they start serving me breakfast?"So I thought the future of robotics would be looking more like us.
...
In CG, computer graphics, it ' s not any news — it ' s been done for a while, and that ' s how most of the \textbf{movies} are made.
...
I call this robotic origami,"robogami."This is our first robogami transformation that was made by me about 10 years ago.
From a flat-sheeted robot, it turns into a pyramid and back into a flat sheet and into a space shuttle.
Quite cute.
...
With the same module, we can actually make it do something else : a manipulator, a \textbf{typical}, classical robotic task.
...
They ' re composed of multiple layers of circuits, motors, microcontrollers and sensors, all in the single body, and when you control individual folding joints, you ' ll be able to achieve soft motions like that upon your command.
...
They may be simple, but super interactive.
...
And what you need is a haptic device, a haptic \textbf{interface} that recreates the sensation of touch.
And using robogamis, we can do this.
This is the world ' s smallest haptic \textbf{interface} that can recreate a sensation of touch just underneath your fingertip.
...
Alex has this \textbf{interface} just underneath his thumb, and if he were to use this with VR goggles and hand controllers, now the virtual reality is no longer virtual.
It becomes a tangible reality.
The blue \textbf{ball}, red \textbf{ball} and black \textbf{ball} that he ' s looking at is no longer differentiated by colors.
Now it is a rubber blue \textbf{ball}, sponge red \textbf{ball} and billiard black \textbf{ball}.
This is now possible.
Let me show you.
This is really the first time this is shown live in front of a public grand audience, so hopefully this works.
So what you see here is an atlas of anatomy and the robogami haptic \textbf{interface}.
So, like all the other reconfigurable robots, it multitasks.
Not only is it going to serve as a mouse, but also a haptic \textbf{interface}.
So for example, we have a white background where there is no object.
That means there is nothing to feel, so we can have a very, very flexible \textbf{interface}.
...
This can actually be inside your pocket while you ' re shopping online.
...
This unique specie of reconfigurable robotics is actually the platform to provide this invisible, intuitive \textbf{interface} to meet our exact needs.
These robots will no longer look like the characters from the \textbf{movies}.
Instead, they will be whatever you want them to be.
Thank you.

% matched lemmas: ball, interface, movie, typical
\end{textsample}
