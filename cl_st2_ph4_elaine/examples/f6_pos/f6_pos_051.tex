\begin{textsample}{POS Dim 6 – 2015 – Score 4.00 – 2015/t001563.txt}  \label{ex:f6_pos_051}
...
Hence if the living creature were removed, all these qualities would be annihilated."Now, that ' s a stunning claim.
...
We can have \textbf{various} organisms in artificial worlds compete and see which survive and which thrive, which sensory systems are more fit.
...
Well, fortunately, we have a very helpful metaphor : the desktop \textbf{interface} on your computer.
...
Of course not.
Anyone who thought that misinterprets the purpose of the \textbf{interface}.
It ' s not there to show you the reality of the computer.
In fact, it ' s there to hide that reality.
You don ' t want to know about the \textbf{diodes} and resistors and all the megabytes of software.
If you had to deal with that, you could never write your text file or edit your photo.
So the idea is that evolution has given us an \textbf{interface} that hides reality and guides adaptive behavior.
...
Those microscopic particles are still in space and time : they ' re still in the user \textbf{interface}.
...
CA : So you think it ' s possible — — This is cool, but what you ' re saying I think is it ' s possible that evolution can still get you to reason.
DH : Yes.
...
% matched lemmas: diode, interface, remarkable, various
\end{textsample}
