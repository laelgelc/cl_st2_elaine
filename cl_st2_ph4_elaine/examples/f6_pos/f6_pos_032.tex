\begin{textsample}{POS Dim 6 – 2011 – Score 6.00 – 2011/t002610.txt}  \label{ex:f6_pos_032}
Thank you.
I ' m thrilled to be here.
I ' m going to talk about a new, old material that still continues to amaze us, and that might impact the way we think about material science, high technology â and maybe, along the way, also do some stuff for medicine and for global health and help reforestation.
So that ' s kind of a bold statement.
I ' ll tell you a little bit more.
This material actually has some traits that make it seem almost too good to be true.
It ' s sustainable ; it ' s a sustainable material that is processed all in water and at room temperature â and is biodegradable with a clock, so you can watch it dissolve instantaneously in a glass of water or have it stable for years.
...
And so we marvel at silk worms â the silk worm you see here spinning its fiber.
The silk worm does a \textbf{remarkable} thing : it uses these two ingredients, protein and water, that are in its gland, to make a material that is exceptionally tough for protection â so comparable to technical fibers like Kevlar.
...
And then we use this to do a variety of things â like, for example, this film.
...
It means that you can \textbf{interface} it with some of the things that are \textbf{typical} of technology, like microelectronics and nanoscale technology.
And the image of the DVD here is just to \textbf{illustrate} a point that silk follows very subtle topographies of the surface, which means that it can replicate features on the nanoscale.
...
And the most \textbf{remarkable} feat is that my hand actually stayed still long enough to do that.
So once you have these attributes of this material, then you can do a lot of things.
It ' s actually not limited to films.
And so the material can assume a lot of formats.
And then you go a little crazy, and so you do \textbf{various} optical components or you do microprism arrays, like the reflective tape that you have on your running shoes.
...
What you see there on the screen is a human hair \textbf{superimposed} on the needle that ' s made of silk â just to give you a sense of size.
You can do bigger things.
You can do gears and nuts and bolts â that you can buy at Whole Foods.
...
And so you have here a little example of a small skull â what we call mini Yorick.
...
So you have a clock, you have protein, and now a silk cup like this can be thrown away without guilt â unlike the polystyrene cups that unfortunately fill our landfills everyday.
...
But probably the most \textbf{remarkable} thing is that it comes full circle.
Silk, during its self-assembly process, acts like a cocoon for biological matter.
And so if you change the recipe, and you add things when you pour â so you add things to your liquid silk solution â where these things are enzymes or antibodies or vaccines, the self-assembly process preserves the biological function of these dopants.
So it makes the materials environmentally active and interactive.
So that screw that you thought about beforehand can actually be used to screw a bone together â a fractured bone together â and deliver drugs at the same, while your bone is healing, for example.
...
And so that could be â- that could be potentially a good alternative to solar powered refrigerated camels.
...
% matched lemmas: illustrate, interface, remarkable, superimpose, typical, various
\end{textsample}
