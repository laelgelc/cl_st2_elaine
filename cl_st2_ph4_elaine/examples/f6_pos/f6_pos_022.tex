\begin{textsample}{POS Dim 6 – 2003 – Score 3.00 – 2003/t000242.txt}  \label{ex:f6_pos_022}
...
Assuming â despite all the dire predictions from many people about our future â assuming we ' re still around, I can ' t imagine the world not being populated with robots.
...
Yeah, I think that ' s pretty likely â there ' s going to be lots of robots everywhere.
...
And we ' re starting to see that same sort of thing with robots : LEGO Mindstorms, Furbies â who here â did anyone here have a Furby?
...
And just as in the early days, when there was a lot of sort of amateur interaction over computers, you can now get \textbf{various} hacking kits, how-to-hack books.
And on the left there is a platform from Evolution Robotics, where you put a PC on, and you program this thing with a GUI to wander around your house and do \textbf{various} stuff.
And then there ' s a higher price point sort of robot toys â the Sony Aibo.
...
The top left one is a very nice home-cleaning robot from a company called Dyson, in the U.
K.
Except it was so expensive â 3, 500 dollars â they didn ' t release it.
...
If it hits something â you people see that?
Now it ' s doing wall-following, it ' s following around my feet to clean up around me.
Let ' s see, let ' s â oh, who stole my Rice Krispies?
...
Okay.
I don ' t know if you see â so, I put a bunch of Rice Krispies there, I put some pennies, let ' s just shoot it at that, see if it cleans up.
Yeah, OK.
So â we ' ll leave that for later.
...
It ' s a military surveillance robot, to go in ahead of \textbf{troops} â looking at caves, for instance.
...
Couldn ' t do a lot in the main rubble pile, things were just too â there was nothing left to do.
...
There ' s a sea change happening in how â where technology ' s going.
Thanks.
...
Very hostile environments, 150Ë C, 10, 000 PSI.
...
And I want to actually use a robot here â a robot named Chris â stand up.
Yeah.
Okay.
Come over here.
Now notice, he thinks robots have to be a bit stiff.
He sort of does that.
But I ' m going to â Chris Anderson : I ' m just British.
RB : Oh.
...
His eyes are going back and forth up to me, to see what I ' m looking at â so we ' ve got shared attention.
...
So in the videos I ' m about to show you, you ' re going to see a visual attention system on a robot which has â it looks for skin tone in HSV space, so it works across all human colorings.
It looks for highly saturated colors, from toys.
And it looks for things that move around.
And it weights those together into an attention window, and it looks for the highest-scoring place â the stuff where the most interesting stuff is happening â and that is what its eyes then segue to.
...
Did people see the \textbf{movie}"AI"?
RB : Yeah, it was really bad, but â remember, especially when Haley Joel Osment, the little robot, looked at the blue fairy for 2, 000 years without taking his eyes off it?
...
So, once you ' ve got that â and here ' s a robot, here ' s Kismet, looking around for a toy.
...
But it ' s still going to pay attention if something more significant comes into its field of view â such as Cynthia Breazeal, the builder of this robot, from the right.
...
And at different places in that space, it expresses â can we have the volume on here?
...
And I want you to watch carefully, at the beginning of this, where this person, Ritchie, who happened to talk to the robot for 25 minutes â â says,"I want to show you something.
...
We don ' t know whether he understood or not that the robot â Notice the turn-taking.
Ritchie : OK, I want to show you something.
OK, this is a watch that my girlfriend gave me.
Robot : Oh, cool.
Ritchie : Yeah, look, it ' s got a little blue light in it too.
...
But then the big questions, two big questions that people ask me are : if we make these robots more and more human-like, will we accept them, will we â will they need rights eventually?
And the other question people ask me is, will they want to take over?
And on the first â you know, this has been a very Hollywood theme with lots of \textbf{movies}.
You probably recognize these characters here â where in each of these cases, the robots want more respect.
...
And it ' s moving forward, you know, propelled by \textbf{various} charges, and then the soul steps in and tweaks those molecules so that they connect.
...
And to imagine â you know, it ' s always hard for us.
Recently we ' ve been battered with the idea that maybe we didn ' t even have our own creation event, here on earth, which people didn ' t like much.
And then the human genome said, maybe we only have 35, 000 genes.
And that was really â people didn ' t like that, we ' ve got more genes than that.
We don ' t like to give up our special-ness, so, you know, having the idea that robots could really have emotions, or that robots could be living creatures â I think is going to be hard for us to accept.
...
And that ' s sort of like this lone guy in the backyard, you know â"I accidentally built a 747."I don ' t think that ' s going to happen.
And I don ' t think â â I don ' t think we ' re going to deliberately build robots that we ' re uncomfortable with.
We ' ll â you know, they ' re not going to have a super bad robot.
...
% matched lemmas: movie, troop, various
\end{textsample}
