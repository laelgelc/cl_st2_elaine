\begin{textsample}{POS Dim 6 – 2004 – Score 3.00 – 2004/t000196.txt}  \label{ex:f6_pos_028}
...
I was at a ski resort in Switzerland without any money to actually enjoy myself, because the snow had melted and I didn ' t have money to go to a \textbf{movie}.
But I found that on the â I read in the newspapers that there was to be a \textbf{presentation} by someone in a place that I ' d seen in the center of Zurich, and it was about flying saucers [ that ] he was going to talk.
And I thought, well, since I can ' t go to the \textbf{movies}, at least I will go for free to listen to flying saucers.
...
This is a \textbf{typical} result that many people have presented, and there are many variations on it.
...
So, arousal is the area where most people learn from, because that ' s where they ' re pushed beyond their comfort zone and to enter that â going back to flow â then they develop higher skills.
...
% matched lemmas: movie, presentation, typical
\end{textsample}
