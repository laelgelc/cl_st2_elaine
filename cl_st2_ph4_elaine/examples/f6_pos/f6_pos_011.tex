\begin{textsample}{POS Dim 6 – 2008 – Score 4.00 – 2008/t000156.txt}  \label{ex:f6_pos_011}
...
So we ' re keeping, like, a million \textbf{balls} in the air but, what ' s going on?
...
That is matter that doesn ' t interact with light the \textbf{typical} way that ordinary matter does, the way the light ' s shining on me or on the stage.
...
So I ' ll show you the next \textbf{movie}.
...
% matched lemmas: ball, movie, typical
\end{textsample}
