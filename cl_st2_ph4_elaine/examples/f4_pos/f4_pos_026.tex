...
I missed the ' 60s.
I read about them ; I understand they were pretty \textbf{interesting}.
...
Maybe I should get away from this map completely, and really be honest about wanting to show you my favorite bits and pieces of Rome and simply kick a soccer ball in the \textbf{air} — which happens in so many of the squares in the city — and let it bounce off of things.
...
Over the Piazza of Saint Ignacio, completely ruining the symmetry, but that aside a spectacular place to \textbf{visit}.
...
Unfortunately for her, the anchor line gets tangled around the feet of some Boy Scouts who are \textbf{visiting} the Pantheon, and they are immediately yanked out and given an extraordinary but terrifying tour of some of the domes of Rome, which would, from their point of view, naturally be hanging upside down.
...
Anyway, the pooch gets back to the dirigible with the \textbf{stuff}.
...
Marcello, on the other hand, is sort of a lazy \textbf{guy}, but he ' s not due at work until about noon.
...
Everything he sees from this point on is slightly affected by the linguine, but keeps on moving because this \textbf{guy} ' s got a job to do.
...
The \textbf{phone} rings anyway, he ' s called to the palazzo.
He saunters — he saunters at a good clip, but as compared to all the traveling we ' ve just seen, he ' s sauntering. \textbf{Everybody} knows Carletto, because he ' s in entertainment, actually ; he ' s in television.
...
He removes it, the problems are solved, \textbf{everybody} in the palazzo is happy.
...
You can see that in 1635, it became essential to make smaller windows because the bad \textbf{guys} were coming or whatever.
...
Goes off during the day and does normal pigeon \textbf{stuff}.
...
And I thought, that ' s sort of \textbf{interesting}, but maybe there ' s a person who should be \textbf{involved} in this in some way.
So I kind of came up with this old \textbf{guy} who spends his life looking after sick pigeons.
He ' ll go anywhere to get them — dangerous places and whatnot — and they become really friends with this \textbf{guy}, and learn to do tricks for him and entertain him at lunchtime and \textbf{stuff} like that.
...
Through the alley, we can see the \textbf{impact} is captured in the red line.
...
% matched lemmas: air, everybody, guy, impact, interested, interesting, involve, phone, stuff, visit
\end{textsample}
