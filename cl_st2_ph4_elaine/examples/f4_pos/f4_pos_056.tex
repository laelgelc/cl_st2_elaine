\begin{textsample}{POS Dim 4 – 2008 – Score 15.00 – 2008/t000296.txt}  \label{ex:f4_pos_056}
...
When they were released, we left and we went as \textbf{refugees} to Kenya and Tanzania.
...
I used to try to take the kids outside as often as possible, to try to connect the academic \textbf{stuff} with the real world.
And they weren ' t used to that.
But I took them outside one day and I said,"I want you to estimate the height of the building."And I expected them to put a ruler next to the wall, size it up with a finger, and make an estimate of the height.
...
I want you to estimate the height of the building."He said,"OK.
I measured the height of a brick.
I counted the number of bricks and now I ' m multiplying."Well — — I hadn ' t thought of that one.
...
What banged?""Everyone talks about the Big Bang.
What banged?"And she ' s right.
It ' s a question we ' ve all been avoiding.
...
Well, I got \textbf{interested} in this because it seemed to me that it was an obvious question.
...
It \textbf{involves} gravitational waves.
...
Now, this is 1990, and then 2002.
...
And this was very eloquently argued at \textbf{TED} Africa : that all of the aid that ' s been given has completely failed to put Africa onto its own two feet.
Well, the \textbf{transition} to democracy in South Africa in 1994 was literally a dream come true for many of us.
My parents were both elected to the first parliament, alongside Nelson and Winnie Mandela.
They were the only other couple.
And in 2001, I took a research leave to \textbf{visit} them.
...
The \textbf{ability} to make and test models has become essential, not only to every single area of science today, but also to modern society itself.
...
It ' s very, very \textbf{interesting} what ' s happening.
...
They ' ll publish, be invited to \textbf{conferences}.
They ' ll do well.
...
And they ' ve all gone on to master ' s and Ph.
D. degrees in excellent places.
Five students can be educated at AIMS for the cost of educating one in the U.
S. or Europe.
...
After that, I came to the Netherlands where I ' m now doing a Ph.
D. in theoretical immunology.
Professor : Tendai is working very independently.
She communicates well with the immunologists at the hospital.
So all in all I have a very good Ph.
D. student from South Africa.
...
He ' s about to finish his Ph.
D., and he was filmed recently with someone you all know.
...
So now I ' m going to get to my \textbf{TED} business.
Well, we had a party.
...
So now let me get to our \textbf{TED} wish.
Well, it ' s not my \textbf{TED} wish ; it ' s our wish, as you ' ve already gathered.
And our wish has two parts : one is a dream and the other ' s a plan.
OK.
Our \textbf{TED} dream is that the next Einstein will be African.
...
We want to add entrepreneurship and \textbf{policy} skills.
...
Over the last year, we ' ve been \textbf{visiting} sites in Africa, looking at potential sites for new AIMS centers.
And here are the ones we ' ve selected.
And each of these centers has a strong local team, each is in a beautiful place, an \textbf{interesting} place, which \textbf{international} lecturers will be happy to \textbf{visit}.
And our partners across Africa are extremely enthusiastic about this.
Everyone wants an AIMS center in their country.
And last November, the \textbf{conference} of all the African ministers of science and technology, held in Mombasa, called for a comprehensive plan to roll out AIMS.
So we have political \textbf{support} right across the continent.
It won ' t be easy.
...
% matched lemmas: ability, conference, interested, interesting, international, involve, policy, refugee, stuff, support, ted, transition, visit
\end{textsample}
