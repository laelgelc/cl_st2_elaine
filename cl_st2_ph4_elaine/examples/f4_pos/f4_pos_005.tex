\begin{textsample}{POS Dim 4 – 1990 – Score 10.00 – 1990/t000287.txt}  \label{ex:f4_pos_005}
I ' m going to go right into the slides.
And all I ' m going to try and prove to you with these slides is that I do just very straight \textbf{stuff}.
...
The garage on the right â the gray structure â will be torn down, finally, and several small classrooms will be placed along this avenue that we ' ve created, this campus.
...
And it was my theory, or my point of view, that one didn ' t upstage the neighborhood â one made accommodations.
I tried to be inclusive, to include the buildings in the neighborhood, whether they were buildings I liked or not.
In the ' 60s I started working with paper furniture and made a bunch of \textbf{stuff} that was very successful in Bloomingdale ' s.
We even made flooring, walls and everything, out of cardboard.
And the success of it threw me for a loop.
I couldn ' t deal with the success of furniture â I wasn ' t secure enough as an architect â and so I closed it all up and made furniture that nobody would like.
...
The piece on the left â and that ultimately led to the piece on the right â happened when the kid that was working on this took one of those long strings of \textbf{stuff} and folded it up to put it in the wastebasket.
...
I got into fish.
I mean, the story I tell is that I got mad at postmodernism â at po-mo â and said that fish were 500 million years earlier than man, and if you ' re going to go back, we might as well go back to the beginning.
...
And I love sake and Kobe and all that \textbf{stuff}.
And after I got â I was really drunk â I was asked to do some sketches on napkins.
And I made some sketches on napkins â little boxes and Morandi-like things that I used to do.
And the client said,"Why no fish?"And so I made a drawing with a fish, and I left Japan.
...
Now, if you saw a picture of this as it was published in Architectural Record â they didn ' t show the context, so you would think,"God, what a pushy \textbf{guy} this is."But a friend of mine spent four hours wandering around here looking for this restaurant.
Couldn ' t find it.
So...
...
And so we built a temporary building â I ' m getting good at temporary â and we put a \textbf{conference} room in that ' s a fish.
And, finally, Jay dragged me to my hometown, Toronto, Canada.
And there is a story â it ' s a real story â about my grandmother buying a carp on Thursday, bringing it home, putting it in the bathtub when I was a kid.
...
People hate it.
And I ' m fascinated with that, which, like the paper furniture â it ' s one of those materials.
...
And it was this interaction between that kind of, up-the-ante \textbf{stuff} that became pretty \textbf{interesting}.
It led to the building on the left.
And I still think the Time magazine picture will be of the binoculars, you know, leaving out the â what the hell.
...
The metalworkers, for the most part, do ducts behind the ceilings and \textbf{stuff}.
...
And it ' s working very well to have these people, these craftsmen, \textbf{interested} in it.
...
The metal continued into a building â Herman Miller, in Sacramento.
...
I spent a lot of time undoing Richard Meier ' s aesthetic. \textbf{Everybody} ' s trying to get the panels perfect, and I always try to get them sloppy and fuzzy.
...
Because these were ideas that we were talking about, building things next to each other, making â it ' s all about [ a ] metaphor for a city, maybe.
And so Stanley did the little dome thing.
And we did it over the \textbf{phone} and by fax.
...
It was a very prominent building off the freeway, and we added a floor and cleaned it up and fixed it up and used the kind of â I thought â the language of the neighborhood, which had these cornices, projecting cornices.
...
And then more metal and some chain link in Santa Monica â a little shopping center.
And this is a laser laboratory at the University of Iowa, in which the fish comes back as an abstraction in the back.
It ' s the \textbf{support} labs, which, by some coincidence, required no windows.
And the shape fit perfectly.
I just joined the points.
In the curved part there ' s all the mechanical equipment.
That solid wall behind it is a pipe chase â a pipe canyon â and so it was an opportunity that I seized, because I didn ' t have to have any protruding ducts or vents or things in this form.
...
The reality, with the lake â the workmanship is pretty bad.
And it reminded me why I play defensively in things like my house.
When you have to do something really cheaply, it ' s hard to get perfect corners and \textbf{stuff}.
That big metal thing is a passage, and in it is â you go downstairs into the living room and then down into the bedroom, which is on the right.
...
It ' s made of metal and the brown \textbf{stuff} is Fin-Ply â it ' s that formed lumber from Finland.
...
And all this \textbf{stuff} at the bottom is a museum, and an idea for a very fancy automobile entry.
This owner has a pet peeve about bad automobile entries.
And this would be a hotel.
So, the centerline of this thing â we ' d preserve it, and it would start to work with the scale of the new buildings by Pelli and Kohn Pederson Fox, etc., that are underway.
...
The Minister of Finance â the \textbf{guy} that moved from the Louvre â goes in here.
There ' s a new library across the river.
And back in here, in this already treed park, we ' re doing a very dense building called the American Center, which has a theater, apartments, dance school, an art museum, restaurants and all kinds of â it ' s a very dense program â bookstores, etc.
...
I was trying to get around this plan coupe â how do you do it?
Apartments, etc.
...
If any of you \textbf{guys} have any ideas for it, please contact me.
...
This is Euro Disney, and I ' ve worked with all of the \textbf{guys} that presented to you earlier.
...
In Switzerland â Germany, actually â on the Rhine across from Basel, we did a furniture factory and a furniture museum.
...
It ' s actually basically three square rooms with a couple of skylights and \textbf{stuff}.
...
But \textbf{everybody} liked these forms and liked the space, and so that ' s one of the problems of a competition.
You have to then try and get that back in some way.
And we studied many models.
This was our original model.
These were the three buildings that were the ideal â the Concertgebouw, Boston and Berlin. \textbf{Everybody} liked the surround.
Actually, this is the smallest hall in size, and it has more seats than any of these because it has double balconies.
Our client doesn ' t want balconies, so â and when we met our new acoustician, he told us this was the right shape or this was the right shape.
...
We studied the acoustics with laser \textbf{stuff}, and they bounce them off this and see where it all works.
...
A.
I was asked to do a sculpture at the foot of Interstate Bank Tower, the highest building in L.
A.
...
And the food wasn ' t as good as the \textbf{stuff}, and so it failed.
It should have been the other way around â the food should have been good first.
It didn ' t work.
Thank you very much.

% matched lemmas: conference, everybody, guy, interested, interesting, phone, stuff, support
\end{textsample}
