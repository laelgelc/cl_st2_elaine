\begin{textsample}{POS Dim 4 – 2015 – Score 19.00 – 2015/t001120.txt}  \label{ex:f4_pos_053}
...
Well, I know a little bit about what this is like, because when I was a medical student in 1999, I worked in a \textbf{refugee} camp in the Balkans during the Kosovo War.
...
Postwar Kosovo was a very \textbf{interesting} place because NATO troops were there, mostly to make sure the war didn ' t break out again.
...
For me, that moment came when I had to cross the first checkpoint, and I realized as I drove up that I would be \textbf{negotiating} passage through this checkpoint with a heavily armed individual who, if he decided to shoot me right then and there, actually wouldn ' t be doing anything illegal.
But the sense of vulnerability that I had was absolutely nothing in comparison to the vulnerability of the families that I got to know over that year.
You see, life in a society where there are no social institutions is riddled with danger and \textbf{uncertainty}, and simple questions like,"What are we going to eat tonight?"are very complicated to answer.
...
What am I going to do?""My sister, who is pregnant, is bleeding.
What should I do?
Who should I turn to?""Where are the doctors, where are the nurses?
If I could find one, are they trustworthy?
How will I pay them?
In what currency will I pay them?""If I need medications, where will I find them?
If I take those medications, are they actually counterfeits?"And on and on.
So for life in these settings, the \textbf{dominant} theme, the \textbf{dominant} feature of life, is the incredible vulnerability that people have to manage day in and day out, because of the lack of social systems.
...
I came back to Boston, I became a physician, I became a global public health \textbf{policy} researcher.
...
Is there any way we can start to think about how to protect and quickly recover the institutions that are critical to survival, like the health system?"And I have to say, I had amazing colleagues.
But one \textbf{interesting} thing about it was, this was sort of an unusual question for them.
They were kind of like,"Oh, if you work in war, doesn ' t that mean you work on \textbf{refugee} camps, and you work on \textbf{documenting} mass atrocities?"— which is, by the way, very, very, very important.
...
These researchers concluded that the vast majority of death and disability from war happens after the cessation of \textbf{conflict}.
...
But what is surprising and somewhat dismaying, is how little \textbf{impact} this insight has had, in terms of how we think about human suffering and war.
...
When the earthquake hit Haiti in 2010, the outpouring of \textbf{international} aid was phenomenal.
But did you know that only two percent of that funding went to rebuild Haitian public institutions, including its health \textbf{sector}?
...
When his health \textbf{sector} fails — and if history is any guide, it will — how do you think that ' s going to influence the decision making of the five million people in his region as they think about whether they should flee that type of vulnerable living situation?
So as you can see, this is a frustrating topic for me, and I really try to understand : Why the reluctance to protect and \textbf{support} indigenous health systems and security systems?
...
And I will admit that I have met unsavory characters working in health \textbf{sectors} in these situations.
...
One of the unsung and untold success stories of our nation-building effort in Afghanistan \textbf{involved} the World Bank in 2002 \textbf{investing} heavily in identifying, training and promoting Afghani health \textbf{sector} \textbf{leaders}.
These health \textbf{sector} \textbf{leaders} have pulled off an incredible feat in Afghanistan.
...
They use things like data to make \textbf{policy}.
It ' s incredible.
The other concern I hear a lot about is :"We just can ' t afford it, we just don ' t have the money.
It ' s just unsustainable."I would submit to you that the current situation and the current system we have is the most expensive, inefficient system we could possibly conceive of.
...
Ninety-five percent of it goes to \textbf{international} relief agencies, that then have to import resources into these areas, and knit together some type of temporary health system, let ' s say, which they then dismantle and send away when they run out of money.
So our job, it turns out, is very clear.
We, as the global health community \textbf{policy} experts, our first job is to become experts in how to monitor the strengths and vulnerabilities of health systems in threatened situations.
...
Number two : places like where I work at Harvard need to take their cue from the World Bank experience in Afghanistan, and we need to — and we will — build robust platforms to \textbf{support} health \textbf{sector} \textbf{leaders} like these.
These people risk their lives.
I think we can match their courage with some \textbf{support}.
Number three : we need to reach out and make new partnerships.
At our global health center, we have launched a new initiative with NATO and other security \textbf{policy} makers to explore with them what they can do to protect health system institutions during deployments.
...
Because unless you understand the value of social institutions, like health systems in these fragile settings, you won ' t \textbf{support} efforts to save them.
You won ' t click on that article that talks about"Hey, all those doctors are on the run in country X.
I wonder what that means.
I wonder what that means for that health system ' s \textbf{ability} to, let ' s say, detect influenza.""Hmm, it ' s probably not good."That ' s what I ' d tell you.
Up on the screen, I ' ve put up my three favorite American institution defenders and builders.
Over here is George C.
Marshall, he was the \textbf{guy} that proposed the Marshall Plan to save all of Europe ' s economic institutions after World War II.
And this Eleanor Roosevelt.
Her work on human rights really serves as the foundation for all of our \textbf{international} human rights organizations.
...
% matched lemmas: ability, conflict, document, dominant, guy, impact, interesting, international, invest, involve, leader, negotiate, policy, refugee, sector, support, uncertainty
\end{textsample}
