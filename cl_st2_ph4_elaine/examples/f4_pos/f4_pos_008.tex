\begin{textsample}{POS Dim 4 – 2006 – Score 18.00 – 2006/t000489.txt}  \label{ex:f4_pos_008}
...
When I was about 24 years old, Kate Stohr and myself started an organization to get architects and designers \textbf{involved} in humanitarian work, not only about responding to natural disasters, but \textbf{involved} in systemic issues.
...
So I started my life as an architect, or training as an architect, and I was always \textbf{interested} in socially responsible design, and how you can really make an \textbf{impact}.
...
And in 1999, we started by responding to the issue of the housing \textbf{crisis} for returning \textbf{refugees} in Kosovo.
...
Two years later we started doing a project on developing mobile health clinics in sub-Saharan Africa, responding to the HIV / AIDS \textbf{pandemic}.
That led to 550 entries from 53 countries.
We also have designers from around the world that participate.
And we had an exhibit of work that followed that. 2004 was the tipping point for us.
We started responding to natural disasters and getting \textbf{involved} in Iran, in Bam, also following up on our work in Africa.
...
So we got \textbf{involved} in and worked in inner cities and elsewhere ; and also, I will go into some more projects. 2005 : Mother Nature kicked our ass.
I think we can pretty much assume that 2005 was a horrific year when it comes to natural disasters.
And because of the Internet, and because of connections to blogs and so forth, within literally hours of the tsunami, we were already raising funds, getting \textbf{involved}, working with people on the ground.
We run from a couple of laptops, and in the first couple of days, I had 4, 000 emails from people needing help.
So we began to get \textbf{involved} in projects there, and I ' ll talk about some others.
...
It was all coming into my laptop and cell \textbf{phone}.
So we decided to embrace an open- source model of business — so that anyone, anywhere in the world, could start a local chapter, and they can get \textbf{involved} in local problems.
...
What it showed me is that there ' s a grassroots movement going on, of socially responsible designers who really believe that this world has got a lot smaller, and that we have the opportunity — not the responsibility, but the opportunity — to really get \textbf{involved} in making change.
...
And so there ' s something to be said about na{\EmojiFont �}{\EmojiFont �}vet{\EmojiFont �}{\EmojiFont �}.
So seven years later, we ' ve developed so that we ' ve got advocacy, instigation and implementation.
We advocate for good design, not only through student workshops and lectures and public forums, op-eds ; we have a book on humanitarian work ; but also disaster mitigation and dealing with public \textbf{policy}.
...
Within three days, we realized the problem was not housing ; it was the growing \textbf{pandemic} of HIV / AIDS.
...
And we started engaging the medical community, and you know, we thought we were real bright sparks —"We ' ve come up with this great idea : mobile health clinics, widely distributed throughout sub-Saharan Africa."And the medical community there said,"We ' ve said this for the last decade.
We know this.
We just don ' t know how to show this."So in a way, we had taken pre- existing needs and shown solutions.
...
So that there would be a very slow way of developing \textbf{confidence} in health care.
...
But what we ' re known probably most for is dealing with disasters and development, and we ' ve been \textbf{involved} in a lot of issues, such as the tsunami and also things like Hurricane Katrina.
...
The kids actually get \textbf{involved} in mapping out where the community center should be.
And then eventually, the community, through skills training, end up building the building with us.
Here is another school.
This is what the UN gave these \textbf{guys} for six months — 12 plastic tarps.
This was in August.
...
They formed a partnership, a diverse partnership of players, to actually map out East Biloxi, to figure out who ' s getting \textbf{involved}.
...
They ' re photographers who had \textbf{documented} the Lower Ninth for the last 40 years.
That was their home, and these are the photographs they took.
And we ' re helping, working with them to create a new building.
Projects we ' ve done.
Projects we ' ve been a part of, \textbf{support}.
...
There are hundreds and hundreds and hundreds and hundreds and hundreds of architects and designers and inventors around the world that are getting \textbf{involved} in humanitarian work.
More hemp houses — it ' s a theme in Japan, apparently.
I ' m not sure what they ' re smoking.
This is a Grip Clip, designed by somebody who said,"All you need is some way to attach membrane structures to physical \textbf{support} beams."This \textbf{guy} designed for NASA, is now doing housing.
...
The average age of a designer who gets \textbf{involved} in this project is 32 — that ' s how old I am.
...
And when you look at this, you see \textbf{crisis}.
...
If we do nothing about the housing \textbf{crisis} that ' s about to happen, in 20 years, one in three people will live in an unplanned settlement or a \textbf{refugee} camp.
...
Designers want to respond to issues of humanitarian \textbf{crisis}, but they don ' t want some company in the West taking their idea and basically profiting from it.
...
As soon as that is built, anyone in Africa or any developing nation can take the construction \textbf{documents} and replicate it for free.
...
When you look at the face of an architect, most people think a gray-haired white \textbf{guy}.
...
I want every Arup engineer in the world to check and make sure that we ' re doing \textbf{stuff} that ' s standing, because those \textbf{guys} are the best in the world.
Plug.
...
My mom once said,"There ' s nothing worse than being all mouth and no trousers."I ' m fed up of talking about making change.
You only make it by doing it.
We ' ve changed FEMA guidelines ; we ' ve changed public \textbf{policy} ; we ' ve changed \textbf{international} response — based on building things.
...
% matched lemmas: confidence, crisis, document, guy, impact, interested, international, involve, pandemic, phone, policy, refugee, stuff, support
\end{textsample}
