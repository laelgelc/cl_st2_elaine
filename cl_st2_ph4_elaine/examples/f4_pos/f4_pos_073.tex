\begin{textsample}{POS Dim 4 – 2012 – Score 15.00 – 2012/t002337.txt}  \label{ex:f4_pos_073}
America ' s public energy conversation boils down to this question : Would you rather die of A ) oil wars, or B ) \textbf{climate} change, or C ) nuclear holocaust, or D ) all of the above?
...
But now we need a new fire that makes us \textbf{safe}, secure, healthy and durable.
Let ' s see how.
...
And switching from the old fire to the new fire means changing two big stories about oil and electricity, each of which puts two- fifths of the fossil carbon in the \textbf{air}.
...
Yet this cheaper energy system could \textbf{support} 158 percent bigger U.
S. economy all without needing oil or coal, or for that matter nuclear energy.
Moreover, this \textbf{transition} needs no new inventions and no acts of Congress and no new federal taxes, mandate subsidies or laws and running Washington gridlock.
...
And whether you care most about profits and jobs and competitive advantage or national security, or environmental stewardship and \textbf{climate} protection and public health, reinventing fire makes sense and makes money.
...
So in reinventing fire, we integrated all four \textbf{sectors} that use energy — transportation, buildings, industry and electricity — and we integrated four kinds of innovation, not just technology and \textbf{policy}, but also design and business strategy.
...
Currently the \textbf{leader} is Germany.
...
And they said,"We do not intend to be a typewriter maker."Audi \textbf{claimed} it ' s going to beat them both by a year.
...
They can save lives because this \textbf{stuff} can absorb up to 12 times as much crash energy per pound as steel.
...
Those 125 to 240 mile-per-gallon-equivalent autos can use any mixture of \textbf{hydrogen} fuel cells, electricity and advanced biofuels.
The trucks and planes can realistically use \textbf{hydrogen} or advanced biofuels.
The trucks could even use natural gas.
But no vehicles will need oil.
And the most biofuel we might need, just three million barrels a day, can be made two-thirds from waste without displacing any cropland and without harming soil or \textbf{climate}.
...
And the long \textbf{transition} is already well under way.
In fact, three years ago mainstream analysts were starting to see peak oil, not in supply, but in \textbf{demand}.
...
And those twin revolutions in electricity will bring to that \textbf{sector} more numerous and profound and diverse disruptions than any other \textbf{sector}, because we ' ve got 21st century technology and speed colliding head-on with 20th and 19th century institutions, rules and cultures.
...
Such unregulated products could ultimately add up to a virtual utility that bypasses your electric company just as your cellphone bypassed your wireline \textbf{phone} company.
...
And that ' s true both for continental areas like the U.
...
But those four futures at the same cost differ profoundly in their risks, around national security, fuel, water, finance, technology, \textbf{climate} and health.
...
We want our \textbf{stuff} to work too.
...
Together, efficient use and diverse dispersed renewable supply are starting to transform the whole electricity \textbf{sector}.
...
However, especially where regulators are now instead rewarding cutting your bills, the investments are shifting radically toward efficiency, \textbf{demand} response, cogeneration, renewables and ways to knit them all together reliably with less transmission and little or no bulk electricity storage.
...
Big discoveries are protected by public incredulity."Now combine the electricity and oil revolutions, both driven by modern efficiency, and you get the really big story : reinventing fire, where business enabled and sped by smart \textbf{policies} in mindful markets can lead the United States completely off oil and coal by 2050, saving 5 trillion dollars, growing the economy 2. 6- fold, strengthening out national security, oh, and by the way, by getting rid of the oil and coal, reducing the fossil carbon emissions by 82 to 86 percent.
Now if you like any of those outcomes, you can \textbf{support} reinventing fire without needing to like all of them and without needing to agree about which of them is most important.
So focusing on outcomes, not motives, can turn gridlock and \textbf{conflict} into a unifying solution to America ' s energy challenge.
This also turns out to be the best way to cope with global challenges — \textbf{climate} change, nuclear proliferation, energy insecurity, energy poverty — all of which make us less \textbf{safe}.
...
Former oil man Maurice Strong said,"Not all the fossils are in the fuel."But as Edgar Woolard, who used to chair Dupont, reminds us,"Companies hampered by old thinking won ' t be a problem because,"he said,"they simply won ' t be around long-term."I ' ve described not just a once-in-a-civilization business opportunity, but one of the most profound \textbf{transitions} in the history of our species.
...
So with the conversation just begun at ReinventingFire. com, let me invite you each to engage with us and with each other, with everyone around you, to help make the world richer, fairer, cooler and \textbf{safer} by together reinventing fire.
Thank you.

% matched lemmas: air, claim, climate, conflict, demand, hydrogen, leader, phone, policy, safe, sector, stuff, support, transition
\end{textsample}
