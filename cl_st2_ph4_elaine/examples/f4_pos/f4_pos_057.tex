\begin{textsample}{POS Dim 4 – 2008 – Score 15.00 – 2008/t000275.txt}  \label{ex:f4_pos_057}
I have given the slide show that I gave here two years ago about 2, 000 times.
I ' m giving a short slide show this morning that I ' m giving for the very first time, so â well it ' s â I don ' t want or need to raise the bar, I ' m actually trying to lower the bar.
...
As Mahatma Gandhi famously said,"You must become the change you wish to see in the world."And the outcome about which we wish to be optimistic is not going to be created by the belief alone, except to the extent that the belief brings about new behavior.
But the word"behavior"is also, I think, sometimes misunderstood in this context.
I ' m a big advocate of changing the lightbulbs and buying hybrids, and Tipper and I put 33 solar panels on our house, and dug the geothermal wells, and did all of that other \textbf{stuff}.
...
In order to solve the \textbf{climate} \textbf{crisis}, we have to solve the democracy \textbf{crisis}.
And we have one.
...
And so I said,"How do you do?"And she said,"You know, if you dyed your hair black, you would look just like Al Gore."Many years ago, when I was a young congressman, I spent an awful lot of time dealing with the challenge of nuclear arms control â the nuclear arms race.
And the military historians taught me, during that quest, that military \textbf{conflicts} are typically put into three categories : local battles, regional or theater wars, and the rare but all-important global, world war â strategic \textbf{conflicts}.
And each level of \textbf{conflict} requires a different allocation of resources, a different approach, a different organizational model.
Environmental challenges fall into the same three categories, and most of what we think about are local environmental problems : \textbf{air} pollution, water pollution, hazardous waste dumps.
...
But the \textbf{climate} \textbf{crisis} is the rare but all-important global, or strategic, \textbf{conflict}.
Everything is affected.
And we have to organize our response appropriately.
We need a worldwide, global mobilization for renewable energy, conservation, efficiency and a global \textbf{transition} to a low-carbon economy.
We have work to do.
...
Greenland remains.
Twenty-eight years ago, this is what the polar ice cap â the North Polar ice cap â looked like at the end of the summer, at the fall equinox.
...
The North Polar ice cap is the same size geographically â doesn ' t look quite the same size â but it is exactly the same size as the United States, minus an area roughly equal to the state of Arizona.
...
It comes back in the winter, but not as permanent ice, as thin ice â vulnerable.
The amount remaining could be completely gone in summer in as little as five years.
That puts a lot of pressure on Greenland.
Already, around the Arctic Circle â this is a famous village in Alaska.
This is a town in Newfoundland.
Antarctica.
Latest studies from NASA.
The amount of a moderate-to-severe snow melting of an area equivalent to the size of California."They were the best of times, they were the worst of times": the most famous opening sentence in English literature.
...
Now, briefly, here ' s an image you ' ve seen, as one of the only old images, but I show it because I want to briefly give you CSI : \textbf{Climate}.
...
Well, the Alliance for \textbf{Climate} Protection, which I head in conjunction with Current TV â who did this pro bono â did a worldwide contest to do commercials on how to communicate this.
This is the winner.
NBC â I ' ll show all of the networks here â the top journalists for NBC asked 956 questions in 2007 of the presidential candidates : two of them were about the \textbf{climate} \textbf{crisis}.
ABC : 844 questions, two about the \textbf{climate} \textbf{crisis}.
Fox : two.
CNN : two.
CBS : zero.
From laughs to tears â this is one of the older tobacco commercials.
...
If the wealthy countries were completely missing from the picture, we would still have this \textbf{crisis}.
But we have given to the developing countries the technologies and the ways of thinking that are creating the \textbf{crisis}.
This is in Bolivia â over thirty years.
...
We need a CO2 tax, revenue neutral, to replace taxation on employment, which was invented by Bismarck â and some things have changed since the 19th century.
In the poor world, we have to integrate the responses to poverty with the solutions to the \textbf{climate} \textbf{crisis}.
Plans to fight poverty in Uganda are mooted, if we do not solve the \textbf{climate} \textbf{crisis}.
...
These are concentrating solar, renewable energy plants, linked in a so-called"supergrid"to supply all of the electrical power to Europe, largely from developing countries â high-voltage DC currents.
...
If you are \textbf{investing} in tar sands or shale oil, then you have a portfolio that is crammed with sub-prime carbon assets.
...
The only two countries that didn ' t ratify â and now there ' s only one.
Australia had an election.
And there was a campaign in Australia that \textbf{involved} television and Internet and radio commercials to lift the sense of urgency for the people there.
...
The cities \textbf{supporting} Kyoto in the U.
S. are up to 780 â and I thought I saw one go by there, just to localize this â which is good news.
...
Those of us who are alive in the United States of America today especially, but also the rest of the world, have to somehow understand that history has presented us with a choice â just as Jill [ Bolte ] Taylor was figuring out how to save her life while she was distracted by the amazing experience that she was going through.
...
Sometimes I hear people respond to the disturbing facts of the \textbf{climate} \textbf{crisis} by saying,"Oh, this is so terrible.
...
I think we ought to approach this challenge with a sense of profound joy and gratitude that we are the generation about which, a thousand years from now, philharmonic orchestras and poets and singers will celebrate by saying, they were the ones that found it within themselves to solve this \textbf{crisis} and lay the basis for a bright and optimistic human future.
Let ' s do that.
Thank you very much.
Chris Anderson : For so many people at \textbf{TED}, there is deep pain that basically a design issue on a voting form â one bad design issue meant that your voice wasn ' t being heard like that in the last eight years in a position where you could make these things come true.
That hurts.
Al Gore : You have no idea.
CA : When you look at what the leading candidates in your own party are doing now â I mean, there ' s â are you excited by their plans on global warming?
AG : The answer to the question is hard for me because, on the one hand, I think that we should feel really great about the fact that the Republican nominee â certain nominee â John McCain, and both of the finalists for the Democratic nomination â all three have a very different and forward-leaning position on the \textbf{climate} \textbf{crisis}.
All three have offered \textbf{leadership}, and all three are very different from the approach taken by the current administration.
And I think that all three have also been responsible in putting forward plans and proposals.
But the campaign dialogue that â as illustrated by the questions â that was put together by the League of Conservation Voters, by the way, the analysis of all the questions â and, by the way, the debates have all been sponsored by something that goes by the Orwellian label,"Clean Coal."Has anybody noticed that?
Every single debate has been sponsored by"Clean Coal.""Now, even lower emissions!"The richness and fullness of the dialogue in our democracy has not laid the basis for the kind of bold initiative that is really needed.
...
So that ' s why I began by saying, be optimistic in what you do, but be an active citizen. \textbf{Demand} â change the light bulbs, but change the laws.
Change the global treaties.
We have to speak up.
We have to solve this democracy â this â We have sclerosis in our democracy.
And we have to change that.
Use the Internet.
Go on the Internet.
Connect with people.
Become very active as citizens.
Have a moratorium â we shouldn ' t have any new coal-fired generating plants that aren ' t able to capture and store CO2, which means we have to quickly build these renewable sources.
Now, nobody is talking on that scale.
But I do believe that between now and November, it is possible.
This Alliance for \textbf{Climate} Protection is going to launch a nationwide campaign â grassroots mobilization, television ads, Internet ads, radio, newspaper â with partnerships with \textbf{everybody} from the Girl Scouts to the hunters and fishermen.
We need help.
We need help.
...
And that ' s hard to â that ' s hard to create â but it is coming.
...
CA : Al Gore, thank you so much for coming to \textbf{TED}.
AG : Thank you.
Thank you very much.

% matched lemmas: air, climate, conflict, crisis, demand, everybody, invest, involve, leadership, stuff, support, ted, transition
\end{textsample}
