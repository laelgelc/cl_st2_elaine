\begin{textsample}{POS Dim 4 – 1998 – Score 12.00 – 1998/t000200.txt}  \label{ex:f4_pos_013}
...
You tend to be \textbf{interested} in a generation past, a generation future â your parents, your kids, things you can change over the next few decades â and this 50-year time bubble you kind of move along in.
...
What I call the human portion â humans and their livestock and pets â versus the natural portion â all the other wild animals and just â these are vertebrates and all the birds, etc., in the land and \textbf{air}, not in the water.
How does it balance?
Certainly, 10, 000 years ago, the civilization ' s beginning, the human portion was less than one tenth of one percent.
Let ' s look at it now.
You follow this curve and you see the whiter spot in the middle â that ' s your 50- year time bubble.
...
And this really is a sobering picture upon realizing that we, humans, are in charge of life on earth ; we ' re like the capricious Gods of old Greek myths, kind of playing with life â and not a great deal of wisdom injected into it.
...
Somehow making these all compatible with the Earth looks like a pretty bad industry to be \textbf{involved} with.
...
They can be.
Our school systems are very flawed and do not reward you for the things that are important in life or for the survival of civilization ; they reward you for a lot of learning and \textbf{sopping} up \textbf{stuff}.
...
We did things on land, in the \textbf{air}, on water â vehicles of all different kinds, usually with some electronics or electric power systems in them.
I find they ' re all the same, whether its land, \textbf{air} or water.
I ' ll be focusing on the \textbf{air} here.
...
A few years later, when we suggested to GM that now is the time and we could do a thing called the \textbf{Impact}, they sponsored it, and here ' s the \textbf{Impact} that we developed with them on their programs.
...
And we ' re working on a bigger plane â 220-foot span â and an intermediate-size, one with a regenerative fuel cell that can store excess energy during the day, feed it back at night, and stay up 65, 000 feet for months at a time.
...
The friendly \textbf{support}, the quiet \textbf{confidence}, congenial hospitality shown by our Hawaiian and military hosts â this is starting â made the experience enjoyable and unforgettable.
...
Oh, that was only a minute, but I think you ' d be \textbf{safe} to have that near the end of the flight, perhaps.
...
We ' ve had one of these fly nine miles through the \textbf{air} at 35 miles an hour with just a little battery in it.
...
Suddenly, we humans â a recently arrived species, no longer subject to the checks and balances inherent in nature â have grown in population, technology and \textbf{intelligence} to a position of terrible power.
...
We consider this to be sort of the spirit of \textbf{TED}.
...
And yet if I had not been making ornithopters like that, a little bit cruder, in 1939 â a long, long time ago â there wouldn ' t have been a Gossamer Condor, there wouldn ' t have been an Albatross, a Solar Challenger, there wouldn ' t be an \textbf{Impact} car, there wouldn ' t be a mandate on zero-emission vehicles in California.
...
You can think of it as a sort of a symbol for learning and \textbf{TED} that somehow gets you thinking of technology and nature, and puts it all together in things that are â that make this \textbf{conference}, I think, more important than any that ' s taken place in this country in this decade.
Thank you.

% matched lemmas: air, conference, confidence, impact, intelligence, interested, involve, safe, sop, stuff, support, ted
\end{textsample}
