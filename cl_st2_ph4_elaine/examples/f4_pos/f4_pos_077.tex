\begin{textsample}{POS Dim 4 – 2013 – Score 16.00 – 2013/t001978.txt}  \label{ex:f4_pos_077}
Democracy is in trouble, no question about that, and it comes in part from a deep dilemma in which it is embedded.
It ' s increasingly irrelevant to the kinds of decisions we face that have to do with global \textbf{pandemics}, a cross-border problem ; with HIV, a transnational problem ; with markets and immigration, something that goes beyond national borders ; with terrorism, with war, all now cross-border problems.
In fact, we live in a 21st-century world of interdependence, and brutal interdependent problems, and when we look for solutions in politics and in democracy, we are faced with political institutions designed 400 years ago, autonomous, sovereign nation-states with jurisdictions and territories separate from one another, each \textbf{claiming} to be able to solve the problem of its own people.
...
Cities are us.
Aristotle said in the ancient world, man is a political animal.
I say we are an urban animal.
We are an urban species, at home in our cities.
So to come back to the dilemma, if the dilemma is we have old-fashioned political nation-states unable to govern the world, respond to the global challenges that we face like \textbf{climate} change, then maybe it ' s time for mayors to rule the world, for mayors and the citizens and the peoples they represent to engage in global governance.
...
There are scores of \textbf{international}, inter-city, cross-border institutions, networks of cities in which cities are already, quite quietly, below the horizon, working together to deal with \textbf{climate} change, to deal with security, to deal with immigration, to deal with all of those tough, interdependent problems that we face.
...
And then all the things we know a little better, the U.
S. \textbf{Conference} of Mayors, the Mexican \textbf{Conference} of Mayors, the European \textbf{Conference} of Mayors.
...
Mayor Nutter of Philadelphia said, we could never get away here in Philadelphia with the \textbf{stuff} that goes on in Washington, the paralysis, the non-action, the inaction.
Why?
Because potholes have to get filled, because the trains have to run, because kids have to be able to get to school.
...
We saw this a couple of decades ago when Teddy Kollek, the great mayor of Jerusalem in the ' 80s and the ' 90s, was besieged one day in his office by religious \textbf{leaders} from all of the backgrounds, Christian prelates, rabbis, imams.
They were arguing with one another about access to the holy sites.
And the squabble went on and on, and Kollek listened and listened, and he finally said,"Gentlemen, spare me your sermons, and I will fix your sewers."That ' s what mayors do.
...
He ' s a libertarian.
He ' s an anarchist.
He rides to work on a bike, but at the same time, he ' s in some ways a \textbf{conservative}.
...
Luzhkov, 20 years mayor in Moscow, though he helped found a party, United Party with Putin, in fact \textbf{refused} to be defined by the party and finally, in fact, lost his job not under Brezhnev, not under Gorbachev, but under Putin, who wanted a more faithful party follower.
...
They ' re known.
Ed Koch used to wander around New York City saying,"How am I doing?"Imagine David Cameron wandering around the United Kingdom asking,"How am I doing?"He wouldn ' t like the answer.
Or Putin.
Or any national \textbf{leader}.
...
And as a result, mayors and city councillors and local authorities have a much higher \textbf{trust} level, and this is the third feature about mayors, than national governing officials.
...
But when you ask,"Do you \textbf{trust} your city councillor, do you \textbf{trust} your mayor?"the rates shoot up to 70, 75, even 80 percent, because they ' re from the neighborhood, because the people they work with are their neighbors, because, like Mayor Booker in Newark, a mayor is likely to get out of his car on the way to work and go in and pull people out of a burning building — that happened to Mayor Booker — or intervene in a mugging in the street as he goes to work because he sees it.
...
When states face each other, China and the U.
S., they face each other like this.
When cities interact, they interact like this.
China and the U.
S., despite the recent meta-meeting in California, are locked in all kinds of anger, resentment, and rivalry for number one.
...
They work together in \textbf{climate} change, for example.
Organizations like the C40, like ICLEI, which I mentioned, have been working together many, many years before Copenhagen.
In Copenhagen, four or five years ago, 184 nations came together to explain to one another why their sovereignty didn ' t permit them to deal with the grave, grave \textbf{crisis} of \textbf{climate} change, but the mayor of Copenhagen had invited 200 mayors to attend.
...
New York has a program to upgrade its old buildings, make them better insulated in the winter, to not leak energy in the summer, not leak \textbf{air} conditioning.
That ' s having an \textbf{impact}.
...
It helped unemployment, because people could get across town, and it had a profound \textbf{impact} on \textbf{climate} as well as many other things there.
...
Pedestrian zones, congestion fees, emission limits in cities like California cities have, there ' s lots and lots that cities can do even when opaque, stubborn nations \textbf{refuse} to act.
So what ' s the bottom line here?
The bottom line is, we still live politically in a world of borders, a world of boundaries, a world of walls, a world where states \textbf{refuse} to act together.
Yet we know that the reality we experience day to day is a world without borders, a world of diseases without borders and doctors without borders, maladies sans fronti{\EmojiFont �}{\EmojiFont �}res, M{\EmojiFont �}{\EmojiFont �}decins Sans Fronti{\EmojiFont �}{\EmojiFont �}res, of economics and technology without borders, of education without borders, of terrorism and war without borders.
...
That ' s an idea.
It ' s in my conception of the coming world, but it ' s also on the table in City Halls in Seoul, Korea, in Amsterdam, in Hamburg, and in New York.
...
If ever there were citizens without borders, I think it ' s the citizens of \textbf{TED} who show the promise to be those citizens without borders.
...
% matched lemmas: air, claim, climate, conference, conservative, crisis, impact, international, leader, pandemic, refuse, stuff, ted, trust
\end{textsample}
