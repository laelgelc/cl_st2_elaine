\begin{textsample}{POS Dim 4 – 2016 – Score 21.00 – 2016/t001270.txt}  \label{ex:f4_pos_040}
The conventional wisdom about our world today is that this is a time of terrible decline.
And that ' s not surprising, given the bad news all around us, from ISIS to inequality, political \textbf{dysfunction}, \textbf{climate} change, Brexit, and on and on.
...
I ' m going to show you what I mean by telling you about how three of the countries I \textbf{visited} — Canada, Indonesia and Mexico — overcame three supposedly impossible problems.
...
Meanwhile, Canada admitted 10 times more Syrian \textbf{refugees} in the last year than did the United States.
...
Now, here ' s the really \textbf{interesting} part.
Canada wasn ' t always like this.
Until the mid-1960s, Canada followed an explicitly racist immigration \textbf{policy}.
...
The real explanation \textbf{involves} the man who became Canada ' s \textbf{leader} in 1968, Pierre Trudeau, who is also the father of the current prime minister.
The thing to know about that first Trudeau is that he was very different from Canada ' s previous \textbf{leaders}.
He was a French speaker in a country long-dominated by its English elite.
He was an intellectual.
He was even kind of groovy.
I mean, seriously, the \textbf{guy} did yoga.
...
His formula, I ' ve learned, \textbf{involved} two parts.
...
Then part two, Trudeau created the world ' s first \textbf{policy} of official multiculturalism to promote integration and the idea that \textbf{diversity} was the key to Canada ' s identity.
...
While ordinary folks have grown more pious on a personal level — I saw a lot more headscarves on a recent \textbf{visit} than I would have a decade ago — the country ' s politics have moved in the opposite direction.
Indonesia is now a pretty decent democracy.
And yet, its Islamist parties have steadily lost \textbf{support}, from a high of about 38 percent in 2004 down to 25 percent in 2014.
...
In 2014, I went to Indonesia to ask its current president, a soft-spoken technocrat named Joko Widodo,"Why is Indonesia thriving when so many other Muslim states are dying?""Well, what we realized,"he told me,"is that to deal with extremism, we needed to deal with inequality first."See, Indonesia ' s religious parties, like similar parties elsewhere, had tended to focus on things like reducing poverty and cutting corruption.
...
Then in 2012, this \textbf{guy} named Enrique Pe{\EmojiFont �}{\EmojiFont �}a Nieto somehow got himself elected president.
Now, this Pe{\EmojiFont �}{\EmojiFont �}a hardly inspired much \textbf{confidence} at first.
Sure, he was handsome, but he came from Mexico ' s corrupt old ruling party, the PRI, and he was a notorious womanizer.
In fact, he seemed like such a pretty boy lightweight that women called him"bomb{\EmojiFont �}{\EmojiFont �}n,"sweetie, at campaign rallies.
And yet this same bomb{\EmojiFont �}{\EmojiFont �}n soon surprised everyone by hammering out a truce between the country ' s three warring political parties.
...
They liberalized its rusting energy \textbf{sector}.
...
Not long ago, I met with Pe{\EmojiFont �}{\EmojiFont �}a and asked how he managed it all.
The President flashed me his famous twinkly smile — and told me that the short answer was"compromiso,"compromise.
Of course, I pushed him for details, and the long answer that came out was essentially"compromise, compromise and more compromise."See, Pe{\EmojiFont �}{\EmojiFont �}a knew that he needed to build \textbf{trust} early, so he started talking to the opposition just days after his election.
To ward off pressure from special interests, he kept their meetings small and secret, and many of the participants later told me that it was this intimacy, plus a lot of shared tequila, that helped build \textbf{confidence}.
So did the fact that all decisions had to be unanimous, and that Pe{\EmojiFont �}{\EmojiFont �}a even agreed to pass some of the other party ' s priorities before his own.
As Santiago Creel, an opposition senator, put it to me,"Look, I ' m not saying that I ' m special or that anyone is special, but that group, that was special."The proof?
When Pe{\EmojiFont �}{\EmojiFont �}a was sworn in, the pact held, and Mexico moved forward for the first time in years.
Bueno.
...
Now, countries face \textbf{crises} all the time.
Right?
That ' s nothing special.
But Trudeau ' s genius was to realize that Canada ' s \textbf{crisis} had swept away all the hurdles that usually block reform.
Canada had to open up.
It had no choice.
...
I know I just mentioned how \textbf{crises} can grant \textbf{leaders} extraordinary freedoms.
...
And Pe{\EmojiFont �}{\EmojiFont �}a could have used his power to keep attacking the opposition, as was traditional in Mexico.
...
So at this point you may be thinking,"OK, Tepperman, if the fixes really are out there like you keep insisting, then why aren ' t more countries already using them?"It ' s not like they require special powers to pull off.
I mean, none of the \textbf{leaders} we ' ve just looked at were superheroes.
...
True story.
So what this tells us is that the real obstacle is not \textbf{ability}, and it ' s not circumstances.
It ' s something much simpler.
Making big changes \textbf{involves} taking big risks, and taking big risks is scary.
Overcoming that fear requires guts, and as you all know, gutsy politicians are painfully rare.
But that doesn ' t mean we voters can ' t \textbf{demand} courage from our political \textbf{leaders}.
...
% matched lemmas: ability, climate, confidence, crisis, demand, diversity, dysfunction, guy, interesting, involve, leader, policy, refugee, sector, support, trust, visit
\end{textsample}
