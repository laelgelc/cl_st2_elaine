\begin{textsample}{POS Dim 4 – 2019 – Score 16.00 – 2019/t002063.txt}  \label{ex:f4_pos_051}
...
But we do now see them at scale, and what worries me most is just our \textbf{ability} to address it in a systemic way that is scalable, that has a rigorous understanding of how we ' re taking action, a transparent understanding of how we ' re taking action and a rigorous appeals process for when we ' re wrong, because we will be wrong.
...
And so when you think about health for the community on Twitter, I ' m \textbf{interested} to hear,"health for everyone,"but specifically : How are you looking to make Twitter a \textbf{safe} space for that subset, for women, for women of color and black women?
JD : Yeah.
...
We can ' t build a business that is successful unless we have a \textbf{diversity} of perspective inside of our walls that actually feel these issues every single day.
And that ' s not just with the team that ' s doing the work, it ' s also within our \textbf{leadership} as well.
...
CA : Let ' s see what you \textbf{guys} are asking.
...
And when you think about that happening on Twitter, what are the things that you ' re doing, specifically, to \textbf{ensure} you don ' t have misinformation like this spreading in this way, influencing people in ways that could affect democracy?
...
JD : So we have \textbf{policies} around violent extremist groups, and the majority of our work and our terms of service works on conduct, not content.
So we ' re actually looking for conduct.
Conduct being using the service to repeatedly or episodically harass someone, using hateful imagery that might be associated with the KKK or the American Nazi Party.
...
We want to have a situation where algorithms are constantly scouring every single tweet and bringing the most \textbf{interesting} ones to the top so that humans can bring their judgment to whether we should take action or not, based on our terms of service.
...
So we want to make sure that we ' re not just encouraging more work around something that ' s super, super negative, and we want to have a good balance between the technology and where humans can actually be creative, which is the judgment of the rules, and not just all the mechanical \textbf{stuff} of finding and reporting them.
...
So there are conversations like \textbf{climate} change.
There are conversations like the displacement in the work through artificial \textbf{intelligence}.
...
How do you define..."Daily active usage"seems like a really dangerous term to be optimizing.
...
I mean, you ' re doing a brilliant job of listening, Jack, and hearing people, but to actually dial up the urgency and move on this \textbf{stuff} — will you do that?
...
It ' s focus, it ' s prioritization, it ' s understanding the fundamentals of the network and building a framework that scales and that is resilient to change, and being open about where we are and being transparent about where are so that we can continue to earn \textbf{trust}.
So I ' m proud of all the frameworks that we ' ve put in place.
I ' m proud of our direction.
We obviously can move faster, but that required just stopping a bunch of \textbf{stupid} \textbf{stuff} we were doing in the past.
CA : All right.
...
% matched lemmas: ability, climate, diversity, ensure, guy, intelligence, interested, interesting, leadership, policy, safe, stuff, stupid, trust
\end{textsample}
