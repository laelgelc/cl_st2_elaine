\begin{textsample}{POS Dim 4 – 2003 – Score 14.00 – 2003/t000436.txt}  \label{ex:f4_pos_036}
...
Every life form on this planet — every insect, every bacteria, every plant, every animal, every human, every politician — is coded in that \textbf{stuff}.
And if you want to take a single crystal of DNA, it looks like that.
And we ' re just beginning to understand this \textbf{stuff}.
...
If you think that the mapping of America ' s made a difference, or landing on the moon, or this other \textbf{stuff}, it ' s the map of ourselves and the map of every plant and every insect and every bacteria that really makes a difference.
And it ' s beginning to tell us a lot about evolution.
It turns out that what this \textbf{stuff} is — and Richard Dawkins has written about this — is, this is really a river out of Eden.
...
So, all you \textbf{guys} have heard about DNA, all the \textbf{stuff} that DNA does, but some of the \textbf{stuff} we ' re discovering is kind of nifty because this turns out to be the single most abundant species on the planet.
...
And by now you should be getting a hint as to how diverse and how important and how \textbf{interesting} this journey into life is, and how many different life forms there are, and how there can be different life forms living in very different places, maybe even outside of this planet.
Because if you can live in radiation that looks like this, that brings up a whole series of \textbf{interesting} questions.
...
This is Ferroplasma.
The reason why Ferroplasma is \textbf{interesting} is because it eats iron, lives inside the equivalent of battery acid, and excretes sulfuric acid.
...
Archaea means"the ancient ones."And the reason why they ' re ancient is because this thing came up when this planet was covered by things like sulfuric acid in batteries, and it was eating iron when the earth was part of a melted core.
So, it ' s not just dogs and cats and whales and dolphins that you should be aware of and \textbf{interested} in on this little journey.
Your fear should be that you are not, that you ' re paying attention to \textbf{stuff} which is temporal.
...
And you can do strange things with this \textbf{stuff}.
This is a baby gaur.
Conservation group gets together, tries to figure out how to breed an animal that ' s almost extinct.
They can ' t do it naturally, so what they do with this thing is they take a spoon, take some cells out of an adult gaur ' s mouth, code, take the cells from that and insert it into a fertilized cow ' s \textbf{egg}, reprogram cow ' s \textbf{egg} — different gene code.
...
And if we do that, and insert this into a fertilized wolf ' s \textbf{egg}, we may give birth to an animal that hasn ' t walked the earth since 1936.
...
The really neat thing about this \textbf{stuff} is that ' s life.
...
EXE, what it does is, it executes the first line of code, which reads just like that, AATCAGGGACCC, and that means : make a root.
...
I won ' t go there.
You can do this \textbf{stuff} even without changing the punctuation.
...
That brings up questions of privacy and insurability and all kinds of \textbf{stuff}, but it also allows us to start going after diseases, because if you run a person who has leukemia through something like this, it turns out that three diseases with completely similar clinical syndromes are completely different diseases.
...
This is what ' s been powering the U.
S. economy.
It ' s Moore ' s Law.
...
This \textbf{stuff} does.
And here ' s an \textbf{interesting} map.
This is a map which was finished at the Harvard Business School.
One of the really \textbf{interesting} questions is, if all this data ' s free, who ' s using it?
This is the greatest public library in the world.
Well, it turns out that there ' s about 27 trillion bits moving inside from the United States to the United States ; about 4. 6 trillion is going over to those European countries ; about 5. 5 ' s going to Japan ; there ' s almost no communication between Japan, and nobody else is literate in this \textbf{stuff}.
It ' s free.
No one ' s reading it.
They ' re focusing on the war ; they ' re focusing on Bush ; they ' re not \textbf{interested} in life.
...
And you can watch states rise and fall depending on their \textbf{ability} to speak a language of life, and you can watch New York fall off a cliff, and you can watch New Jersey fall off a cliff, and you can watch the rise of the new empires of \textbf{intelligence}.
...
And then the U.
S. came in about 1950, and then Switzerland about 1973, and then the U.
...
S. patent.
So, about 3, 000 Americans, 6, 000 Koreans, 14, 000 \textbf{Brits}, 790, 000 Argentines.
You want to know why Argentina ' s crashing?
It ' s got nothing to do with \textbf{inflation}.
...
It turns out that if you ' d gone to the U.
...
And the really \textbf{interesting} thing is, you and your kids are empowered to build great empires, and you don ' t need a lot to do it.
...
% matched lemmas: ability, brit, egg, guy, inflation, intelligence, interested, interesting, stuff
\end{textsample}
