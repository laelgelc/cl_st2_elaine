\begin{textsample}{POS Dim 4 – 2012 – Score 15.00 – 2012/t002162.txt}  \label{ex:f4_pos_072}
...
Last March, I went to the \textbf{TED} \textbf{conference}, and I saw Jim Hansen speak, the NASA scientist who first raised the alarm about global warming in the 1980s, and it seems that the predictions he made back then are coming true.
...
Yet we dither, taking no action to deflect the asteroid, even though the longer we wait, the more difficult and expensive it becomes."Of course, the left wants to take action, but the right denies that there ' s any problem.
All right, so I go back from \textbf{TED}, and then the following week, I ' m invited to a dinner party in Washington, D.
C., where I know that I ' ll be meeting a number of \textbf{conservative} intellectuals, including Yuval Levin, and to prepare for the meeting, I read this article by Levin in National Affairs called"Beyond the Welfare State."Levin writes that all over the world, nations are coming to terms with the fact that the social democratic welfare state is turning out to be untenable and unaffordable, dependent upon dubious economics and the demographic model of a bygone era.
...
If you won ' t help, then get the hell out of the way."We can deflect both of these asteroids.
...
No."To understand why this is happening to us, and what we can do about it, we need to learn more about moral psychology.
...
It ' s miraculous, and part of the explanation is this \textbf{ability} to circle around sacred values.
...
It ' s a sacred rock, and when people circle something together, they unite, they can \textbf{trust} each other, they become one.
...
We circle around flags, and then we can \textbf{trust} each other.
...
You can see the moral electromagnet operating in the U.
S.
Congress.
This is a graph that shows the degree to which voting in Congress falls strictly along the left-right axis, so that if you know how liberal or \textbf{conservative} someone is, you know exactly how they voted on all the major issues.
...
This was a golden age of bipartisanship, at least in terms of the parties ' \textbf{ability} to work together and solve grand national problems.
But in the 1980s and ' 90s, the electromagnet turns back on.
Polarization rises.
It used to be that \textbf{conservatives} and moderates and liberals could all work together in Congress.
...
If you go back to the Carter and even Reagan administrations, they were rating the other party 43, 45.
It ' s not terrible.
It drifts downwards very slightly, but now look what happens under George W.
Bush and Obama.
It plummets.
...
And we will never again have a large group of \textbf{conservative} southern Democrats and liberal northern \textbf{Republicans} making it easy, making there be a lot of overlap for bipartisan cooperation.
...
There are dozens and dozens of reforms we can do that will make things better, because a lot of our \textbf{dysfunction} can be traced directly to things that Congress did to itself in the 1990s that created a much more polarized and dysfunctional institution.
...
But what if the situation we face is not a single threat but is actually more like this, where there ' s just so much \textbf{stuff} coming in, it ' s just,"Start shooting, come on, \textbf{everybody}, we ' ve got to just work together, just start shooting."Because actually, we do face this situation.
...
Especially, it destroys our \textbf{ability} to \textbf{trust} each other, to feel that we ' re all in the same boat, because it ' s obvious we ' re not.
Some of us are sitting there \textbf{safe} and sound in gigantic private yachts.
...
Hmm?
No problem.
No problem."Now, why is that happening to us?
...
It ' s not a problem."The left has been very reluctant to say that marriage is actually good for women and for children.
Now let me be clear.
I ' m not blaming the women here.
I ' m actually more critical of the men who won ' t take responsibility for their own children and of an economic system that makes it difficult for many men to earn enough money to \textbf{support} those children.
...
They earn a lot of money, they \textbf{invest} that money in their kids, some of them become tiger mothers, the kids rise to their full potential, and the kids go on to become the top two lines in this graph.
And then there ' s \textbf{everybody} else : the children who don ' t benefit from a stable marriage, who don ' t have as much \textbf{invested} in them, who don ' t grow up in a stable environment, and who go on to become the bottom three lines in that graph.
...
But if \textbf{everybody} could just take off their partisan blinders, we ' d see that these two problems actually are best addressed together.
...
Well, congratulations, you \textbf{guys} are the inaugural members of the Asteroids Club, which is a club for all Americans who are willing to admit that the other side actually might have a point.
...
But are \textbf{conservatives} happy about this?
Well, Grover Norquist isn ' t, because this system costs an unbelievable amount of money.
And so, because the prison-industrial complex is bankrupting our states and corroding our souls, groups of fiscal \textbf{conservatives} and Christian \textbf{conservatives} have come together to form a group called Right on Crime.
...
% matched lemmas: ability, conference, conservative, dysfunction, everybody, guy, invest, leader, republican, safe, stuff, support, ted, trust
\end{textsample}
