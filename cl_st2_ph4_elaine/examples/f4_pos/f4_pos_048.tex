\begin{textsample}{POS Dim 4 – 2009 – Score 17.00 – 2009/t000082.txt}  \label{ex:f4_pos_048}
...
So if you are concerned to influence energy \textbf{policy}, or you are concerned to influence national security \textbf{policy}, or health \textbf{policy}, or education, science — and a particular branch of science — is a way to do it, not the way we ' ve been doing it, which is seat-of-the-pants wisdom.
...
Pretty much \textbf{everybody} is rational.
I think there are only two exceptions that I ' m aware of — two-year-olds, they are not rational, they have very fickle preferences, they switch what they think all the time, and schizophrenics are probably not rational, but pretty much \textbf{everybody} else is rational.
...
If we ' re looking at Iran, the president of the United States we would like to think, may have some influence — certainly the president in Iran has some influence — but we make a mistake if we just pay attention to the person at the top of the power ladder because that person doesn ' t know much about Iran, or about energy \textbf{policy}, or about health care, or about any particular \textbf{policy}.
...
There are lots of people shaping decisions and so if we want to predict correctly we have to pay attention to \textbf{everybody} who is trying to shape the outcome, not just the people at the pinnacle of the decision-making pyramid.
...
So I ' m going to talk to you about how to process it, and I ' m going to give you some examples out of Iran, and you ' re going to be wondering,"Why should we listen to this \textbf{guy}?
...
That ' s not my \textbf{claim}, that ' s a CIA \textbf{claim} — you can read it, it was declassified a while ago.
You can read it in a volume edited by H.
...
If we know those things we can predict their behavior by assuming that \textbf{everybody} cares about two things on any decision.
They care about the outcome.
They ' d like an outcome as close to what they are \textbf{interested} in as possible.
...
Most people fall in between, and if we can work out where they fall we can work out how to \textbf{negotiate} with them to change their behavior.
...
We can get this information from the Internet, from The Economist, The Financial Times, The New York Times, U.
S.
News and World Report, lots of sources like that, or we can get it from asking experts who spend their lives studying places and problems, because those experts know this information.
...
That ' s what it means to be an expert, that ' s the basic \textbf{stuff} an expert needs to know.
...
What ' s its future?
And \textbf{everybody} ' s best friend, Ahmadinejad.
...
I ' ve taken inputs on positions and so forth, run it through a computer model that had simulated the dynamics of interaction, and these are the simulated dynamics, the predictions about the path of \textbf{policy}.
...
Up at the top of the axis,"Build the Bomb."At 130, we start somewhere above 130, between building a bomb, and making enough weapons-grade fuel so that you could build a bomb.
...
The white line reproduces the analysis if the \textbf{international} environment just left Iran to make its own internal decisions, under its own domestic political pressures.
That ' s not going to be happening, but you can see that the line comes down faster if they ' re not put under \textbf{international} pressure, if they ' re allowed to pursue their own devices.
...
Just about nobody \textbf{supports} research on weapons-grade fuel today, but by 2011 that gets to be a big block, and you put these two together, that ' s the controlling influence in Iran.
...
That power disappears completely ; nobody \textbf{supports} that by 2011.
These \textbf{guys} are all shrinking, the power is all drifting out here, so the outcome is going to be the weapons-grade fuel.
Who are the winners and who are the losers in Iran?
Take a look at these \textbf{guys}, they ' re growing in power, and by the way, this was done a while ago before the current economic \textbf{crisis}, and that ' s probably going to get steeper.
...
Again, whether we ' re talking health \textbf{policy}, education, environment, energy, litigation, mergers, all of these are complicated problems that are predictable, that this sort of technology can be applied to.
...
I would like to leave you with one thought, which is for me, the \textbf{dominant} theme of this gathering, and is the \textbf{dominant} theme of this way of thinking about the world.
...
Bruce Bueno de Mesquita : I ' ve thought about that, and since I ' ve done a lot of work for the \textbf{intelligence} community, they ' ve also pondered that.
...
It would hasten how quickly people arrive at an agreement, and so it would save \textbf{everybody} a lot of grief and time.
And, it would arrive at an agreement that \textbf{everybody} was happy with, without having to manipulate them so much — which is basically what I do, I manipulate them.
...
CA : Here ' s hoping they hear it that way.
Thank you very much Bruce.
BBM : Thank you.

% matched lemmas: claim, crisis, dominant, everybody, guy, intelligence, interested, international, involve, negotiate, phone, policy, stuff, support
\end{textsample}
