\begin{textsample}{POS Dim 4 – 1984 – Score 7.00 – 1984/t000297.txt}  \label{ex:f4_pos_039}
...
And these will be some simple design qualities and they will also be some qualities of, if you will, the \textbf{intelligence} of interaction.
...
I ' m very \textbf{interested} in touch-sensitive displays.
...
But this is the \textbf{interesting} part.
...
So, what I will show you is... it ' s a rather boring book, but I ' m afraid sometimes you have to do boring books because your sponsors aren ' t necessarily \textbf{interested} in fiction and entertainment.
...
Here ' s another step-by-step procedure, only in this case — NN : Okay, this movie is... \textbf{Everybody} ' s heard of sound-sync movies — this is text-sync movies, so as the movie plays, the text gets highlighted.
...
But did hang around the, quote,"computer room,"where there were quite a few computers, and learned this particular language called Logo — and learned it with great ease and found it a lot of fun, it was very \textbf{interesting}.
...
And all of a sudden...
You may not call that reading and writing, but a certain bit of typing and reading \textbf{stuff} on the screen has a huge payoff, and it ' s a lot of fun.
...
So if I wanted to call my friend Peter Sprague on the \textbf{phone}, my secretary would get his head out and bring it and set it on the desk, and that would be the TV used for the occasion.
...
And when somebody gets up, in fact, to go answer a \textbf{phone} or use a bathroom or something, the empty seat becomes, if you will, that person.
...
% matched lemmas: everybody, intelligence, interested, interesting, phone, stuff
\end{textsample}
