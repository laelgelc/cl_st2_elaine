\begin{textsample}{POS Dim 4 – 2013 – Score 15.00 – 2013/t002037.txt}  \label{ex:f4_pos_078}
Good morning.
...
It also \textbf{claims} that all human societies develop in a linear progression towards a singular end.
...
See, I grew up on this \textbf{stuff} : food stamps.
...
Three assumptions are made by the \textbf{dominant} political theories of our time.
...
In 64 years of running the largest country in the world, the range of the Party ' s \textbf{policies} has been wider than any other country in recent memory, from radical land collectivization to the Great Leap Forward, then privatization of farmland, then the Cultural Revolution, then Deng Xiaoping ' s market reform, then successor Jiang Zemin took the giant political step of opening up Party \textbf{membership} to private businesspeople, something unimaginable during Mao ' s rule.
So the Party self-corrects in rather dramatic fashions.
Institutionally, new rules get enacted to correct previous \textbf{dysfunctions}.
For example, term limits.
Political \textbf{leaders} used to retain their positions for life, and they used that to accumulate power and perpetuate their rules.
...
One thing we often hear is,"Political reforms have lagged far behind economic reforms,"and"China is in dire need of political reform."But this \textbf{claim} is a rhetorical trap hidden behind a political bias.
...
The vast majority of \textbf{senior} Chinese \textbf{leaders} worked and competed their way to the top.
...
They interview their superiors, their peers, their subordinates.
...
China ' s new president, Xi Jinping, is the son of a former \textbf{leader}, which is very unusual, first of his kind to make the top job.
Even for him, the career took 30 years.
He started as a village manager, and by the time he entered the Politburo, he had managed areas with a total population of 150 million people and combined GDPs of 1. 5 trillion U.
S. dollars.
...
Where is the source of legitimacy?"I said,"How about competency?"We all know the facts.
...
So here they are.
In the next 10 years, China will surpass the U.
S. and become the largest economy in the world.
Income per capita will be near the top of all developing countries.
Corruption will be curbed, but not eliminated, and China will move up 10 to 20 notches to above 60 in T.
I. ranking.
...
Meta-narratives that make universal \textbf{claims} failed us in the 20th century and are failing us in the 21st.
...
It is the universal \textbf{claim} that many Western elites are making about their political system, the hubris, that is at the heart of the West ' s current ills.
...
Perhaps a more \textbf{interesting} age is upon us.
...
EXL : You know, Frank Fukuyama, the political scientist, called the Chinese system"responsive authoritarianism."It ' s not exactly right, but I think it comes close.
...
So there is, in China, there is a different kind of mechanism to be responsive to the \textbf{demands} and the thinking of the people.
...
And you have shown figures about the \textbf{support} that the government and the authorities have in China.
...
BG : Eric, thank you for sharing this with \textbf{TED}.
EXL : Thank you.

% matched lemmas: claim, demand, dominant, dysfunction, interesting, leader, membership, policy, senior, stuff, support, ted
\end{textsample}
