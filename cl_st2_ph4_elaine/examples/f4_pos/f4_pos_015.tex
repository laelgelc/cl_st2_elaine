\begin{textsample}{POS Dim 4 – 2005 – Score 23.00 – 2005/t000414.txt}  \label{ex:f4_pos_015}
...
And what I ' ve spent 15 years doing in this business â and it ' s taken me almost 14 to figure it out â is I think about the future of wars in the context of everything else.
...
That ' s how distant we are from even meeting an \textbf{air} force willing to fly against ours.
So that overmatched capability creates problems â catastrophic successes the White House calls them.
...
OK?
The theory of anti-access, area-denial asymmetrical strategies â gobbledygook that we sell to Congress, because if we just told them we can kick anybody ' s asses they wouldn ' t buy us all the \textbf{stuff} we want.
So we say, area-denial, anti-access asymmetrical strategies and their eyes glaze over.
And they say,"Will you build it in my district?"Here ' s my parody and it ain ' t much of one.
...
We say,"China, it ' s yours."Prometheus approach, largely a geographic definition, focuses almost exclusively on the start of \textbf{conflict}.
We field the first-half team in a league that insists on keeping score until the end of the game.
That ' s the problem.
We can run the score up against anybody, and then get our asses kicked in the second half â what they call fourth generation warfare.
Here ' s the way I like to describe it instead.
There is no battle space the U.
S.
...
What we have trouble accessing is the \textbf{transition} space that must naturally follow, and creating the peace space that allows us to move on.
...
Who do you access in this \textbf{transition} space?
You have to create internal partners.
You have to access coalition partners.
We asked the Indians for 17, 000 peace keepers.
I know their \textbf{senior} \textbf{leadership}, they wanted to give it to us.
But they said to us,"You know what?
In that \textbf{transition} space you ' re mostly hat not enough cattle.
We don ' t think you can pull it off, we ' re not going to give you our 17, 000 peace keepers for fodder."We asked the Russians for 40, 000.
They said no.
I was in China in August, I said,"You should have 50, 000 peace keepers in Iraq.
It ' s your oil, not ours."Which is the truth.
It ' s their oil.
...
Because if we did, that \textbf{guy} would be in front of the Senate, still testifying over Abu Ghraib.
...
We don ' t have one for processing politically bankrupt states that, frankly, \textbf{everybody} wants gone.
Like Saddam, like Mugabe, like Kim Jong-Il â people who kill in hundreds of thousands or millions.
...
What we have extant right now, at the beginning of this system, is the U.
N.
...
They can put it in an envelope and mail it to you, and then say in no uncertain terms,"Please cut that out."That gets you about four million dead in Central Africa over the 1990s.
That gets you 250, 000 dead in the Sudan in the last 15 months. \textbf{Everybody} ' s got to answer their grandchildren some day what you did about the holocaust in Africa, and you better have an answer.
We don ' t have anything to translate that will into action.
What we do have is the U.
S. -enabled Leviathan Force that says,"You want me to take that \textbf{guy} down?
I ' ll take that \textbf{guy} down.
I ' ll do it on Tuesday.
It will cost you 20 billion dollars."But here ' s the deal.
As soon as I can ' t find anybody else to \textbf{air} out, I leave the scene immediately.
That ' s called the Powell Doctrine.
Way downstream we have the International Criminal Court.
They love to put them on trial.
They ' ve got MiloseviÄ right now.
What are we missing?
...
We haven ' t faced an imminent threat since the Cuban missile \textbf{crisis} in 1962.
...
France says,"No, but I do like to criticize you after the fact."What we need downstream is a great power enabled â what I call that Sys Admin Force.
We should have had 250, 000 troops streaming into Iraq on the heels of that Leviathan sweeping towards Baghdad.
What do you get then?
No looting, no military disappearing, no arms disappearing, no ammo disappearing, no Muqtada Al-Sadr â I ' m wrecking his bones â no insurgency.
...
You ' re America."What we need is an \textbf{international} reconstruction fund â Sebastian Mallaby, Washington Post, great idea.
Model on the IMF.
Instead of passing the hat each time, OK?
Where are we going to find this \textbf{guy}?
G20, that ' s easy.
...
They ' ve been experiencing an identity \textbf{crisis} since the end of the Cold War.
...
We do Desert Storm.
The split starts to emerge between those in the military who see a future they can live with, and those who see a future that starts to scare them, like the U.
S. submarine community, which watches the Soviet Navy disappear overnight.
Ah!
...
The Clinton administration wasn ' t \textbf{interested} in running this.
For eight years, after screwing up the relationship on day one â inauguration day with gays in the military â which was deft.
So we were home alone for eight years.
And what did we do home alone?
We bought one military and we operated another.
It ' s like the \textbf{guy} who goes to the doctor and says,"Doctor, it hurts when I do this."The doctor says,"Stop doing that you idiot."I used to give this brief inside the Pentagon in the early 1990s.
I ' d say,"You ' re buying one military and you ' re operating another, and eventually it ' s going to hurt.
It ' s wrong.
Bad Pentagon, bad!"And they ' d say,"Dr.
Barnett, you are so right.
Can you come back next year and remind us again?"Some people say 9 / 11 heals the rift â jerks the long-term transformation gurus out of their 30, 000 foot view of history, drags them down in to the muck and says,"You want a networked opponent?
I ' ve got one, he ' s everywhere, go find him."It elevates MOOTW â how we pronounce that acronym â from crap to grand strategy, because that ' s how you ' re going to shrink that gap.
...
How this \textbf{impacts} the way we think about the future of war.
This is a concept which gets me vilified throughout the Pentagon.
It makes me very popular as well. \textbf{Everybody} ' s got an opinion.
Going back to the beginning of our country â historically, defenses meant protection of the homeland.
...
Our long-term rationale becomes, we ' re \textbf{involved} in a hair trigger stand off with the Soviets.
To attack America is to risk blowing up the world.
We connected national security to \textbf{international} security with about a seven minute time delay.
...
TSA â thousands standing around.
I \textbf{supported} the war in Iraq.
He was a bad \textbf{guy} with multiple priors.
...
You break out that Leviathan Force, you promise, you guarantee that you ' re going to mount one hell of a â immediately â follow- on Sys Admin effort.
Don ' t plan for the war unless you plan to win the peace.
Other differences.
Leviathan traditional partners, they all look like the \textbf{Brits} and their former colonies.
Including us, I would remind you.
The rest â wider array of partners. \textbf{International} organizations, non-governmental organizations, private voluntary organizations, contractors.
...
It ' s everything the man ' s military hates. \textbf{Gender} balanced much more, older, educated, married with children.
The force on the left, up or out.
The force on the right, in and out.
The force on the left respects Posse Comitatus restrictions on the use of force inside the U.
S.
...
You ' re going to build the Sys Admin Force inside the U.
S.
Military first.
...
Read Max Boon.
This is the history of the \textbf{marines} â small wars, small arms.
...
You ' ll see the pattern â airborne, just like carriers.
Armor goes this way.
Here ' s the dirty secret of the Air Force, you can win by bombing.
But you need lots of these \textbf{guys} on the ground to win the peace.
...
No off season, these \textbf{guys} are always active.
...
Because when the thing gets prevented in Chicago with the three million dead that perverts our political system beyond all recognition, these are the \textbf{guys} who are going to kill them first.
So it ' s better off to have them make some mistakes along the way than to see that.
Reserve component â National Guard reserves overwhelmingly Sys Admin.
How are you going to get them to work for this force?
Most firemen in this country do it for free.
This is not about money.
This is about being up front with these \textbf{guys} and gals.
Last point, \textbf{intelligence} community â the muscle and the defense agencies go this way.
...
They said,"Al Qaeda could be listening."They said,"Well, Jesus, they already know this \textbf{stuff}."Take a gift in the left hand.
These are the sunglasses that don ' t scare people, simple \textbf{stuff}.
Censors and transparency, the overheads go in both directions.
Thanks.

% matched lemmas: air, brit, conflict, crisis, everybody, gender, guy, impact, intelligence, interested, international, involve, leadership, marine, senior, stuff, support, transition
\end{textsample}
