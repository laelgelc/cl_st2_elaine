\begin{textsample}{POS Dim 4 – 2017 – Score 22.00 – 2017/t001157.txt}  \label{ex:f4_pos_043}
Chris Anderson : Hello.
Welcome to this \textbf{TED} Dialogues.
...
That ' s at least what we ' re going to try in these \textbf{TED} Dialogues, starting today.
...
YNH : Yeah, next week.
CA :"Homo Deus."Now, this is the history of the next hundred years.
I ' ve had a chance to read it.
It ' s extremely dramatic, and I daresay, for some people, quite alarming.
It ' s a must-read.
...
At least, of all the people in the world, you are most likely to be killed by yourself — which is, again, very good news, compared — compared to the level of violence that we saw in previous eras.
...
YNH : I think the underlying feeling or idea is that the political system — something is broken there.
It doesn ' t empower the ordinary person anymore.
It doesn ' t care so much about the ordinary person anymore, and I think this diagnosis of the political disease is correct.
With regard to the answers, I am far less certain.
I think what we are seeing is the immediate human \textbf{reaction} : if something doesn ' t work, let ' s go back.
...
And in Israel, where I come from, the hottest political vision of the present is :"Let ' s build the temple again."So let ' s go back 2, 000 years backwards.
...
CA : But why couldn ' t it work?"America First"is a very appealing slogan in many ways.
...
YNH : For many centuries, even thousands of years, patriotism worked quite well.
Of course, it led to wars an so forth, but we shouldn ' t focus too much on the bad.
There are also many, many positive things about patriotism, and the \textbf{ability} to have a large number of people care about each other, sympathize with one another, and come together for \textbf{collective} action.
...
And then in a long and complicated process, the tribes coalesced together to form the Chinese nation, which controlled the entire Yellow River and had the \textbf{ability} to bring hundreds of thousands of people together to build dams and canals and regulate the river and prevent the worst floods and droughts and raise the level of prosperity for \textbf{everybody}.
...
And if you don ' t have some kind of global cooperation, nationalism is just not on the right level to tackle the problems, whether it ' s \textbf{climate} change or whether it ' s technological disruption.
...
It ' s not just \textbf{climate} change, which is, like, the most obvious example people give.
I think more in terms of technological disruption.
If you think about, for example, artificial \textbf{intelligence}, over the next 20, 30 years pushing hundreds of millions of people out of the job market — this is a problem on a global level.
It will disrupt the economy of all the countries.
And similarly, if you think about, say, bioengineering and people being afraid of conducting, I don ' t know, genetic engineering research in humans, it won ' t help if just a single country, let ' s say the US, outlaws all genetic experiments in humans, but China or North Korea continues to do it.
...
CA : So this is really \textbf{interesting}.
...
It could have been an extremely effective way of frightening people — and galvanizing people :"The robots will take your jobs!"And nobody used that line.
...
So one of the examples you give in"Sapiens"is just the whole agricultural revolution, which, for an actual person tilling the fields, they just picked up a 12-hour backbreaking workday instead of six hours in the jungle and a much more \textbf{interesting} lifestyle.
...
During the agricultural revolution, what happened is that immense technological and economic revolution empowered the human \textbf{collective}, but when you look at actual individual lives, the life of a tiny elite became much better, and the lives of the majority of people became considerably worse.
And this can happen again in the 21st century.
No doubt the new technologies will empower the human \textbf{collective}.
...
CA : So we ' re in New York City for the first of a series of \textbf{TED} Dialogues with Yuval Harari, and there ' s a Facebook Live audience out there.
...
The things that people, some people at least, care about much more immediately, perhaps, is \textbf{climate} change, perhaps other issues like \textbf{refugees}, nuclear weapons, and so forth.
Would you argue that where we are right now that somehow those issues need to be dialed up?
You ' ve talked about \textbf{climate} change, but Trump has said he doesn ' t believe in that.
So in a way, your most powerful argument, you can ' t actually use to make this case.
YNH : Yeah, I think with \textbf{climate} change, at first sight, it ' s quite surprising that there is a very close correlation between nationalism and \textbf{climate} change.
I mean, almost always, the people who deny \textbf{climate} change are nationalists.
And at first sight, you think : Why?
What ' s the connection?
Why don ' t you have socialists denying \textbf{climate} change?
But then, when you think about it, it ' s obvious — because nationalism has no solution to \textbf{climate} change.
...
But in order to confront \textbf{climate} change, we need additional loyalties and commitments to a level beyond the nation.
...
It ' s a very difficult problem, because in a world where people lose their \textbf{ability} to be employed, the only thing they are going to get is this basic income.
So what ' s part of it is a very, very difficult ethical question.
CA : There ' s a bunch of questions on how the world affords it as well, who pays.
There ' s a question here from Facebook from Lisa Larson :"How does nationalism in the US now compare to that between World War I and World War II in the last century?"YNH : Well the good news, with regard to the dangers of nationalism, we are in a much better position than a century ago.
...
So in the 18th century, if Scotland wanted — and the Scots wanted several times — to break out of the control of London, the \textbf{reaction} of the government in London was to send an army up north to burn down Edinburgh and massacre the highland tribes.
...
So for all the talk of the rise of nationalism and going back to the 1930s, to the 19th century, in the \textbf{West} at least, the power of national sentiments today is far, far smaller than it was a century ago.
...
But when you have a lose-lose situation like with \textbf{climate} change, it ' s much more difficult without some overarching authority, real authority.
...
But still, given the dangers that we are facing, I think the imperative of having some kind of real \textbf{ability} to force through difficult decisions on the global level is more important than almost anything else.
CA : There ' s a question from Facebook here, and then we ' ll get the mic to Andrew.
So, Kat Hebron on Facebook, calling in from Vail :"How would developed nations manage the millions of \textbf{climate} migrants?"YNH : I don ' t know.
...
CA : Yuval, there ' s a belief among many technologists, certainly, that political concerns are kind of overblown, that actually, political \textbf{leaders} don ' t have that much influence in the world, that the real determination of humanity at this point is by science, by invention, by companies, by many things other than political \textbf{leaders}, and it ' s actually very hard for \textbf{leaders} to do much, so we ' re actually worrying about nothing here.
YNH : Well, first, it should be emphasized that it ' s true that political \textbf{leaders} ' \textbf{ability} to do good is very limited, but their \textbf{ability} to do harm is unlimited.
There is a basic imbalance here.
You can still press the button and blow \textbf{everybody} up.
You have that kind of \textbf{ability}.
...
CA : So as you look at what ' s happening today, and putting your historian ' s hat on, do you look back in history at moments when things were going just fine and an individual \textbf{leader} really took the world or their country backwards?
YNH : There are quite a few examples, but I should emphasize, it ' s never an individual \textbf{leader}.
...
How are they to be integrated into the system, and how is a diverse set of identities to be made coherent under either national or global \textbf{leadership}?
YNH : Well, the problem of such diverse identities is a problem from nationalism as well.
...
You have religions, you have nations that sometimes \textbf{demand} exclusive loyalty, but it ' s not the only option.
...
YNH : Yeah.
Identity is always problematic, because identity is always based on fictional stories that sooner or later collide with reality.
...
YNH : It does, and also it messes with your mind when you think too much that I am a combination of soil and blood.
If you look from a biological perspective, obviously none of the nations that exist today existed 5, 000 years ago.
Homo sapiens is a social animal, that ' s for sure.
But for millions of years, Homo sapiens and our hominid ancestors lived in small communities of a few dozen individuals. \textbf{Everybody} knew \textbf{everybody} else.
...
CA : So it feels like you ' re really highlighting a question that ' s really been bugging me the last few months more and more.
...
And we just need to discover what our role is and then play it to the best of our \textbf{ability}.
...
You point out that it ' s different from \textbf{intelligence}, the \textbf{intelligence} that we ' re building in machines, and that there ' s actually a lot of mystery around it.
...
YNH : Well, I certainly think that the most \textbf{interesting} question today in science is the question of consciousness and the mind.
We are getting better and better in understanding the brain and \textbf{intelligence}, but we are not getting much better in understanding the mind and consciousness.
People often confuse \textbf{intelligence} and consciousness, especially in places like Silicon Valley, which is understandable, because in humans, they go together.
I mean, \textbf{intelligence} basically is the \textbf{ability} to solve problems.
Consciousness is the \textbf{ability} to feel things, to feel joy and sadness and boredom and pain and so forth.
In Homo sapiens and all other mammals as well — it ' s not unique to humans — in all mammals and birds and some other animals, \textbf{intelligence} and consciousness go together.
We often solve problems by feeling things.
So we tend to confuse them.
But they are different things.
What ' s happening today in places like Silicon Valley is that we are creating artificial \textbf{intelligence} but not artificial consciousness.
There has been an amazing development in computer \textbf{intelligence} over the last 50 years, and exactly zero development in computer consciousness, and there is no indication that computers are going to become conscious anytime soon.
So first of all, if there is some cosmic role for consciousness, it ' s not unique to Homo sapiens.
Cows are conscious, pigs are conscious, chimpanzees are conscious, chickens are conscious, so if we go that way, first of all, we need to broaden our horizons and remember very clearly we are not the only sentient beings on Earth, and when it comes to sentience — when it comes to \textbf{intelligence}, there is good reason to think we are the most intelligent of the whole bunch.
...
As an individual, knowing that, how does it \textbf{impact} the stories that you choose to live your life, and do you confuse them with the truth, like all of us?
YNH : I try not to.
...
The question is :"Is the post-truth era really a brand-new era, or just another climax or moment in a never-ending trend?
YNH : Personally, I don ' t connect with this idea of post-truth.
My basic \textbf{reaction} as a historian is : If this is the era of post-truth, when the hell was the era of truth?
CA : Right.
...
YNH : Yeah.
I mean, the intentional use of fake news is a disturbing sign.
...
Another thing that I would emphasize is that anybody who is really \textbf{interested} in global governance should always make it very, very clear that it doesn ' t replace or abolish local identities and communities, that it should come both as — It should be part of a single package.
...
YNH : Well, I think again we should start really with the biological realities of Homo sapiens.
...
In the last hundred years, people are losing their \textbf{ability} to be in touch with their body and their senses, to hear, to smell, to feel.
More and more attention goes to screens, to what is happening elsewhere, some other time.
This, I think, is the deep reason for the feelings of alienation and loneliness and so forth, and therefore part of the solution is not to bring back some mass nationalism, but also reconnect with our own bodies, and if you are back in touch with your body, you will feel much more at home in the world also.
...
If we don ' t have a global governance, and if we suffer from \textbf{climate} change, from technological disruptions, the worst suffering will not be in the US.
...
And therefore, because history is so unfair and the results of a calamity will not be shared equally between \textbf{everybody}, as usual, the rich will be able to get away from the worst consequences of \textbf{climate} change in a way that the poor will not be able to.
CA : And here ' s a great question from Cameron Taylor on Facebook :"At the end of ' Sapiens, '"you said we should be asking the question, ' What do we want to want? ' Well, what do you think we should want to want?"YNH : I think we should want to want to know the truth, to understand reality.
...
When people think about the future, very often they think in terms,"Oh, I want to gain control of my body and of my brain."And I think that ' s very dangerous.
...
Similarly, now, artificial \textbf{intelligence} and bioengineering and all of that — they don ' t predetermine a single outcome.
...
In fact, nuclear weapons prompted humans all over the world to change the way that they manage \textbf{international} politics to reduce violence.
...
And this is maybe the most important reason why \textbf{international} violence declined dramatically since 1945, and today, as I said, more people commit suicide than are killed in war.
...
CA : That ' s a very powerful note, on which I think we should draw this to a conclusion.
Before I wrap up, I just want to say one thing to people here and to the global \textbf{TED} community watching online, anyone watching online : help us with these dialogues.
...
% matched lemmas: ability, climate, collective, demand, everybody, impact, intelligence, interested, interesting, international, leader, leadership, reaction, refugee, ted, west
\end{textsample}
