\begin{textsample}{POS Dim 5 – 1994 – Score 4.00 – 1994/t002458.txt}  \label{ex:f5_pos_006}
...
And the interesting thing about it is that this slide, like so many technology slides that we ' re used to, is a sort of a straight line on a semi-log \textbf{curve}.
In other words, every step here represents an order of magnitude in performance scale.
And this is a new thing that we talk about technology on semi-log \textbf{curves}.
...
Now why do we draw technology \textbf{curves} in semi-log \textbf{curves}?
Well the answer is, if I drew it on a normal \textbf{curve} where, let ' s say, this is years, this is time of some sort, and this is whatever measure of the technology that I ' m trying to graph, the graphs look sort of silly.
They sort of go like this.
And they don ' t tell us much.
Now if I graph, for instance, some other technology, say transportation technology, on a semi-log \textbf{curve}, it would look very stupid, it would look like a flat line.
...
Now the question that I ' d like to ask is, if you look at these exponential \textbf{curves}, they don ' t go on forever.
...
So I think this \textbf{picture} makes sense if you look at it a few billion years at a time.
...
Now that ' s sort of just a very simple chemical form of life, but when things got interesting was when these drops learned a trick about \textbf{abstraction}.
...
And I think that that ' s what we ' re seeing here in this explosion of \textbf{curve}.
...
Instead, what I do and what the designers at Thinking Machines do is we think at some level of \textbf{abstraction} and then we hand it to the machine and the machine takes it beyond what we could ever do, much farther and faster than we could ever do.
...
So we ' re the amoebas and we can ' t quite figure out what the \textbf{hell} this thing is we ' re creating.
...
% matched lemmas: abstraction, curve, hell, picture
\end{textsample}
