\begin{textsample}{POS Dim 5 – 1998 – Score 6.00 – 1998/t000216.txt}  \label{ex:f5_pos_010}
...
Most of the earthquakes and volcanoes are in the sea, at the \textbf{bottom} of the sea.
...
Marcel Proust said,"The true voyage of discovery is not so much in seeking new landscapes as in having new eyes."People that have partnered with us have given us new eyes, not only on what exists — the new landscapes at the \textbf{bottom} of the sea — but also how we think about life on the planet itself.
Here ' s a jelly.
...
It gets up to about 150 \textbf{feet} long.
But see all those different working things?
I love that kind of stuff.
It ' s got these fishing lures on the \textbf{bottom}.
...
Bill Lange : We tend to forget about the fact that the ocean is miles deep on average, and that we ' re real familiar with the animals that are in the first 200 or 300 \textbf{feet}, but we ' re not familiar with what exists from there all the way down to the \textbf{bottom}.
...
You hear about giant squid and things like that, but some of these animals get up to be approximately 140, 160 \textbf{feet} long.
...
They go from a couple of inches to a couple of \textbf{feet}.
...
The height of these mountains on either side of this \textbf{valley} is greater than the Alps in most cases.
...
And you can sit in a room like this, with a joystick and a headset, and drive a robot like that around the \textbf{bottom} of the ocean in real time.
...
We see it either as sound, or we see it as video, or we see it as photographs, or we see it as chemical sensors, but we never have yet put it all together into one interesting \textbf{picture}.
...
DG : I think that ' s one of the greatest stories right now that we ' re seeing from the \textbf{bottom} of the sea, is that the first thing we see coming out of the sea floor after a volcanic eruption is bacteria.
...
One for extracting oxygen out of the deep-sea water, another one which houses this chemosynthetic bacteria, which takes the hydrothermal fluid — that hot water that you saw coming out of the \textbf{bottom} — and converts that into simple sugars that the tube worm can digest.
...
Their \textbf{foot} is at about 200 degrees C and their head is out at three degrees C, so it ' s like having your hand in boiling water and your \textbf{foot} in freezing water.
...
The red dot is the \textbf{laser} light of the submarine Alvin to give us an idea about how far away we are from the vents.
...
So here, you ' ve got this \textbf{valley} with this incredible alien landscape of pillars and hot springs and volcanic eruptions and earthquakes, inhabited by these very strange animals that live only on chemical energy coming out of the ground.
...
This stuff is toxic as \textbf{hell}, by the way.
...
DG : I already said that this site, from a human perspective, is toxic as \textbf{hell}.
...
We want tomorrow ' s note to be the same as it was today."It ' s absurd.
It ' s just absurd.
...
% matched lemmas: bottom, foot, hell, laser, picture, valley
\end{textsample}
