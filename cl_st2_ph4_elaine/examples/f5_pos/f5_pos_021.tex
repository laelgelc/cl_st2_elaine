\begin{textsample}{POS Dim 5 – 2006 – Score 6.00 – 2006/t000181.txt}  \label{ex:f5_pos_021}
...
The school teachers weren ' t having much \textbf{fun}, the sports were very dirty or very painful.
...
This was a 1K computer, and you ' d buy your programs on cassette \textbf{tape}.
Actually I ' m just going to pause for one second, because I heard that there ' s a prerequisite to speak here at TED — you had to have a \textbf{picture} of yourself from the old days with big hair.
So I brought a \textbf{picture} with big hair..
I just want to get that out of the way.
So after the Sinclair ZX80 came along the very cleverly named Sinclair ZX81.
And — you see the \textbf{picture} at the \textbf{bottom}?
There ' s a \textbf{picture} of a guy doing homework with his son.
...
You had to have an even better imagination to play this game,"Death Rider."But of course the scientists couldn ' t help themselves.
...
By 2010, we ' re going to hit 42 billion. 43 percent of gamers are female.
...
It turns out they ' re actually in Hollywood Bowl in Los Angeles listening to the L.
A.
Philharmonic playing video game music.
...
We ' re on this \textbf{curve}, and the graphics are getting so ridiculously better.
...
Think about that ' s where we are right now, and the \textbf{curve} that we ' re on means that this is going to continue to get better.
...
Mr.
Rogers, Walt Disney, Nick Junior, and roughly half a million commercials have undoubtedly left their mark on me.
...
Video games are nearing an evolutionary leap, a point where game worlds will look and feel just as real as the \textbf{films} we see in theatres, or the news we watch on TV.
...
Video games are \textbf{fun}, engaging, and leave your brain completely vulnerable to re-programming.
...
The most important one being \textbf{fun}.
...
Chris Anderson : You ' re off, you ' re off.
That ' s it.
He ' s out of time.
DP : I ' ve just got a little tiny bit more if you ' ll indulge me.
CA : Go ahead.
I ' m going to stay right here though.
...
Thank you.
Chris Anderson : David Perry.
That was awesome.

% matched lemmas: bottom, curve, film, fun, picture, tape
\end{textsample}
