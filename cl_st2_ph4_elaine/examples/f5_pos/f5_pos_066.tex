\begin{textsample}{POS Dim 5 – 2018 – Score 6.00 – 2018/t000502.txt}  \label{ex:f5_pos_066}
...
But where I ' m trying to be as clear as possible for you now, puzzles have to navigate the line between \textbf{abstraction} and clarity.
...
That ' s why we love crosswords and escape rooms and figuring out how to explore the \textbf{bottom} of the ocean.
...
Yeah,"You Make Me Feel Like a Natural Woman."So you can identify that and seven other songs and clips, and then look at the videos themselves for clues, where the way that they are \textbf{filmed} and edited together plus things like the cutaways to the \textbf{panel} of five people sitting at a table, which is reminiscent of a \textbf{panel} of judges, all of this can suggest"reality competition show."And either through internet research, or from just recognizing this, you can get to the aha, which is that these clips are shot- for-shot recreations of lip-synch battles from"RuPaul ' s Drag Race."So, why do we do this?
You tell me, I don ' t know.
So, first of all, it ' s really \textbf{fun}.
...
Instead, it ' s the slow burn of saying something through perplexing \textbf{abstraction}, yet being understood.
...
It ' s too much work.
It ' s really \textbf{fun}, but no more winning."One year later, in January of 2018, we won the MIT Mystery Hunt again.
...
% matched lemmas: abstraction, bottom, film, fun, panel
\end{textsample}
