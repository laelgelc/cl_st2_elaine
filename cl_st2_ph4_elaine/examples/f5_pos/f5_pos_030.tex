\begin{textsample}{POS Dim 5 – 2010 – Score 7.00 – 2010/t002785.txt}  \label{ex:f5_pos_030}
...
And the thing is, is that oil is really an \textbf{abstraction} for us as the American consumer.
...
And it goes all the way over to these big, thick, galumphy ones that have hundreds of carbons, and they have thousands of hydrogens, and they have vanadium and heavy \textbf{metals} and sulfur and all kinds of craziness hanging off the sides of them.
...
And then the asphaltenes — and this is the \textbf{crucial} thing — the asphaltenes get whipped by the waves into a frothy emulsion, something like mayonnaise.
...
It ' s incredibly hard to \textbf{clean} up.
...
So I ' m going to talk just a little bit about the origin of these politics, because it ' s really \textbf{crucial} to understanding why this summer is so important, why we need to stay focused.
...
I have to go buy \textbf{gas}.
I ' m so angry about it.
The oil companies are ripping me off.
They set the prices, and I don ' t even know.
I am helpless over this."And this is what happens to us at the \textbf{gas} pump — and actually, \textbf{gas} pumps are specifically designed to diffuse that anger.
You might notice that many \textbf{gas} pumps, including this one, are designed to look like ATMs.
...
Now there ' s another perverse thing about the way we buy \textbf{gas}, which is that we ' d rather be doing anything else.
This is BP ' s \textbf{gas} station in downtown Los Angeles.
It is green.
It is a shrine to greenishness."Now,"you think,"why would something so lame work on people so smart?"Well, the reason is, is because, when we ' re buying \textbf{gas}, we ' re very invested in this sort of cognitive dissonance.
...
There were no lips.
There were puffs under the little colorless eyes with creases running from them."Okay, so that guy is actually still with us.
...
I mean, these \textbf{pictures} — this is from the Santa Barbara spill.
You have these \textbf{pictures} of birds.
...
I think it ' s important to kind of look at these \textbf{pictures} of the birds and understand what happens to us.
Here we are normally ; we ' re standing at the \textbf{gas} pump, and we ' re feeling kind of helpless.
We look at these \textbf{pictures} and we understand, for the first time, our role in this supply chain.
...
And these guys, I mean, if they were in the U.
...
This is it."And then the guy in the Exxon uniform stepped out, and we realized it was okay.
...
Now what ' s happened in the Gulf of Mexico — as you can see, this is the Minerals Management diagram of wells for \textbf{gas} and oil.
...
What you see in this top \textbf{drawing} is a schematic of how petroleum gets used in the U.
S. economy.
...
We need to make the \textbf{gas} price better reflect the real cost of oil.
...
This is a \textbf{gas} receipt, hypothetically, for a year from now.
...
And what it says is,"The National Academy of Sciences estimates that every gallon of \textbf{gas} you burn in your car creates 29 cents in health care costs."That ' s a lot.
...
% matched lemmas: abstraction, clean, crucial, drawing, gas, metal, picture
\end{textsample}
