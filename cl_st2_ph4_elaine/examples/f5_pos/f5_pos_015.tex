\begin{textsample}{POS Dim 5 – 2008 – Score 9.00 – 2008/t000180.txt}  \label{ex:f5_pos_015}
...
But more importantly, the reason I wanted to show this \textbf{picture} : look where the other people are looking, and look where he is looking.
...
So you see, on the \textbf{bottom}, that rocket was supposed to go upward ; somehow it ended going sideways.
...
So that kind of tells you about, kind of, the \textbf{fun} things, you know, and the serious things that we try to do.
...
It is like the Grand Canyon on Earth, except a \textbf{hell} of a lot larger.
...
This \textbf{picture} was taken from an orbiting satellite.
...
It turned out that every once in a while there are dust devils which come by on Mars, as you are seeing here, and when the dust devil comes over the Rover, it just \textbf{cleans} it up.
...
Open.
Camera.
We have a \textbf{picture} right now.
Yeah!
...
It looks like I could have told you these are \textbf{pictures} taken from the Sahara Desert or somewhere, and you ' d have believed me, but these are \textbf{pictures} taken from Mars.
But one area which is particularly intriguing for us is the northern region, you know, of Mars, close to the North Pole, because we see ice caps, and we see the ice caps shrinking and expanding, so it ' s very much like you have in northern Canada.
...
And as you can see, this is a \textbf{picture} of the spacecraft put on Mars, but I thought that just in case you ' re going to miss that show, you know, in 17 days, I ' ll show you, kind of, a little bit of what ' s going to happen.
Video : That ' s what we call the seven minutes of terror.
So the plan is to dig in the soil and take samples that we put them in an oven and actually heat them and look what \textbf{gases} will come from it.
...
BC : We separate from the lander going 125 miles an hour at roughly a kilometer above the surface of Mars : 3, 200 \textbf{feet}.
...
Actually, the lander will come down to about 100 \textbf{feet} and hover above that surface for 100 \textbf{feet}, and then we have a sky crane which will take that Rover and land it down on the surface.
...
But also, if there is something that we cannot reach because it is too high on a cliff, we have a little \textbf{laser} system which will actually zap the rock, evaporate some of it, and actually analyze what ' s coming from that rock.
...
So that ' s kind of giving you an idea of the kind of, you know, \textbf{fun} things we are doing on Mars.
...
And this is a \textbf{picture} of an area as we were coming down.
...
So in closing, I said I want to close by a couple of \textbf{pictures}.
And just to kind of put us in perspective, this is a \textbf{picture} of Saturn taken with a spacecraft from behind Saturn, looking towards the Sun.
...
% matched lemmas: bottom, clean, foot, fun, gas, hell, laser, picture
\end{textsample}
