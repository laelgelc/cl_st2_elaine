\begin{textsample}{POS Dim 5 – 2018 – Score 7.00 – 2018/t000514.txt}  \label{ex:f5_pos_064}
...
A colleague asked me to \textbf{guest} teach his undergraduate geology class.
...
So instead, we use arguments like,"It ' s just a natural cycle.""It ' s the sun."Or my favorite,"Those climate scientists are just in it for the money."I get that at least once a week.
...
Where is global warming now?"And politician Y is saying,"For every scientist who says this thing is real, I can find one who says it isn ' t."So it ' s no surprise that sometimes we feel like everybody is saying these myths.
But when we look at the data — and the Yale Program on Climate [ Change ] Communication has done public opinion polling across the country now for a number of years — the data shows that actually 70 percent of people in the United States agree that the climate is changing.
...
How am I supposed to talk about radiative forcing or cloud parametrization in climate models?"We don ' t need to be talking about more science ; we ' ve been talking about the science for over 150 years.
Did you know that it ' s been 150 years or more since the 1850s, when climate scientists first discovered that digging up and burning coal and \textbf{gas} and oil is producing heat- trapping \textbf{gases} that is wrapping an extra blanket around the planet?
That ' s how long we ' ve known.
It ' s been 50 years since scientists first formally warned a US president of the dangers of a changing climate, and that president was Lyndon B.
Johnson.
...
I truly believe, after thousands of conversations that I ' ve had over the past decade and more, that just about every single person in the world already has the values they need to care about a changing climate.
...
I ' m a Christian, I care about a changing climate because it is, as the military calls it, a"threat multiplier."It takes those issues, like poverty and hunger and disease and lack of access to \textbf{clean} water and even political crises that lead to refugee crises — it takes all of these issues and it exacerbates them, it makes them worse.
I ' m not a Rotarian.
...
Absolutely.
Is it fair?
Heck, no, that ' s why I care most about climate change, because it is absolutely unfair.
...
I ' ve been really trying hard to get my \textbf{foot} in the door with our local churches, but I can ' t seem to get any traction.
I want to talk to them about why climate change matters."So I said,"Well, the best thing to do is to start with the denomination that you ' re part of, because you share the most values with those people.
...
Let ' s talk about what you do enjoy doing, what you are involved in."And we were able to identify a community group that he was part of, that he could start with.
The \textbf{bottom} line is, we don ' t have to be a liberal tree hugger to care about a changing climate.
...
If we live in Texas or if we live in Syria, we ' re seeing climate change supersize our droughts, making them more frequent and more severe.
...
We are almost up to 20 percent of our electricity from \textbf{clean}, renewable sources, most of that wind, though solar is growing quickly.
...
And they know that \textbf{clean} energy is essential to powering their future.
So China is investing hundreds of billions of dollars in \textbf{clean} energy.
They ' re flooding coal mines, and they ' re putting floating solar \textbf{panels} on the surface.
...
Too often, we \textbf{picture} this problem as a giant boulder sitting at the \textbf{bottom} of a hill, with only a few hands on it, trying to roll it up the hill.
...
The \textbf{bottom} line is this : climate change is affecting you and me right here, right now, in the places where we live.
...
% matched lemmas: bottom, clean, foot, gas, guest, panel, picture
\end{textsample}
