\begin{textsample}{POS Dim 5 – 2013 – Score 5.00 – 2013/t001925.txt}  \label{ex:f5_pos_042}
...
In Gando, there was no electricity, no access to \textbf{clean} drinking water, and no school.
...
People still are dying in Burkina Faso, and access to \textbf{clean} drinking water is still a big problem.
I had luck.
I was lucky, because this is a fact of life when you grow up in a place like that.
But I was lucky.
I had a scholarship.
...
From Gando, my home village in Burkina Faso, to Berlin in Germany to become an \textbf{architect} is a big, big step.
...
Oh yes, I started to make \textbf{drawings} and asked for money.
...
In real wonder, two years later, I was able to collect 50, 000 U.
S. dollars.
When I came home to Gando to bring the good news, my people were over the moon, but when they realized that I was planning to use clay, they were shocked."A clay building is not able to stand a rainy season, and Francis wants us to use it and build a school.
Is this the reason why he spent so much time in Europe studying instead of working in the field with us?"My people build all the time with clay, but they don ' t see any innovation with mud.
...
And then you have this result, very fine, like a baby \textbf{bottom}.
It ' s not photoshopped.
This is the school, built with the community.
The walls are totally made out of compressed clay blocks from Gando.
The \textbf{roof} structure is made with cheap steel bars normally hiding inside concrete.
...
How do you explain \textbf{drawings} and engineering to people who are neither able to read nor write?
...
So we just bring them like you can see to the building site. we start cutting them, and then we place them on top of the \textbf{roof} before we pour the concrete, and you have this result.
...
The rain in Burkina comes very fast, and after that, you have floods everywhere in the country.
...
% matched lemmas: architect, bottom, clean, drawing, roof
\end{textsample}
