\begin{textsample}{POS Dim 5 – 2009 – Score 9.00 – 2009/t002971.txt}  \label{ex:f5_pos_034}
...
So recently, we asked ourselves if we could invent a format that could actually tell the stories behind the projects, maybe combining images and \textbf{drawings} and words to actually sort of tell stories about architecture.
...
After him followed the post-modern counter-revolution, Robert Venturi saying,"Less is a bore."After him, Philip Johnson sort of introduced you could say promiscuity, or at least openness to new ideas with,"I am a whore."Recently, Obama has introduced optimism at a sort of time of global financial crisis.
...
The cliche of the radical \textbf{architect} is the sort of angry young man rebelling against the establishment.
...
It went on the cover of the Wen Wei Po newspaper, which got Mr.
Liangyu Chen, the mayor of Shanghai, to visit the exhibition.
...
Unfortunately, Mr.
Chen is now in prison for corruption.
But like I said, Haibao looked very familiar, because he is actually the Chinese character for"people."And they chose this mascot because the theme of the expo is"Better City, Better Life."Sustainability.
...
Gradually, you get this idea that sustainable life is less \textbf{fun} than normal life.
...
So that means that all 1. 3 billion Chinese have grown up with"The Emperor ' s New Clothes,""The Matchstick Girl"and"The Little Mermaid."It ' s almost like a fragment of Danish culture integrated into Chinese culture.
...
Like I said, Shanghai and Copenhagen are both port cities, but in Copenhagen the water has gotten so \textbf{clean} that you can actually swim in it.
...
You can try it.
Like with the water, instead of talking about it, we ' re going to sail a million liters of harbor water from Copenhagen to Shanghai, so the Chinese who have the courage can actually dive in and feel how \textbf{clean} it is.
...
You ' ll walk around, start looking for a bicycle on the \textbf{roof}, jump on your ride and then continue out into the rest of the expo.
...
We will add on.
The second thing, we had compared the swan to the dragon, and then the Chinese state said,"Suggest change to panda."So, when it came out in Denmark that we were actually going to move our national monument, the National People ' s Party sort of rebelled against it.
...
As an \textbf{architect}, it ' s really hard to set the agenda.
...
Then we place these mountains on the island, surrounding this sort of central green \textbf{valley}, almost like a central \textbf{park}.
...
% matched lemmas: architect, clean, drawing, fun, park, roof, valley
\end{textsample}
