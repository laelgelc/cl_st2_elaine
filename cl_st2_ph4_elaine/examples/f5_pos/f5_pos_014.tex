\begin{textsample}{POS Dim 5 – 2008 – Score 9.00 – 2008/t000135.txt}  \label{ex:f5_pos_014}
...
So, eventually I decided to pursue an MFA instead of an M.
D. and in grad school I became interested in creatures that dwell in the hidden corners of the city.
...
One day, in the subway, I was snapping \textbf{pictures} of the tracks hoping to catch a rat or two, and a man came up to me and said,"You can ' t take photographs here.
The MTA will confiscate your camera."I was quite shocked by that, and thought to myself,"Well, OK then.
I ' ll follow the rats."Then I started going into the tunnels, which made me realize that there ' s a whole new dimension to the city that I never saw before and most people don ' t get to see.
...
When I took photographs in these locations, I felt there was something missing in the \textbf{pictures}.
...
And, in a way, I wanted the human figure in the \textbf{picture} to become a part of that nature.
...
There ' s nobody around you, and you hear the kids playing in the \textbf{park} above you, completely unaware of what ' s underneath.
...
This is a tunnel that ' s abandoned in \textbf{Hell} ' s Kitchen.
...
And when I was done, he actually offered me his shirt to wipe off my \textbf{feet} and kindly walked me out.
...
There are more than 185 miles of tunnels, and only about a mile is open to the public as a \textbf{museum}.
The first tunnels date back to 60 B.
C.
...
The tunnels are famous for having been used by the Resistance, which Victor Hugo wrote about in"Les Miserables."And I saw a lot of graffiti from the 1800s, like this one.
...
I had to wear a \textbf{gas} mask because of the toxic fumes — I guess, except for in this \textbf{picture}.
And when the tides of waste matter come in it sounds as if a whole storm is approaching you.
This is a still from a \textbf{film} I worked on recently, called"Blind Door."I ' ve become more interested in capturing movement and texture.
And the 16mm black- and-white \textbf{film} gave a different feel to it.
...
% matched lemmas: film, foot, gas, hell, museum, park, picture
\end{textsample}
