\begin{textsample}{POS Dim 5 – 2011 – Score 8.00 – 2011/t002523.txt}  \label{ex:f5_pos_031}
I am a papercutter.
I cut stories.
...
And he slashed so many budgets that people said they couldn ' t afford paintings anymore, and they needed to have their portrait"a la silhouette."So I made series of images, cuttings, and I assembled them in portfolios.
And people told me — like these 36 views of the Empire State building — they told me,"You ' re making artist books."So artist books have a lot of definitions.
They come in a lot of different shapes.
But to me, they are \textbf{fascinating} objects to visually narrate a story.
...
So one of these works is the"Spelling Spider."So the Spelling Spider is a cousin of the spelling bee.
But it ' s much more connected to the Web.
And this spider spins a bilingual alphabet.
So you can read"architecture active"or"active architecture."So this spider goes through the whole alphabet with identical adjectives and substantives.
...
And I revisit this world thinking about the image or clich{\EmojiFont �}{\EmojiFont �} about what we want to do, and what are the words, colloquialisms, that we have with the expressions.
It ' s all if.
...
I have some stories that are humorous, like"Dead Beats."Other ones are historical.
...
The result is"Hells and Heavens."It ' s two \textbf{panels} 13 ft. high.
They were installed in the \textbf{museum} on two floors, but in fact, it ' s a continuous image.
And I call it"Hells and Heavens"because it ' s daily \textbf{hells} and daily heavens.
There is no border in between.
Some people are born in \textbf{hells}, and against all odds, they make it to heavens.
Other people make the opposite trip.
That ' s the border.
You have sweatshops in \textbf{hells}.
You have people renting their wings in the heavens.
And then you have all those individual stories where sometimes we even have the same action, and the result puts you in \textbf{hells} or in heavens.
So the whole"Hells and Heavens"is about free will and determinism.
And in papercutting, you have the \textbf{drawing} as the structure itself.
So you can take it off the wall.
Here it ' s an artist book installation called"Identity Project."It ' s not autobiographical identities.
...
In fact, in the \textbf{picture}, you have two of them.
...
Here it ' s in Scottsdale, Arizona, and it ' s called"Floating Memories."So it ' s regional memories, and they are just randomly moved by the wind.
I love public art.
...
And it ' s called"Seeds of the Future are Planted Today."It ' s a story about transformation and connections.
...
It ' s called Rue \textbf{des} Prairies — Prairie Street.
...
I take images from our global imagination, from clich{\EmojiFont �}{\EmojiFont �}, from things we are thinking about, from history.
...
% matched lemmas: des, drawing, fascinate, hell, museum, panel, picture
\end{textsample}
