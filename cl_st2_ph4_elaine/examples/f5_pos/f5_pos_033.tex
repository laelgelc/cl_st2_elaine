\begin{textsample}{POS Dim 5 – 2011 – Score 7.00 – 2011/t002591.txt}  \label{ex:f5_pos_033}
I ' d like to begin with a thought experiment.
Imagine that it ' s 4, 000 years into the future.
Civilization as we know it has ceased to exist â no books, no electronic devices, no Facebook or Twitter.
...
Perhaps some circular pieces of \textbf{metal}.
Maybe some cylindrical containers with some symbols on them.
And perhaps one archeologist becomes an instant celebrity when she discovers â buried in the hills somewhere in North America â massive versions of these same symbols.
...
It ' s only about one inch by one inch in size â pretty tiny.
...
Perhaps they ' re the name of the sender or some information about the goods that are being sent from one place to the other â we don ' t know.
...
I ' ve always been \textbf{fascinated} by the Indus script ever since I read about it in a middle school textbook.
And why was I \textbf{fascinated}?
...
Okay.
The answer is : if you look at the \textbf{left-hand} side of the two texts, you ' ll notice that there ' s a cramping of signs, and it seems like 4, 000 years ago, when the scribe was writing from right to left, they ran out of space.
...
Now there ' s several thoughts.
There ' s E.
It could be I.
It could be A, but certainly not B, C or D, right?
...
This symbol can in turn be followed by these fish-like symbols and some other signs, but never by these other signs at the \textbf{bottom}.
...
You might have encountered the stuck-key problem â so basically the same symbol being repeated over and over again.
...
At the very top you find the uniformly random sequence, which is a random jumble of letters â and interestingly, we also find the DNA sequence from the human genome and instrumental music.
...
The computer found several texts â two of them are shown here â that have very unusual patterns.
...
So you ' ll notice that many of the symbols look like \textbf{pictures} of humans, of insects, of fishes, of birds.
Most ancient scripts use the rebus principle, which is, using \textbf{pictures} to represent words.
So as an example, here ' s a word.
Can you write it using \textbf{pictures}?
I ' ll give you a couple seconds.
Got it?
Okay.
Great.
Here ' s my solution.
You could use the \textbf{picture} of a bee followed by a \textbf{picture} of a leaf â and that ' s"belief,"right.
There could be other solutions.
In the case of the Indus script, the problem is the reverse.
You have to figure out the sounds of each of these \textbf{pictures} such that the entire sequence makes sense.
...
And finally, there ' s other combinations, such as this fish sign with something that looks like a \textbf{roof} on top of it.
...
These are our ancestors â yours and mine.
...
% matched lemmas: bottom, fascinate, left-hand, metal, picture, roof
\end{textsample}
