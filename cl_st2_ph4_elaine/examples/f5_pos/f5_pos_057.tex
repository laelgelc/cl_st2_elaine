\begin{textsample}{POS Dim 5 – 2016 – Score 7.00 – 2016/t001399.txt}  \label{ex:f5_pos_057}
...
So the first question is,"Do we really have to change?"And of course, the Apollo Mission, among other things changed the environmental movement, really launched the modern environmental movement. 18 months after this Earthrise \textbf{picture} was first seen on earth, the first Earth Day was organized.
...
As this \textbf{picture} illustrates, the sky is not the vast and limitless expanse that appears when we look up from the ground.
...
And there are many sources of the greenhouse \textbf{gases}, I ' m certainly not going to go through them all.
...
And along with other factors, that opened the gates of \textbf{Hell} that people are trying to close now.
...
And already, land-based plants and animals are now moving towards the poles at an average rate of 15 \textbf{feet} per day.
...
We see an exponential \textbf{curve} for wind installations now.
...
The exponential \textbf{curve} on solar is even steeper and more dramatic.
When I came to this stage 10 years ago, this is where it was.
We have seen a revolutionary breakthrough in the emergence of these exponential \textbf{curves}.
...
In 1980, AT\&T, then Ma Bell, commissioned McKinsey to do a global market survey of those clunky new mobile phones that appeared then."How many can we sell by the year 2000?"they asked.
...
So now we ' re getting this : solar \textbf{panels} on grass huts and new business models that make it affordable.
...
And I heard adults of that day and time say,"That ' s reckless, expensive, may well fail."But eight years and two months later, in the moment that Neil Armstrong set \textbf{foot} on the Moon, there was great cheer that went up in NASA ' s mission control in Houston.
...
They enlisted her in this effort to put a tax on solar \textbf{panels} and regulations.
And she had just put solar \textbf{panels} on her \textbf{roof} and she didn ' t understand the request.
...
So, finally, the answer to your question is, this sounds a little corny and maybe it ' s a clich{\EmojiFont �}{\EmojiFont �}, but 10 years ago — and Christiana referred to this — there are people in this audience who played an incredibly significant role in generating those exponential \textbf{curves}.
...
% matched lemmas: curve, foot, gas, hell, panel, picture, roof
\end{textsample}
