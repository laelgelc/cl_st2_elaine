\begin{textsample}{POS Dim 5 – 2006 – Score 6.00 – 2006/t000210.txt}  \label{ex:f5_pos_020}
My name is Ursus Wehrli, and I would like to talk to you this morning about my project, Tidying Up Art.
First of all â any questions so far?
...
But don ' t worry â I don ' t have trouble with English, as such.
...
It ' s called"Tidying Up Art"and it ' s, as you can see, it ' s more or less a \textbf{picture} book.
...
I ' d like to show them around so we can just, you know â Actually, I managed to prepare for you some enlarged \textbf{pictures} â even better.
So Tidying Up Art, I mean, I have to say, that ' s a relatively new term.
You won ' t be familiar with it.
I mean, it ' s a hobby of mine that I ' ve been indulging in for the last few years, and it all started out with this \textbf{picture} of the American artist, Donald Baechler I had hanging at home.
...
It ' s a \textbf{picture} by Paul Klee.
...
The various \textbf{pictures} here of the various elements of the \textbf{picture} â the whole thing is unstructured.
We don ' t know, maybe Mr.
Klee was probably in a hurry, I mean â â maybe he had to catch a plane, or something.
...
And I would like to show you here my tidied up version of this \textbf{picture}.
...
I would like to show you here a \textbf{picture} which is a bit more advanced.
What can you say?
What a mess.
I mean, you see, everything seems to have been scattered aimlessly around the space.
If my room back home had looked like this, my mother would have grounded me for three days.
So I ' d like to â I wanted to reintroduce some structure into that \textbf{picture}.
...
This is a \textbf{picture} by Joan Miro.
...
And this is my â â you can see now the whole thing takes up far less space.
It ' s more economical and also more efficient.
With this method Mr.
Miro could have saved canvas for another \textbf{picture}.
But I can see in your faces that you ' re still a little bit skeptical.
So that you can just appreciate how serious I am about all this, I brought along the patents, the specifications for some of these works, because I ' ve had my working methods patented at the EidgenĂśssische Amt fĂźr Geistiges Eigentum in Bern, Switzerland.
I ' ll just quote from the specification."Laut den KunstprĂźfer Dr.
Albrecht â"It ' s not finished yet."Laut den KunstprĂźfer Dr.
Albrecht GĂśtz von Ohlenhusen wird die Verfahrensweise rechtlich geschĂźtzt welche die Kunst durch spezifisch aufgerĂ¤umte RegelmĂ¤ssigkeiten \textbf{des} allgemeinen Formenschatzes neue Wirkungen zu erzielen mĂśglich wird."Ja, well I could have translated that, but you would have been none the wiser.
...
Yeah, it ' s a â this one here, that ' s much better.
That ' s a \textbf{picture} by Keith Haring.
I think it doesn ' t matter.
So, I mean, this \textbf{picture} has not even got a proper title.
...
Or here, for example, we have 27 pink squares with only one pink \textbf{curve}.
I mean, that ' s interesting.
One could extend this sort of statistical analysis to cover all Mr.
Haring ' s various works, in order to establish in which period the artist favored pale green circles or pink squares.
...
Yeah, from my own experience.
So I ' m â Actually, I mean, here we have some artists that are a bit more structured.
It ' s not too bad.
...
Tidying up Rene Magritte â this is really \textbf{fun}.
You know, there is a â I ' m always being asked what inspired me to embark on all this.
It goes back to a time when I was very often staying in hotels.
So once I had the opportunity to stay in a ritzy, five-star hotel.
And you know, there you had this little sign â I put this little sign outside the door every morning that read,"Please tidy room."I don ' t know if you have them over here.
So actually, my room there hasn ' t been tidied once daily, but three times a day.
So after a while I decided to have a little \textbf{fun}, and before leaving the room each day I ' d scatter a few things around the space.
Like books, clothes, toothbrush, etc.
And it was great.
By the time I returned everything had always been neatly returned to its place.
But then one morning, I hang the same little sign onto that \textbf{picture} by Vincent van Gogh.
And you have to say this room hadn ' t been tidied up since 1888.
And when I returned it looked like this.
Yeah, at least it is now possible to do some vacuuming.
OK, I mean, I can see there are always people that like reacting that one or another \textbf{picture} hasn ' t been properly tidied up.
So we can make a short test with you.
This is a \textbf{picture} by Rene Magritte, and I ' d like you all to inwardly â like in your head, that is â to tidy that up.
...
So now I ' ve been able to tidy up \textbf{pictures} that I ' ve wanted to tidy up for a long time.
Here is a very good example.
Take Jackson Pollock, for example.
It ' s â oh, no, it ' s â that ' s a really hard one.
...
But yeah, and it ' s great, you can even go, you know â Or we have this pointillist movement for those of you who are into art.
The pointillist movement is that kind of paintings where everything is broken down into dots and pixels.
And then I â this sort of thing is \textbf{ideal} for tidying up.
...
I mean, it ' s"the future we will create."But to round things up I would like to show you just one more.
...
So I ' m â yeah, actually I ' m kind of finished at that moment.
And for those who want to see more, I ' ve got my book downstairs in the bookshop.
And I ' m happy to sign it for you with any name of any artist.
But before leaving I would like to show you, I ' m working right now on another â in a related field with my tidying up art method.
I ' m working in a related field.
And I started to bring some order into some flags.
Here â that ' s just my new proposal here for the Union Jack.
...
% matched lemmas: curve, des, fun, ideal, picture
\end{textsample}
