\begin{textsample}{POS Dim 5 – 2011 – Score 7.00 – 2011/t002595.txt}  \label{ex:f5_pos_032}
I ' m a contemporary artist with a bit of an unexpected background.
I was in my 20s before I ever went to an art \textbf{museum}.
...
And then at the other end, there ' s performance and short \textbf{films} and indoor installations like this indoor installation and this one, and outdoor installations like this one and this one.
...
And this is 22 \textbf{feet} long.
...
So this piece was great \textbf{fun} because it was two days of digging in soft dirt.
...
And in this one it ' s called"Drawing the Short Stick."I love this piece because I have a little cousin at home who introduced me — which I think is such a great introduction — to a friend one day as,"This is my cousin Shea.
He draws sticks real good."Which is one of the best compliments ever.
This artist is Gus Weinmueller, and he ' s doing a project, a large project, called"Art for the Peoples."And within this project, he ' s doing a smaller project called"Artists in Residence."And what he does is — he spends a week at a time with a family.
...
This project is called"Love Nests."What he did was to get wild birds to make his art for him.
So he put the material in places where the birds were going to collect them, and they crafted his nests for him.
And this one ' s called"Lovelock ' s Nest."This one ' s called"Mixtape Love Song ' s Nest."And this one ' s called"Lovemaking Nest."Next is Sylvia Slater.
...
And you would carry this around with you, and if everything went to \textbf{hell}, you could make payments and buy your life.
...
This is precious \textbf{metals} and gemstones.
...
We ' re going to go do some work."And so we got to the grave and made this, which was hilarious — the attention that we got.
...
So you open the box and you think,"Whoa, there ' s a snake in there."But it ' s actually a painting.
...
Hazel Clausen is an anthropologist who took a sabbatical and decided,"You know, I would learn a lot about culture if I created a culture that doesn ' t exist from scratch."So that ' s what she did.
...
And this is from a documentary called"Sexual Practices and Populations Control Among the Uvulites."This is a typical angora embroidery for them.
...
And this is called"Horse Sense Fence."The next artist is K.
M.
Yoon, a really interesting South Korean artist.
...
Next is an Australian artist, Janeen Jackson, and this is from a project of hers called"What an Artwork Does When We ' re Not Watching."Next is by a Lithuanian fortune teller, Jurgi Petrauskas.
Next is Ginger Cheshire.
This is from a short \textbf{film} of hers called"The Last Person."And that ' s my cousin and my sister ' s dog, Gabby.
...
This is by Z.
Zhou, and he ' s interested in stasis.
Next is by Hilda Singh, and she ' s doing a whole project called"Social Outfits."Next is by Vera Sokolova.
...
And she ' s an optometrist in St.
Petersburg, and she plays with optics.
Next, this is by Thomas Swifton.
This is from a short \textbf{film},"Adventures with Skinny."And this is by Cicily Bennett, and it ' s from a series of short \textbf{films}.
...
% matched lemmas: film, foot, fun, hell, metal, museum
\end{textsample}
