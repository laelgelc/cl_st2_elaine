\begin{textsample}{POS Dim 5 – 2013 – Score 5.00 – 2013/t001434.txt}  \label{ex:f5_pos_041}
Announcer : 10 seconds.
Five, four, three, two, one.
Official top.
Plus one, two, three, four, five six, seven, eight, nine, ten.
Guillaume NĂŠry, France.
Constant weight, 123 meters, three minutes and 25 seconds.
National record attempt. 70 meters. [ 123 meters ] Judge : White card.
Guillaume NĂŠry!
National record!
Guillaume NĂŠry : Thank you.
Thank you very much, thanks for the warm welcome.
That dive you just watched is a journey â a journey between two breaths.
A journey that takes place between two breaths â the last one before diving into the water, and the first one, coming back to the surface.
...
It ends with a special technique called the \textbf{carp}, which allows me to store one to two extra liters of air in my lungs by compressing it.
...
And what ' s extraordinary is that we share this instinct with marine mammals â all marine mammals : dolphins, whales, sea lions, etc.
...
It ' s truly an amazing feeling â an extraordinary feeling of freedom.
And so I slowly continue sliding to the \textbf{bottom}. 40 meters down, 50 meters down, and between 50 and 60 meters, a second physiological response kicks in.
...
I prefer"blood shift."So blood shift â how does it work?
The capillaries in the lungs become engorged with blood â which is caused by the suction â so the lungs can harden and protect the whole chest cavity from being crushed.
It prevents the two walls of the lungs from collapsing, from sticking together and caving in.
Thanks to this phenomenon, which we also share with marine mammals, I ' m able to continue with my dive. 60, 70 meters down, I keep falling, faster and faster, because the pressure is crushing my body more and more.
...
You can see what it looks like â not pretty at all.
...
How do you do it?"If I relied on my earthly reflexes â what do we do above water when there ' s a problem?
...
And the dive continues. 80, 85 meters down, 90, 100. 100 meters â the magic number.
...
And then the Frenchman, Jacques Mayol â you all know him as the hero in"The Big Blue"â came along and dived down to 100 meters.
...
So I carry on with my dive. 105, 110, 115.
The \textbf{bottom} is getting closer. 120, 123 meters.
I ' m at the \textbf{bottom}.
...
It ' s cold â freezing cold.
The pressure is crushing you completely â 13 times stronger than on the surface.
And I know what you ' re thinking :"This is horrible.
What the \textbf{hell} am I doing here?
He ' s insane."But no.
That ' s not what I think when I ' m down there.
When I ' m at the \textbf{bottom}, I feel good.
...
And each time, I \textbf{picture} the same image. [ The Pale Blue Dot ] It ' s that small dot the arrow is pointing to.
...
That ' s how I feel when I ' m at the \textbf{bottom}, at 123 meters.
...
Nowhere else on Earth you can experience this â looking all around you, and seeing the same thing.
It ' s extraordinary.
And at that moment, I still get that feeling each time, building up inside of me â the feeling of humility.
Looking at this \textbf{picture}, I feel very humble â just like when I ' m all the way down at the \textbf{bottom} â because I ' m nothing, I ' m a little speck of nothingness lost in all of time and space.
...
First, because it takes a huge effort to tear yourself away from the \textbf{bottom}.
...
You can ' t control them, and you shouldn ' t try to â you have to let it happen.
...
I want to go up.
I want to breathe now."You should not do that.
Never look up to the surface â not with your eyes, or your mind.
You should never \textbf{picture} yourself up there.
...
Every time I see them, I think to myself,"It ' s thanks to you."It ' s thanks to them, my team, that I ' m here.
...
So I ' m happy to finish my journey with them, because I wouldn ' t be here if it weren ' t for them. 20 meters, 10 meters, my lungs slowly return to their normal volume.
...
Once at the surface, I have 15 seconds to take off my nose clip, give this signal and say"I am OK."Plus, you need to be bilingual.
On top of everything â that ' s not very nice.
...
So my wife and I decided to \textbf{film} it and try to show another side of it, mostly to make people want to go into the water.
...
And if I may say one more thing, holding your breath, being in the water, finding this underwater world â it ' s all about connecting with yourself.
...
% matched lemmas: bottom, carp, film, hell, picture
\end{textsample}
