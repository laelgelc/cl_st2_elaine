\begin{textsample}{POS Dim 5 – 2003 – Score 8.00 – 2003/t000434.txt}  \label{ex:f5_pos_022}
...
They ' re fighting to develop their own way of living within the forest in a world that ' s \textbf{clean}, a world that isn ' t contaminated, a world that isn ' t polluted.
And what was so amazing to me, and what fits right in with what we ' re all talking about here at TED, is that there, right in the middle of this rainforest, was some solar \textbf{panels} — the first in that part of Ecuador — and that was mainly to bring water up by pump so that the women wouldn ' t have to go down.
The water was \textbf{cleaned}, but because they got a lot of batteries, they were able to store a lot of electricity.
...
Too often we just see a few slides, or a bit of \textbf{film}, but these beings have voices that mean something.
...
So this opens up a whole new \textbf{avenue} of research.
...
And of course, there ' s developments in infrared, so you can watch animals at night, and equipment for recording by video, and \textbf{tape} recording is getting lighter and better.
...
And the grim \textbf{picture} in Africa — I love Africa, and what do we see in Africa?
...
Maybe I can get just a few dollars from this last tree which will keep us going a little bit longer, and then we ' ll pray that something will happen to save us from the inevitable end."So, this is a pretty grim \textbf{picture}.
...
That ' s effective, but if they decide themselves,"We want to \textbf{clean} this river and put the fish back that used to be there.
...
Know the facts, but see how they fit in the big \textbf{picture}.
...
Secondly, the \textbf{resilience} of nature.
...
This bell is made from \textbf{metal} from a defused landmine, from the killing fields of Pol Pot — one of the most evil regimes in human history — where people are now beginning to put their lives back together after the regime has crumbled.
...
% matched lemmas: avenue, clean, film, metal, panel, picture, resilience, tape
\end{textsample}
