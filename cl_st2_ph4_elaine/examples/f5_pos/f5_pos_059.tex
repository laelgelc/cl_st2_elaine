\begin{textsample}{POS Dim 5 – 2017 – Score 7.00 – 2017/t001083.txt}  \label{ex:f5_pos_059}
...
So a single road lane tunnel according to regulations has to be 26 \textbf{feet}, maybe 28 \textbf{feet} in diameter to allow for crashes and emergency vehicles and sufficient ventilation for combustion engine cars.
But if you shrink that diameter to what we ' re attempting, which is 12 \textbf{feet}, which is plenty to get an electric skate through, you drop the diameter by a factor of two and the cross-sectional area by a factor of four, and the tunneling cost scales with the cross-sectional area.
...
So it was quite \textbf{fun} to do that, but it was kind of a hobby thing, and then we think we might — so we ' ve built a little pusher car to push the student pods, but we ' re going to try seeing how fast we can make the pusher go if it ' s not pushing something.
...
CA : But you can \textbf{picture}, then, a Hyperloop in a tunnel running quite long distances.
EM : Exactly.
...
CA : Huh.
EM : So, yeah.
CA : And so you could actually \textbf{picture}, what kind of length tunnel is in Elon ' s future to running Hyperloop?
...
Yeah.
CA : We can ' t see that much of it, but it doesn ' t look like just a little friendly neighborhood truck.
...
EM : Yes.
So what will be really \textbf{fun} about this is you have a flat torque RPM \textbf{curve} with an electric motor, whereas with a diesel motor or any kind of internal combustion engine car, you ' ve got a torque RPM \textbf{curve} that looks like a hill.
...
CA : This is cool.
OK, from a really badass \textbf{picture} to a kind of less badass \textbf{picture}.
This is just a cute house from"Desperate Housewives"or something.
What on earth is going on here?
EM : Well, this illustrates the \textbf{picture} of the future that I think is how things will evolve.
You ' ve got an electric car in the driveway.
If you look in between the electric car and the house, there are actually three Powerwalls stacked up against the side of the house, and then that house \textbf{roof} is a solar \textbf{roof}.
So that ' s an actual solar glass \textbf{roof}.
CA : OK.
EM : That ' s a \textbf{picture} of a real — well, admittedly, it ' s a real fake house.
That ' s a real fake house.
CA : So these \textbf{roof} tiles, some of them have in them basically solar power, the ability to — EM : Yeah.
Solar glass tiles where you can adjust the texture and the color to a very fine-grained level, and then there ' s sort of microlouvers in the glass, such that when you ' re looking at the \textbf{roof} from street level or close to street level, all the tiles look the same whether there is a solar cell behind it or not.
...
CA : You put them in the ones that are likely to see a lot of sun, and that makes these \textbf{roofs} super affordable, right?
They ' re not that much more expensive than just tiling the \textbf{roof}.
EM : Yeah.
We ' re very confident that the cost of the \textbf{roof} plus the cost of electricity — A solar glass \textbf{roof} will be less than the cost of a normal \textbf{roof} plus the cost of electricity.
...
EM : I think eventually almost all houses will have a solar \textbf{roof}.
The thing is to consider the time scale here to be probably on the order of 40 or 50 years.
So on average, a \textbf{roof} is replaced every 20 to 25 years.
But you don ' t start replacing all \textbf{roofs} immediately.
But eventually, if you say were to fast- forward to say 15 years from now, it will be unusual to have a \textbf{roof} that does not have solar.
CA : Is there a mental model thing that people don ' t get here that because of the shift in the cost, the economics of solar power, most houses actually have enough sunlight on their \textbf{roof} pretty much to power all of their needs.
If you could capture the power, it could pretty much power all their needs.
You could go off-grid, kind of.
EM : It depends on where you are and what the house size is relative to the \textbf{roof} area, but it ' s a fair statement to say that most houses in the US have enough \textbf{roof} area to power all the needs of the house.
...
You can \textbf{picture} what it would take to move the world off this vast fossil fuel thing.
It ' s like you ' re building one, it costs five billion dollars, or whatever, five to 10 billion dollars.
Like, it ' s kind of cool that you can \textbf{picture} that project.
...
And if I hadn ' t done that, that wasn ' t on the agenda before.
...
CA : So that was a sped-up — EM : That was the slowed down version.
...
This is a scene you \textbf{picture} in, what, 30 years time? 20 years time?
...
If you look at the progress in space, in 1969 you were able to send somebody to the moon. 1969.
...
Solar energy, we need to get there, so we need to make these beautiful \textbf{roofs}.
...
EM : I think the value of beauty and inspiration is very much underrated, no question.
...
% matched lemmas: curve, foot, fun, picture, roof
\end{textsample}
