\begin{textsample}{POS Dim 5 – 2015 – Score 7.00 – 2015/t001601.txt}  \label{ex:f5_pos_052}
...
When we go back four and a half billion years, there was a cloud of \textbf{gas} and dust.
...
Afterwards, the big planets like Jupiter and Saturn, they were not in their place where they are now, and they interacted gravitationally, and they swept the whole interior of the solar system \textbf{clean}, and what we now know as comets ended up in something called the Kuiper Belt, which is a belt of objects beyond the orbit of Neptune.
...
Comets contain the original material from which our solar system was formed, so they ' re \textbf{ideal} to study the components that were present at the time when Earth, and life, started.
...
From the results of that mission, it became immediately clear that comets were \textbf{ideal} bodies to study to understand our solar system.
...
However, our P.
R. department, in its enthusiasm, had already made 1, 000 Delft Blue plates with the name of the wrong comets.
...
On the way there, we flew by Earth and we took a few \textbf{pictures} to test our cameras.
This is the moon rising over Earth, and this is what we now call a selfie, which at that time, by the way, that word didn ' t exist.
It ' s at Mars.
It was taken by the CIVA camera.
...
Then we got in the vicinity of the comet, and these were the first \textbf{pictures} we saw.
...
We can sniff \textbf{gas}, we can measure dust particles, the shape of them, the composition, there are magnetometers, everything.
This is one of the results from an instrument which measures \textbf{gas} density at the position of Rosetta, so it ' s \textbf{gas} which has left the comet.
The \textbf{bottom} graph is September of last year.
There is a long-term variation, which in itself is not surprising, but you see the sharp peaks.
This is a comet day.
You can see the effect of the sun on the evaporation of \textbf{gas} and the fact that the comet is rotating.
...
These are the \textbf{gases} and the organic compounds that we already have measured.
...
On the \textbf{left-hand} side, you see in the middle a pit.
On the right-hand side, if you carefully look, there are three jets coming out of the \textbf{bottom} of that pit.
So this is the activity of the comet.
Apparently, at the \textbf{bottom} of these pits is where the active regions are, and where the material evaporates into space.
...
By the time we will be at the sun, there will be 100 kilos a second leaving this comet : \textbf{gas}, dust, whatever.
That ' s 100 million kilos a day.
Then, finally, the landing day.
I will never forget — absolute madness, 250 TV crews in Germany.
The BBC was interviewing me, and another TV crew who was following me all day were \textbf{filming} me being interviewed, and it went on like that for the whole day.
...
% matched lemmas: bottom, clean, film, gas, ideal, left-hand, picture
\end{textsample}
