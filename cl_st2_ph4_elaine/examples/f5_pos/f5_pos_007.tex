\begin{textsample}{POS Dim 5 – 2005 – Score 10.00 – 2005/t000435.txt}  \label{ex:f5_pos_007}
...
And this Grebe, I think, sort of, mistaked us for a prospect, and started to run along the water next to us, in a courtship dance â for miles.
...
What ' s happened since the book came out â the book was mainly about research in biomimicry â and what ' s happened since then is \textbf{architects}, designers, engineers â people who make our world â have started to call and say, we want a biologist to sit at the design table to help us, in real time, become inspired.
Or â and this is the \textbf{fun} part for me â we want you to take us out into the natural world.
We ' ll come with a design challenge and we find the champion adapters in the natural world, who might inspire us.
So this is a \textbf{picture} from a Galapagos trip that we took with some wastewater treatment engineers ; they purify wastewater.
...
We use bacteria to \textbf{clean} our water.
...
So if we had some way to stop this scaling â and so I picked up some shells on the beach.
...
And I said, well, in the same way that they exude a protein and it starts the crystallization â and then they all sort of leaned in â they let go of a protein that stops the crystallization.
It literally adheres to the growing face of the crystal.
And, in fact, there is a product called TPA that ' s mimicked that protein â that stop-protein â and it ' s an environmentally friendly way to stop scaling in pipes.
...
Learning about the natural world is one thing ; learning from the natural world â that ' s the switch.
That ' s the profound switch.
What they realized was that the answers to their questions are everywhere ; they just needed to change the lenses with which they saw the world. 3. 8 billion years of field-testing. 10 to 30 â Craig Venter will probably tell you ; I think there ' s a lot more than 30 million â well-adapted solutions.
The important thing for me is that these are solutions solved in context.
And the context is the Earth â the same context that we ' re trying to solve our problems in.
So it ' s the conscious emulation of life ' s genius.
It ' s not slavishly mimicking â although Al is trying to get the hairdo going â it ' s not a slavish mimicry ; it ' s taking the design principles, the genius of the natural world, and learning something from it.
...
So what can we learn about making â not just computers, but everything?
...
On the lower left there is a \textbf{picture} of mother of pearl forming out of seawater.
...
Imagine spraying the precursors to a PV cell, to a solar cell, onto a \textbf{roof}, and having it self- assemble into a layered structure that harvests light.
Here ' s an interesting one for the IT world : bio-silicon.
This is a diatom, which is made of silicates.
And so silicon, which we make right now â it ' s part of our carcinogenic problem in the manufacture of our chips â this is a bio-mineralization process that ' s now being mimicked.
...
And those little bumps actually increase efficiency in, for instance, the edge of an airplane â increase efficiency by about 32 percent.
...
Light comes through, it bounces back off the layers ; it ' s called thin- \textbf{film} interference.
...
See that up-close \textbf{picture}?
That ' s a ball of water, and those are dirt particles.
And that ' s an up-close \textbf{picture} of a lotus leaf.
There ' s a company making a product called Lotusan, which mimics â when the building facade paint dries, it mimics the bumps in a self-cleaning leaf, and rainwater \textbf{cleans} the building.
...
The one on the right is a pill bug â pulls water out of air, does not drink fresh water.
...
What if we were to separate out \textbf{metals} from waste streams, small amounts of \textbf{metals} in water?
That ' s what microbes do ; they chelate \textbf{metals} out of water.
...
This is a \textbf{picture} of the spinnerets coming out of a spider and the silk being formed from a spider.
...
A guy named Bruce Rosner looked at the tardigrade â which dries out completely, and yet stays alive for months and months and months, and is able to regenerate itself.
And he found a way to dry out vaccines â encase them in the same sort of sugar capsules as the tardigrade has within its cells â meaning that vaccines no longer need to be refrigerated.
...
Because we just â your slides are so gorgeous, and the ideas are so big, I can ' t stand to let you go down without seeing 10, 11 and 12.
...
So, farming based on how a prairie builds soil, ranching based on how a native ungulate herd actually increases the health of the range, even wastewater treatment based on how a marsh not only \textbf{cleans} the water, but creates incredibly sparkling productivity.
...
Life â and this is the secret trick ; this is the magic trick â life creates conditions conducive to life.
It builds soil ; it \textbf{cleans} air ; it \textbf{cleans} water ; it mixes the cocktail of \textbf{gases} that you and I need to live.
...
% matched lemmas: architect, clean, film, fun, gas, metal, picture, roof
\end{textsample}
