\begin{textsample}{POS Dim 5 – 2013 – Score 7.00 – 2013/t002089.txt}  \label{ex:f5_pos_040}
I ' m almost like a crazy evangelical.
I ' ve always known that the age of design is upon us, almost like a rapture.
If the day is sunny, I think,"Oh, the gods have had a good design day."Or, I go to a show and I see a beautiful piece by an artist, particularly beautiful, I say he ' s so good because he clearly looked to design to understand what he needed to do.
...
The Wind Map, by Wattenberg and Fernanda Vi{\EmojiFont �}{\EmojiFont �}gas, I don ' t know if you ' ve ever seen it — it ' s really fantastic.
...
But also, more recently, we started acquiring video games, and that ' s where all \textbf{hell} broke loose in a really interesting way.
...
I love them.
So we are in the right quadrant.
...
So the first was Jonathan Jones from The Guardian."Sorry, MoMA, video games are not art."Did I ever say they were art?
I was talking about interaction design.
Excuse me."Exhibiting Pac-Man and Tetris alongside Picasso and Van Gogh"— They ' re two floors away. —"will mean game over for any real understanding of art."I ' m bringing in the end of the world.
You know?
...
But then there was another wonderfully pretentious article that came out in The New Republic, so pretentious, by Liel Leibovitz, and it said,"MoMA has mistaken video games for art."Again."The \textbf{museum} is putting Pac-Man alongside Picasso."Again."That misses the point."Excuse me.
You ' re missing the point.
And here, look, the above question is put bluntly :"Are video games art?
No.
Video games aren ' t art because they are quite thoroughly something else : code."Oh, so Picasso is not art because it ' s oil paint.
Right?
...
And there ' s this Flaubert quote that I love :"I have always tried to live in an ivory tower, but a tide of shit is beating at its walls, threatening to undermine it."I consider myself the tide of shit.
...
So to get to choosing Eric Chahi ' s wonderful Another World, amongst others, we put together a \textbf{panel} of experts, and we worked on this acquisition, and it ' s mostly myself and Kate Carmody and Paul Galloway.
...
So when I show The Sims, I try to make people really feel what it meant to have an interaction with The Sims, not only the \textbf{fun} but also the responsibility that came with the Tamagotchi.
...
And I was just recently at the Eve Online fan festival in Reykjav{\EmojiFont �}{\EmojiFont �}k that was quite amazing.
...
Dwarf Fortress is like the holy grail of this kind of massive multiplayer online game, and in fact the two Adams brothers were in Reykjav{\EmojiFont �}{\EmojiFont �}k, and they were greeted by a standing ovation by all the Eve Online fans.
It was amazing to see.
And it ' s a beautiful game.
So you start seeing here that the aesthetics that are so important to a \textbf{museum} collection like MoMA ' s are kept alive also by the selection of these games.
...
At MoMA, interestingly, there ' s a lot of violence depicted in the art part of the collection, but when I came to MoMA 19 years ago, and as an Italian, I said,"You know what, we need a Beretta."And I was told,"No.
No guns in the design collection."And I was like,"Why?"Interestingly, I learned that it ' s considered that in design and in the design collection, what you see is what you get.
...
So, I ' m making \textbf{fun} of it, but we discussed this for so many days.
You have no idea.
...
But that ' s what would enable us to preserve the video games for a really long time, and that ' s what \textbf{museums} do.
...
But I want to explain to you the criteria that we chose for interaction design.
...
You know, I feel that the best video games are the ones that have really savvy \textbf{architects} that are behind them, and if they ' re not \textbf{architects}, bona fide trained in architecture, they have that feeling.
...
% matched lemmas: architect, fun, hell, museum, panel
\end{textsample}
