\begin{textsample}{POS Dim 5 – 2002 – Score 11.00 – 2002/t000317.txt}  \label{ex:f5_pos_003}
I draw to better understand things.
Sometimes I make a lot of \textbf{drawings} and I still don ' t understand what it is I ' m \textbf{drawing}.
Those of you who are comfortable with digital stuff and even smug about that relationship might be amused to know that the guy who is best known for"The Way Things Work,"while preparing for part of a \textbf{panel} for called Understanding, spent two days trying to get his laptop to communicate with his new CD burner.
...
I missed the ' 60s.
I read about them ; I understand they were pretty interesting.
...
I also make \textbf{drawings} to help people understand things.
Things that I want them to believe I understand.
And that ' s what I do as an illustrator, that ' s my job.
So, I ' m going to show you some \textbf{pictures} of Rome.
I ' ve made a lot of \textbf{drawings} of Rome over the years.
These are just \textbf{drawings} of Rome.
I get back as often as possible — I need to.
All different materials, all different styles, all different times, \textbf{drawings} from sketchbooks looking at the details of Rome.
...
This thing would be flying over or past or be \textbf{parked} in front of, but it would be like having a ruler — sort of travel through the pages without being a ruler.
...
She \textbf{parks} her dirigible, lowers the anchor rope and climbs down for a closer look inside.
The text here is right side and upside down so that you are forced to turn the book around, and you can see it from ground point of view and from her point of view — looking in the hole, getting a different kind of perspective, moving you around the space.
...
Unfortunately for her, the anchor line gets tangled around the \textbf{feet} of some Boy Scouts who are visiting the Pantheon, and they are immediately yanked out and given an extraordinary but terrifying tour of some of the domes of Rome, which would, from their point of view, naturally be hanging upside down.
...
Ajax the dog is put in a basket and lowered with a list of food into the marketplace, which flourishes there until about one in the afternoon, and then is completely removed and doesn ' t appear again until six or seven the following morning.
...
She ' s managed to save the prosciutto, but in the process she loses the tablecloth, which you can see flying away in the upper \textbf{left-hand} corner.
They continue without their tablecloth, looking for a place to land this thing so that they can actually have lunch.
They eventually discover a huge wall that ' s filled with small holes, \textbf{ideal} for docking a dirigible because you ' ve got a place to tie up.
Turns out to be the exterior wall — that part of it that remains — of the Coliseum, so they \textbf{park} themselves there and have a terrific lunch and have a spectacular view.
...
That speed with which he is moving, I hope I have suggested in this little image, which, again, can be turned around and read from both sides because there ' s text on the \textbf{bottom} and text on the top, one of which is upside down in this image.
...
And finally Carletto.
You see his apartment in the upper \textbf{left-hand} corner.
...
No, I ' ll just take my favorite bits and pieces and I ' ll put them inside the Pantheon but keep the scale, so you can see the top of Sant ' Ivo and the Pyramid of Cestius and the Tempietto of Bramante all side by side in this amazing space.
Now that ' s one \textbf{drawing}, so I thought maybe it ' s time for Piranesi to meet Escher.
...
Then I thought,"Wait a minute, what am I doing?"A book is not only a neat way of collecting and storing information, it ' s a series of layers.
...
If I do a foldout page on the \textbf{left-hand} side and let you just unfold it, you see behind it what I mean by scar tissue.
...
So I went back to the notion of story, which is always a good thing to have if you ' re trying to get people to pay attention to a book and pick up information along the way."Pigeon ' s Progress"struck me as a catchy title.
...
And he finally gets enough strength together to climb up the ladder onto the \textbf{roof}, and all the pigeons, a la Red Balloon, are there waiting for him and they carry him off over the walls of the city.
...
We almost collide with the \textbf{cornice} of the Palazzo Farnese — designed by Michelangelo, built of stone taken from the Coliseum — narrow escape.
...
And then we can swoop inside and around ; and because we ' re flying, we don ' t really have to worry about gravity at this particular moment in time, so this \textbf{drawing} can be oriented in any way on the page.
...
Straight up through the courtyard into a little window into the attic, where somebody is working at the \textbf{drawing} board.
He removes the message from the leg of the bird ; this is what it says.
As we look at the \textbf{drawing} board, we see what he ' s working on is, in fact, a map of the journey that the pigeon has just taken, and the red line extends through all the sights.
...
% matched lemmas: bottom, cornice, drawing, foot, ideal, left-hand, panel, park, picture, roof
\end{textsample}
