\begin{textsample}{POS Dim 5 – 2016 – Score 8.00 – 2016/t001286.txt}  \label{ex:f5_pos_055}
...
And someone told me â I was eight years old â someone told me that when they were done with those tubs, they washed them out and kept them in the back, and if you asked they would give you one.
It took me a couple of weeks to work up the courage, but I did, and they did.
They gave me one â I went home with this beautiful cardboard tub.
I was trying to figure out what I could do with this exotic material â \textbf{metal} ring, top and \textbf{bottom}.
I started turning it over in my head, and I realized,"Wait a minute â my head actually fits inside this thing."Yeah, I cut a hole out, I put some acetate in there and I made myself a space helmet.
I needed a place to wear the space helmet, so I found a refrigerator box a couple blocks from home.
I pushed it home, and in my parents ' \textbf{guest} room closet, I turned it into a spaceship.
I started with a control \textbf{panel} out of cardboard.
I cut a hole for a radar screen and put a flashlight underneath it to light it.
I put a view screen up, which I offset off the back wall â and this is where I thought I was being really clever â without permission, I painted the back wall of the closet black and put a star field, which I lit up with some Christmas lights I found in the attic, and I went on some space missions.
...
And I loved it.
A couple years later, my dad took me to a \textbf{film} called"Excalibur."I actually got him to take me to it twice, which is no small thing, because it is a hard, R-rated \textbf{film}.
But it wasn ' t the blood and guts or the boobs that made me want to go see it again.
They helped â It was the armor.
...
All the time â they wear it at dinner, they wear it to bed.
I was like,"Are they reading my mind?
I want to wear armor all the time!"So I went back to my favorite material, the gateway drug for making, corrugated cardboard, and I made myself a suit of armor, replete with the neck shields and a white horse.
Now that I ' ve oversold it, here ' s a \textbf{picture} of the armor that I made.
Now, this is only the first suit of armor I made inspired by"Excalibur."A couple of years later, I convinced my dad to embark on making me a proper suit of armor.
...
We carefully, over that month, constructed an articulated suit of aluminum armor with compound \textbf{curves}.
...
And then my teacher looks at me sort of concerned about halfway through the class and says,"Are you feeling OK?"I ' m thinking,"Are you kidding?
Am I feeling OK?
I ' m wearing a suit of armor!
I am having the time of my â"And I ' m just about to tell her how great I feel, when the classroom starts to list to the left and disappear down this long tunnel, and then I woke up in the nurse ' s office.
...
Where ' s my armor?"OK, fast-forward a whole bunch of years, some colleagues and I get hired to make a show for Discovery Channel, called"MythBusters."And over 14 years, I learn on the job how to build experimental methodologies and how to tell stories about them for television.
...
I wanted to visually separate these two elements, and I thought,"Well, for the first part we ' re training, so we should wear sweatsuits â Oh!
Let ' s put ' Stunt Trainee ' on the back of the sweatsuits.
That ' s for the training."But for the second part, I wanted something really visually striking â"I know!
I ' ll dress as Neo from ' The Matrix. '"So I went to Haight Street.
...
They ' re like,"."And I feel two distinct things at this moment.
...
This was the big leagues â this was costuming mecca.
...
It ' s not called costuming at Cons, it ' s called"cosplay."Now ostensibly, cosplay means people who dress up as their favorite characters from \textbf{film} and television and especially anime, but it is so much more than that.
These aren ' t just people who find a costume and put it on â they mash them up.
...
At Comic-Con or any other Con, you don ' t just take \textbf{pictures} of people walking around.
You go up and say,"Hey, I like your costume, can I take your \textbf{picture}?"And then you give them time to get into their pose.
...
At subsequent Cons, I learn Heath Ledger ' s shambling walk as the Joker from"The Dark Knight."I learn how to be a scary Ringwraith from"Lord of the Rings,"and I actually frighten some children.
I learned that"hrr hrr hrr"â that head laugh that Chewbacca does.
...
This is a masterpiece, and one of my all-time favorite \textbf{films}.
It ' s about a young girl named Chihiro who gets lost in the spirit world in an abandoned Japanese theme \textbf{park}.
And she finds her way back out again with the help of a couple of friends she makes â a captured dragon named Haku and a lonely demon named No-Face.
...
When people asked to take my \textbf{picture}, I would nod and I would shyly stand next to them.
They would take the \textbf{picture} and then I would secret out from behind my robe a chocolate gold coin.
And at the end of the photo process, I ' d make it appear for them.
Ah, ah ah! â like that.
And people were freaking out."Holy crap!
Gold from No-Face!
Oh my god, this is so cool!"And I ' m feeling and I ' m walking the floor and it ' s fantastic.
...
I don ' t know why.
And I keep on going, I take some more \textbf{pictures}.
And then it happens again.
Understand, I can ' t see anything inside this costume.
I can see through the mouth â I can see people ' s shoes.
I can hear what they ' re saying and I can see their \textbf{feet}.
...
In the \textbf{film}"Spirited Away,"bad luck befalls those who take gold from No-Face.
...
% matched lemmas: bottom, curve, film, foot, guest, metal, panel, park, picture
\end{textsample}
