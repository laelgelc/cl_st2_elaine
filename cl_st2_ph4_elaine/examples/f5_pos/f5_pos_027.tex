\begin{textsample}{POS Dim 5 – 2007 – Score 8.00 – 2007/t000213.txt}  \label{ex:f5_pos_027}
...
So a megabyte, 26 million megabytes is 26 terabytes — it goes mega-, giga-, tera-. 26 terabytes. 26 terabytes fits in a computer system that ' s about this big, on spinning Linux drives, and it costs about 60, 000 dollars.
...
Some of the first things that people do is they make book readers that allow you to search inside the books, and that ' s kind of \textbf{fun}.
...
And we have a quick hack that we did to try to put one of our books on it, and it turns out that 200 dots per inch means that you can put \textbf{scanned} books on them that look really good.
At 200 dots per inch, it ' s kind of the equivalent of a 300 dot print \textbf{laser} printer.
We ' re in good enough shape.
You actually can go and read \textbf{scanned} books quite easily.
So the idea of electronic books is starting to come about.
But how do you go about doing all this \textbf{scanning}?
...
The lesson we learned out of this is, \textbf{scan} your own books.
If you really care about books, you ' re going to \textbf{scan} them better, especially if they ' re valuable books.
If they ' re new books and you can just, you know, butcher them, because you could just buy another one, that ' s not such a big deal in terms of doing high-quality \textbf{scanning}.
But do things that you love.
But the Indians have been \textbf{scanning} a lot of their own books — about 300, 000 now — doing very well.
...
So we started out trying to figure out.
...
So anyway — so we ended up making our own book scanner, and with two digital, high-grade, professional digital cameras, controlled \textbf{museum} lighting, so even if it ' s a black and white book, you can go and get the proper intonation.
...
We ' ve now got eight of these \textbf{scanning} centers in three countries, and libraries are up for having their books \textbf{scanned}.
The Getty here is moving their books to the UCLA, which is where we have one these \textbf{scanning} centers, and \textbf{scanning} their out-of-copyright books, which is fabulous.
...
We ' ve \textbf{scanned} about 200, 000 books.
Now we ' re \textbf{scanning} about 15, 000 books a month, and it ' s starting to gear up another factor of two from there.
...
But we ' ve found that there ' s lots of other types of movies that haven ' t really seen the light of day — archival \textbf{films}.
We ' ve found, also, a lot of political \textbf{films}, a lot of amateur \textbf{films}, all sorts of things that are basically needing a home, a permanent home.
So we ' ve been starting to make these available and it ' s grown to be very popular.
We ' re not quite a YouTube.
We tended towards longer-term things and also things that people can reuse and make into new movies, which has just been great \textbf{fun}.
...
For one week, what did the world see?
...
So books, music, video, software.
There ' s only 50, 000 titles of it.
...
So this is a \textbf{picture} of the Internet Archive at the Library of Alexandria.
...
Carnegie — one of the great capitalists of this country — carved above his legacy,"Free to the People."Thank you very much.

% matched lemmas: film, fun, laser, museum, picture, scan
\end{textsample}
