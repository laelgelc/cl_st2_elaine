\begin{textsample}{POS Dim 5 – 1990 – Score 77.00 – 1990/t000287.txt}  \label{ex:f5_pos_001}
...
And my ideas are â in my head, anyway â they ' re very logical and relate to what ' s going on and problem solving for clients.
...
In fact, it appeared in a \textbf{porno} comic book, which is the slide on the right.
This is in Venice.
I just show it because I want you to know I ' m concerned about context.
On the \textbf{left-hand} side, I had the context of those little houses, and I tried to build a building that fit into that context.
When people take \textbf{pictures} of these buildings out of that context they look really weird, and my premise is that they make a lot more sense when they ' re photographed or seen in that space.
...
The garage on the right â the gray structure â will be torn down, finally, and several small classrooms will be placed along this \textbf{avenue} that we ' ve created, this campus.
...
And it was my theory, or my point of view, that one didn ' t \textbf{upstage} the neighborhood â one made accommodations.
...
We even made \textbf{flooring}, walls and everything, out of cardboard.
And the success of it threw me for a loop.
I couldn ' t deal with the success of furniture â I wasn ' t secure enough as an \textbf{architect} â and so I closed it all up and made furniture that nobody would like.
...
The piece on the left â and that ultimately led to the piece on the right â happened when the kid that was working on this took one of those long strings of stuff and folded it up to put it in the \textbf{wastebasket}.
And I put a piece of \textbf{tape} around it, as you see there, and realized you could sit on it, and it had a lot of \textbf{resilience} and strength and so on.
So, it was an accidental discovery.
I got into fish.
I mean, the story I tell is that I got mad at \textbf{postmodernism} â at po-mo â and said that fish were 500 million years earlier than man, and if you ' re going to go back, we might as well go back to the beginning.
And so I started making these funny things.
And they started to have a life of their own and got bigger â as the one glass at the Walker.
...
And a lot of my architectural ideas that came from it â accidental, again â it was an intuitive kind of thing, and I just kept going with it, and made this proposal for a building, which was only a proposal.
...
And after I got â I was really drunk â I was asked to do some sketches on \textbf{napkins}.
And I made some sketches on \textbf{napkins} â little boxes and Morandi-like things that I used to do.
And the client said,"Why no fish?"And so I made a \textbf{drawing} with a fish, and I left Japan.
Three weeks later, I received a complete set of \textbf{drawings} saying we ' d won the competition.
Now, it ' s hard to do.
It ' s hard to translate a fish form, because they ' re so beautiful â perfect â into a building or object like this.
And Oldenburg, who I work with a little once in a while, told me I couldn ' t do it, and so that made it even more exciting.
But he was right â I couldn ' t do the tail.
I started to get the head OK, but the tail I couldn ' t do.
It was pretty hard.
The thing on the right is a snake form, a \textbf{ziggurat}.
And I put them together, and you walk between them.
It was a dialog with the context again.
Now, if you saw a \textbf{picture} of this as it was published in Architectural Record â they didn ' t show the context, so you would think,"God, what a pushy guy this is."But a friend of mine spent four hours wandering around here looking for this restaurant.
Couldn ' t find it.
So...
...
The way we sent \textbf{drawings} to Japan : we used the magic computer in Michigan that does carved models, and we used to make foam models, which that thing \textbf{scanned}.
We made the \textbf{drawings} of the fish and the scales.
And when I got there, everything was perfect â except the tail.
...
And so we built a temporary building â I ' m getting good at temporary â and we put a conference room in that ' s a fish.
And, finally, Jay dragged me to my hometown, Toronto, Canada.
And there is a story â it ' s a real story â about my grandmother buying a \textbf{carp} on Thursday, bringing it home, putting it in the bathtub when I was a kid.
...
A few years ago, we did a performance piece in Venice, Italy, called"Il Corso del Coltello"â the Swiss Army knife.
And most of the imagery is â Claes ', but those two little boys are my sons, and they were Claes ' assistants in the play.
He was the Swiss Army knife.
He was a souvenir salesman who always wanted to be a painter, and I was Frankie P.
Toronto.
P for Palladio.
Dressed up like the AT\&T building by Claes â with a fish hat.
...
And I can tell you â it ' s totally an Oldenburg.
...
I ' ve been known to mess with things like chain link \textbf{fencing}.
...
People hate it.
And I ' m \textbf{fascinated} with that, which, like the paper furniture â it ' s one of those materials.
...
Like a Morandi â like the little bottles â composing them like a still life.
And it seemed to work as a way to put he and I together.
Then Jay Chiat asked me to do this building on this funny lot in Venice, and I started with this \textbf{three-piece} thing, and you entered in the middle.
And Jay asked me what I was going to do with the piece in the middle.
And he pushed that.
And one day I had a â oh, well, the other way.
...
And I still think the Time magazine \textbf{picture} will be of the binoculars, you know, leaving out the â what the \textbf{hell}.
I use a lot of \textbf{metal} in my work, and I have a hard time connecting with the craft.
...
I said,"If I can ' t get the craft that I want, I ' ll use the craft I can get."There were plenty of models for that, in Rauschenberg and Jasper Johns, and many artists who were making beautiful art and sculpture with junk materials.
I went into the \textbf{metal} because it was a way of building a building that was a sculpture.
And it was all of one material, and the \textbf{metal} could go on the \textbf{roof} as well as the walls.
The metalworkers, for the most part, do ducts behind the ceilings and stuff.
I was given an opportunity to design an exhibit for the metalworkers ' unions of America and Canada in Washington, and I did it on the condition that they become my partners in the future and help me with all future \textbf{metal} buildings, etc. etc.
...
The \textbf{metal} continued into a building â Herman Miller, in Sacramento.
And it ' s just a complex of factory buildings.
And Herman Miller has this philosophy of having a place â a people place.
...
Everybody ' s trying to get the \textbf{panels} perfect, and I always try to get them sloppy and fuzzy.
...
Because these were ideas that we were talking about, building things next to each other, making â it ' s all about [ a ] \textbf{metaphor} for a city, maybe.
...
I don ' t want the tower."So he came back with a simpler building, but he put some funny details on it, and he moved it closer to my building.
And so I decided to put him in a depression.
I put him in a hole and made a kind of a hole that he sits in.
And so then he put two bridges â this all happened on the fax, going back and forth over a couple of weeks ' period.
...
It was a very prominent building off the freeway, and we added a floor and \textbf{cleaned} it up and fixed it up and used the kind of â I thought â the language of the neighborhood, which had these \textbf{cornices}, projecting \textbf{cornices}.
...
The detailing was very careful with the lead copper and making \textbf{panels} and fitting it tightly into the fabric of the existing building.
In Barcelona, on Las Ramblas for some \textbf{film} festival, I did the Hollywood sign going and coming, made a building out of it, and they built it.
I flew in one night and took this \textbf{picture}.
But they made it a third smaller than my model without telling me.
And then more \textbf{metal} and some chain link in Santa Monica â a little shopping center.
And this is a \textbf{laser} laboratory at the University of Iowa, in which the fish comes back as an \textbf{abstraction} in the back.
It ' s the support labs, which, by some coincidence, required no windows.
And the shape fit perfectly.
I just joined the points.
In the \textbf{curved} part there ' s all the \textbf{mechanical} equipment.
That solid wall behind it is a pipe chase â a pipe canyon â and so it was an opportunity that I seized, because I didn ' t have to have any \textbf{protruding} ducts or vents or things in this form.
...
And we started with the stream and built the house along the stream â dammed it up to make a lake.
These are the models.
The reality, with the lake â the \textbf{workmanship} is pretty bad.
...
That big \textbf{metal} thing is a passage, and in it is â you go downstairs into the living room and then down into the bedroom, which is on the right.
...
The owners had a dilemma â they asked Philip to do it.
He was too busy.
...
It ' s made of \textbf{metal} and the brown stuff is Fin-Ply â it ' s that formed lumber from Finland.
...
There ' s a \textbf{railroad} track.
This is the city hall over here somewhere, and the courthouse.
And the \textbf{centerline} of the mall goes out.
Burnham had designed a \textbf{railroad} station that was never built, and so we followed.
Sohio is on the axis here, and we followed the axis, and they ' re two kind of \textbf{goalposts}.
...
And all this stuff at the \textbf{bottom} is a \textbf{museum}, and an idea for a very fancy automobile entry.
This owner has a pet peeve about bad automobile entries.
And this would be a hotel.
So, the \textbf{centerline} of this thing â we ' d preserve it, and it would start to work with the scale of the new buildings by Pelli and Kohn Pederson Fox, etc., that are underway.
It ' s hard to do high-rise.
I feel much more comfortable down here.
This is a piece of property in Brentwood.
And a long time ago, about ' 82 or something, after my house â I designed a house for myself that would be a village of several pavilions around a courtyard â and the owner of this lot worked for me and built that actual model on the left.
And she came back, I guess wealthier or something â something happened â and asked me to design a house for her on this site.
And following that basic idea of the village, we changed it as we got into it.
I locked the house into the site by cutting the back end â here you see on the photographs of the site â slicing into it and putting all the bathrooms and dressing rooms like a retaining wall, creating a lower level zone for the master bedroom, which I designed like a kind of a barge, looking like a boat.
And that ' s it, built.
The dome was a request from the client.
She wanted a dome somewhere in the house.
She didn ' t care where.
When you sleep in this bedroom, I hope â I mean, I haven ' t slept in it yet.
...
It ' s up there.
Left â it ' s my right.
Anyway, you enter into a garden with a beautiful grove of trees.
That ' s the living room.
Servants ' quarters.
A \textbf{guest} bedroom, which has this dome with marble on it.
...
And so it was an intent to make this small piece of land â it ' s 100 by 250 â into a kind of an estate by separating these areas and making the living room and dining room into this pavilion with a high space in it.
...
Eventually this will be screened â these trees will come up â and it will be very private.
And you feel like you ' re in your own kind of village.
This is for Michael Eisner â Disney.
...
On the backside, it ' s much more humane â entrance, dining hall, etc.
And then this thing here â I ' m hoping as you drive by you ' ll hear the picket fence effect of the sound hitting it.
Kind of a \textbf{fun} thing to do.
...
These are the early studies, but they have to sell furniture to normal people, so if I did the building and it was too fancy, then people might say,"Well, the furniture looks OK in his thing, but no, it \textbf{ain} ' t going to look good in my normal building."So we ' ve made a kind of pragmatic slab in the second phase here, and we ' ve taken the conference facilities and made a villa out of them so that the communal space is very sculptural and separate.
...
Palais \textbf{des} Sports, the Gare de Lyon over here.
The Minister of Finance â the guy that moved from the Louvre â goes in here.
There ' s a new library across the river.
And back in here, in this already treed \textbf{park}, we ' re doing a very dense building called the American Center, which has a theater, apartments, dance school, an art \textbf{museum}, restaurants and all kinds of â it ' s a very dense program â bookstores, etc.
In a very tight, small â this is the ground level.
And the French have this extraordinary way of screwing things up by taking a beautiful site and cutting the corner off.
They call it the plan \textbf{coupe}.
And I struggled with that thing â how to get around the corner.
These are the models for it.
I showed you the other model, the one â this is the way I organized myself so I could make the drawing â so I understood the problem.
I was trying to get around this plan \textbf{coupe} â how do you do it?
Apartments, etc.
...
The restaurants here â the apartments and the theater, etc.
So it would all be built in stone, in French limestone, except for this \textbf{metal} piece.
And it faces into a \textbf{park}.
...
Jay Chiat is a \textbf{glutton} for punishment, and he hired me to do a house for him in the Hamptons.
And it ' s got a fish.
And I keep thinking,"This is going to be the last fish."It ' s like a drug addict.
I say,"I ' m not going to do it anymore â I don ' t want to do it anymore â I ' m not going to do it."And then I do it.
There it is.
But it ' s the living room.
And this piece here is â I don ' t know what it is.
...
We ' ve had a lot of \textbf{fun} working together.
...
What I did â because of the Paris skies being quite dull, I made a light grid that ' s perpendicular to the train station, to the route of the train.
...
In Switzerland â Germany, actually â on the Rhine across from Basel, we did a furniture factory and a furniture \textbf{museum}.
And I tried to â there ' s a Nick Grimshaw building over here, there ' s an Oldenburg sculpture over here â I tried to make a relationship urbanistically.
And I don ' t gave good slides to show â it ' s just been completed â but this piece here is this building, and these pieces here and here.
And as you pass by it ' s always part â you see it as all of these pieces accrue and become part of an overall neighborhood.
It ' s plaster and just zinc.
And you wonder, if this is a \textbf{museum}, what it ' s going to be like inside?
If it ' s going to be so busy and crazy that you wouldn ' t show anything, and just wait.
I ' m so cunning and clever â I made it quiet and wonderful.
...
This is the Disney Hall â the concert hall.
...
And it ' s not a great building, but I approached it optimistically, that we would make a \textbf{compositional} relationship between us that would strengthen both of us.
And the plan of this â it ' s a concert hall.
...
These were the kind of relationships made to the Chandler, composing these elevations together and relating them to the buildings that existed â to MOCA, etc.
The \textbf{acoustician} in the competition gave us criteria, which led to this compartmentalized scheme, which we found out after the competition would not work at all.
...
These were the three buildings that were the \textbf{ideal} â the Concertgebouw, Boston and Berlin.
...
Our client doesn ' t want balconies, so â and when we met our new \textbf{acoustician}, he told us this was the right shape or this was the right shape.
And we tried many shapes, trying to get the energy of the original design within an \textbf{acoustical}, acceptable format.
We finally settled on a shape that was the proportion of the Concertgebouw with the \textbf{sloping} outside walls, which the \textbf{acoustician} said were \textbf{crucial} to this and later decided they weren ' t, but now we have them.
...
Now, this is not a final design â these are just on the way to being â and so I wouldn ' t take it literally, except the feeling of the space.
We studied the acoustics with \textbf{laser} stuff, and they bounce them off this and see where it all works.
...
When you get into a box, it ' s harder to do it â and here we are, struggling with how to put the hotel in.
...
A.
I was asked to do a sculpture at the \textbf{foot} of Interstate Bank Tower, the highest building in L.
A.
...
In Barcelona I was asked to do a fish, and we ' re working on that, at the \textbf{foot} of a Ritz-Carlton Tower being done by Skidmore, Owings and Merrill.
And the Ritz-Carlton Tower is being designed with exposed steel, non-fire proof, much like those old \textbf{gas} tanks.
And so we took the language of this exposed steel and used it, perverted it, into the form of the fish, and created a kind of a 19th- century contraption that looks like, that will sit â this is the beach and the harbor out in front, and this is really a shopping center with department stores.
...
It should have been the other way around â the food should have been good first.
It didn ' t work.
Thank you very much.

% matched lemmas: abstraction, acoustical, acoustician, ain, architect, avenue, bottom, carp, centerline, clean, compositional, cornice, coupe, crucial, curve, des, drawing, fascinate, fencing, film, flooring, foot, fun, gas, glutton, goalpost, guest, hell, ideal, laser, left-hand, mechanical, metal, metaphor, museum, napkin, panel, park, picture, porno, postmodernism, protrude, railroad, resilience, roof, scan, sloping, tape, three-piece, upstage, wastebasket, workmanship, ziggurat
\end{textsample}
