\begin{textsample}{POS Dim 5 – 2009 – Score 7.00 – 2009/t002945.txt}  \label{ex:f5_pos_036}
...
How does it work to make habitat for animals like me?"I ' d go to Times Square and I ' d look at the amazing ladies on the wall, and wonder why nobody is looking at the historical figures just behind them.
...
Those are two students at King ' s College — later Columbia University — sitting on a hill, overlooking a \textbf{valley}.
...
And it ' s 10 \textbf{feet} long and three and a half \textbf{feet} wide.
...
And I thought to myself,"You know, if I could georeference this map, if I could place this map in the grid of the city today, I could find these lost features of the city, in the block-by-block geography that people know, the geography of where people go to work, and where they go to live, and where they like to eat."So, after some work we were able to georeference it, which allows us to put the modern streets on the city, and the buildings, and the open spaces, so that we can zoom in to where the Collect Pond is.
We can digitize the Collect Pond and the streams, and see where they actually are in the geography of the city today.
So this is \textbf{fun} for finding where things are relative to the old topography.
...
We call these Muir Webs after the Scottish-American naturalist John Muir, who said,"When we try to pick out anything by itself, we find that it ' s bound fast by a thousand invisible cords that cannot be broken, to everything in the universe."So then we took the Muir webs and we took them back to the maps.
...
We can basically take a \textbf{picture} out of any window on Manhattan and see what that landscape looked like 400 years ago.
...
It had this \textbf{resilience} that is what we need in our modern world.
But I wouldn ' t have you think that I don ' t like the place on the right, which I quite do.
I ' ve come to love the city and its kind of diversity, and its \textbf{resilience}, and its dependence on density and how we ' re connected together.
In fact, that I see them as reflections of each other, much as Lewis Carroll did in"Through the Looking Glass."We can compare these two and hold them in our minds at the same time, that they really are the same place, that there is no way that cities can escape from nature.
...
What if we imagined the Upper East Side with green \textbf{roofs}, and streams winding through the city, and windmills supplying the power we need?
...
% matched lemmas: foot, fun, picture, resilience, roof, valley
\end{textsample}
