\begin{textsample}{POS Dim 2 – 2001 – Score 9.00 – 2001/t000092.txt}  \label{ex:f2_pos_040}
I coined my own definition of success in 1934, when I was teaching at a high school in South Bend, Indiana, being a little bit disappointed, and [ disillusioned ] perhaps, by the way parents of the youngsters in my English classes expected their youngsters to get an A or a B.
...
Not everybody could earn an A or a B, and I didn ' t like that way of \textbf{judging}, and I did know how the alumni of various schools back in the ' 30s \textbf{judged} coaches and athletic teams.
...
But it seemed that we didn ' t win each individual game by the margin that some of our alumni had predicted — And quite frequently I really felt that they had backed up their predictions in a more materialistic manner.
...
And I knew how Mr.
Webster defined it, as the accumulation of material possessions or the attainment of a position of power or prestige, or something of that sort, \textbf{worthy} accomplishments perhaps, but in my opinion, not necessarily indicative of success.
...
Then I ran across this simple verse that said,"At God ' s footstool to confess, a poor soul knelt, and bowed his head. ' I failed! ' he cried.
...
If you make the effort to do the best of which you ' re capable, trying to improve the situation that exists for you, I think that ' s success, and I don ' t think others can \textbf{judge} that ; it ' s like character and reputation — your reputation is what you ' re perceived to be ; your character is what you really are.
...
And I may say, I may not see the church, or hear the word, or eat the food their hands may grow, but yet again I may ; And later I may say, I knew him once, and he was weak, or strong, or \textbf{bold} or proud or gay.
...
One was"Never be late."Later on I said certain things — the players, if we were leaving for somewhere, had to be neat and clean.
...
I believe you should be on time, but I felt at \textbf{practice}, for example — we start on time, we close on time.
...
And I tell them,"Don ' t run \textbf{practices} late, because you ' ll go home in a bad mood, and that ' s not good, for a young married man to go home in a bad mood.
...
Not just give it word \textbf{service}, believe that things will work out as they should, providing we do what we should.
...
Big league \textbf{baseball} players — they ' re very perceptive about those things, and they noticed he had only one ' i ' in his name.
...
He called it"The Road Ahead, or the Road Behind."He said,"Sometimes I think the Fates must grin as we denounce them and insist the only reason we can ' t win, is the Fates themselves have missed.
...
It ' s you and I who make our fates — we open up or close the gates on the road ahead or the road behind."Reminds me of another set of threes that my dad tried to get across to us : Don ' t whine.
Don ' t \textbf{complain}.
Don ' t make excuses.
...
I used to say that when a game is over, and you see somebody that didn ' t know the outcome, I hope they couldn ' t tell by your \textbf{actions} whether you outscored an opponent or the opponent outscored you.
...
But I wanted the \textbf{score} of a game to be the byproduct of these other things, and not the end itself.
I believe it was one great philosopher who said — no, no — Cervantes.
Cervantes said,"The journey is better than the end."And I like that.
...
As a basketball coach at UCLA, I liked our \textbf{practices} to be the journey, and the game would be the end, the end result.
...
What would you want?"And I said,"Well, I ' d want one that knew why he was at UCLA : to get an education, he was a good student, really knew why he was there in the first place.
...
% matched lemmas: action, baseball, bold, complain, judge, practice, score, service, worthy
\end{textsample}
