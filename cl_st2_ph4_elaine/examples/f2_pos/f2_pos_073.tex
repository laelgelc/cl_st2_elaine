\begin{textsample}{POS Dim 2 – 2008 – Score 11.00 – 2008/t000275.txt}  \label{ex:f2_pos_073}
...
And when we change our behavior in our \textbf{daily} lives, we sometimes leave out the citizenship part and the democracy part.
...
And the military historians taught me, during that quest, that military conflicts are typically put into three categories : local battles, regional or theater wars, and the rare but all-important global, world war â strategic conflicts.
And each level of conflict requires a different allocation of resources, a different approach, a different \textbf{organizational} model.
...
This last fall, I went to the Snow and Ice Data Center in Boulder, Colorado, and talked to the \textbf{researchers} here in Monterey at the Naval Postgraduate Laboratory.
This is what ' s happened in the last 28 years.
To put it in perspective, 2005 was the previous record.
Here ' s what happened last fall that has really unnerved the \textbf{researchers}.
...
Now, briefly, here ' s an image you ' ve seen, as one of the only old images, but I show it because I want to briefly give you CSI : Climate.
...
Well, the Alliance for Climate Protection, which I head in conjunction with Current TV â who did this pro bono â did a worldwide contest to do commercials on how to communicate this.
This is the winner.
NBC â I ' ll show all of the networks here â the top journalists for NBC asked 956 questions in 2007 of the presidential candidates : two of them were about the climate crisis.
...
This is \textbf{peak} fishing in a few seconds.
The ' 60s. ' 70s. ' 80s. ' 90s.
We have to stop this.
And the good news is that we can.
We have the technologies.
We have to have a unified view of how to go about this : the \textbf{struggle} against poverty in the world and the challenge of cutting wealthy country emissions, all has a single, very simple solution.
...
The cities supporting Kyoto in the U.
...
And we have to find a way to create, in the generation of those alive today, a sense of generational \textbf{mission}.
...
How many generations in all of human history have had the opportunity to rise to a challenge that is \textbf{worthy} of our best efforts?
...
Let ' s do that.
Thank you very much.
Chris Anderson : For so many people at TED, there is deep pain that basically a design issue on a voting form â one bad design issue meant that your voice wasn ' t being heard like that in the last eight years in a position where you could make these things come true.
That hurts.
...
Every single debate has been sponsored by"Clean Coal.""Now, even lower emissions!"The richness and fullness of the dialogue in our democracy has not laid the basis for the kind of \textbf{bold} initiative that is really needed.
So they ' re saying the right things and they may â whichever of them is elected â may do the right thing, but let me tell you : when I came back from Kyoto in 1997, with a feeling of great \textbf{happiness} that we ' d gotten that breakthrough there, and then confronted the United States Senate, only one out of 100 senators was willing to vote to confirm, to ratify that treaty.
...
Demand â change the light bulbs, but change the laws.
...
This Alliance for Climate Protection is going to launch a nationwide campaign â grassroots mobilization, television \textbf{ads}, Internet \textbf{ads}, radio, newspaper â with partnerships with everybody from the Girl Scouts to the hunters and fishermen.
We need help.
We need help.
...
% matched lemmas: ad, bold, daily, happiness, mission, organizational, peak, researcher, struggle, worthy
\end{textsample}
