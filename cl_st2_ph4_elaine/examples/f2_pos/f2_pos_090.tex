\begin{textsample}{POS Dim 2 – 2007 – Score 8.00 – 2007/t000356.txt}  \label{ex:f2_pos_090}
...
But if you ask people what the three most important things that they carry are — across cultures and across gender and across contexts — most people will say keys, money and, if they own one, a \textbf{mobile} phone.
...
OK, it might seem like an obvious thing for someone who works for a \textbf{mobile} phone company to ask.
...
So, keys provide an access to shelter and warmth — transport as well, in the U.
S. increasingly.
Money is useful for buying food, sustenance, among all its other uses.
And a \textbf{mobile} phone, it turns out, is a great recovery tool.
...
And in particular, it ' s the \textbf{mobile} phone ' s ability to allow people to transcend space and time.
...
And the \textbf{mobile} phone, in addition, is both personal — and so it also gives you a degree of \textbf{privacy} — and it ' s convenient.
...
So, let me give you an example of delegation in \textbf{practice}, right.
So this is — probably the thing I ' m most \textbf{passionate} about is the research that we ' ve been doing on illiteracy and how people who are illiterate communicate.
So, the U.
N. estimated — this is 2004 figures — that there are almost 800 million people who can ' t read and write, worldwide.
...
And it ' s quite likely that they ' d have a quite simple \textbf{mobile} phone as a phone kiosk.
...
So the first is, it turns anyone who has access to a \textbf{mobile} phone — anyone who has a \textbf{mobile} phone — essentially into an ATM machine.
It brings rudimentary banking \textbf{services} to places where there ' s no banking infrastructure.
...
And we look at this and we think, well, how does that apply, for example, for the design of — the lessons from this — apply to the design of online \textbf{services}, future \textbf{services} in these markets?
...
And yes, this is quite \textbf{trivial}, but actually the lessons from this can apply to that kind of personal area networks.
And what you see here is a couple of phone numbers written above the shack in rural Uganda.
This doesn ' t have house numbers.
This has phone numbers.
So what does it mean when people ' s identity is \textbf{mobile}?
When those extra three billion people ' s identity is \textbf{mobile}, it isn ' t fixed?
...
% matched lemmas: mobile, norm, passionate, practice, privacy, service, trivial
\end{textsample}
