\begin{textsample}{POS Dim 2 – 2004 – Score 9.00 – 2004/t000177.txt}  \label{ex:f2_pos_026}
I was trying to think, how is sync connected to \textbf{happiness}, and it occurred to me that for some reason we take pleasure in synchronizing.
...
I would like to see if this audience would — no, you haven ' t \textbf{practiced}, as far as I know — can you get it together to clap in sync?
Whoa!
...
I ' ll show you a computer model made by Iain Couzin, a \textbf{researcher} at Oxford, that shows how swarms work.
...
It ' s beautiful.
The birds are, we sort of understand, we think, from that computer model, what ' s going on.
...
Mate with me."In a second I ' m going to show you a slow motion of a single firefly so that you can get a sense.
...
The combined light from these beetles — these are actually tiny beetles — is so bright that fishermen out at sea can use them as \textbf{navigating} beacons to find their way back to their home rivers.
It ' s stunning.
...
I ' ve set it on the fastest \textbf{setting}, and I ' m going to now take another one set to the same \textbf{setting}.
...
I ' m going to put them on a movable \textbf{platform}, which is the"Guide to Graduate Study at Cornell."Okay?
So here it is.
...
Now, that might seem a bit whimsical, but this pervasiveness of this tendency towards spontaneous order sometimes has \textbf{unexpected} consequences.
...
I want a blade of light across the Thames."So they built the blade of light, and it ' s a very thin ribbon of steel, the world ' s — probably the flattest and thinnest suspension bridge there is, with cables that are out on the side.
...
Think of the bridge as being like this \textbf{platform}.
...
Was there something \textbf{special} about the Millennium Bridge that caused this effect?
...
Allan McRobie : Yes.
Interviewer : You designed this, yes, this simulated bridge, and this, you reckon, mimics the \textbf{action} of the real bridge?
...
% matched lemmas: action, happiness, navigate, platform, practice, researcher, setting, special, unexpected
\end{textsample}
