\begin{textsample}{POS Dim 2 – 2010 – Score 11.00 – 2010/t002629.txt}  \label{ex:f2_pos_076}
...
Well it turns out there is a way to measure \textbf{happiness} in the brain.
...
And Matthieu ' s \textbf{happiness} measure is off the charts.
...
Compassion is something that creates \textbf{happiness}.
Compassion is fun.
...
So, I started paying attention to what compassion looks like in a business \textbf{setting}.
...
In Google, \textbf{expressions} of corporate compassion almost always follow the same pattern.
...
And \textbf{expressions} of compassion are also found in our international offices.
In China for example, one mid-level employee initiated the largest social \textbf{action} competition in China, involving more than 1, 000 schools in China, working on issues such as education, poverty, health care and the environment.
There is so much organic social \textbf{action} all around Google that the company decided to form a social responsibility team just to support these efforts.
...
According to a very comprehensive study led by Jim Collins, and documented in the book"Good to Great,"it takes a very \textbf{special} kind of leader to bring a company from goodness to greatness.
And he calls them"Level 5 leaders."These are leaders who, in addition to being highly capable, possess two important qualities, and they are humility and ambition.
...
The second compelling benefit of compassion is that it creates an inspiring \textbf{workforce}.
...
So, having said all that, what is the secret formula for brewing compassion in the corporate \textbf{setting}?
In our experience, there are three ingredients.
The first ingredient is to create a culture of \textbf{passionate} concern for the greater good.
...
And one of our most popular managers jokes that, this is what he says,"Google is a place where the inmates run the asylum."And he considers himself one of the inmates.
...
Leadership training in Google, for example, places a lot of emphasis on the inner qualities, such as self-awareness, self-mastery, \textbf{empathy} and compassion, because we believe that leadership begins with character.
...
What does that mean?
It means being able to \textbf{observe} our thought stream and the process of emotion with high clarity, objectivity and from a third-person perspective.
...
I want you to be happy."Imagine you can do that.
...
And this also creates the conditions for compassion in the \textbf{workplace}.
...
And in closing, I want to end the same place I started, with \textbf{happiness}.
I want to quote this guy — the guy in robes, not the other guy — the Dalai Lama, who said,"If you want others to be happy, \textbf{practice} compassion.
If you want to be happy, \textbf{practice} compassion."I found this to be true, both on the individual level and at a corporate level.
And I hope that compassion will be both fun and profitable for you too.
Thank you.

% matched lemmas: action, empathy, expression, happiness, observe, passionate, practice, setting, special, workforce, workplace
\end{textsample}
