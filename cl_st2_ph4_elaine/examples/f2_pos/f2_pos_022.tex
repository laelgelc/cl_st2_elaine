\begin{textsample}{POS Dim 2 – 2005 – Score 12.00 – 2005/t000425.txt}  \label{ex:f2_pos_022}
...
And for the first, I don ' t know, three to five years of their life, mountain bikes were known as"clunkers."And they were just made in a community of bikers, mainly in Northern California.
...
It ' s when the Internet combines with these kinds of \textbf{passionate} pro-am consumers â who are knowledgeable ; they ' ve got the incentive to innovate ; they ' ve got the tools ; they want to â that you get this kind of explosion of creative collaboration.
...
The traditional view, still enshrined in much of the way that we think about creativity â in organizations, in government â is that creativity is about \textbf{special} people : wear \textbf{baseball} caps the wrong way round, come to conferences like this, in \textbf{special} places, elite universities, R\&D labs in the forests, water, maybe \textbf{special} rooms in companies painted funny colors, you know, bean bags, maybe the odd table-football table. \textbf{Special} people, \textbf{special} places, think up \textbf{special} ideas, then you have a pipeline that takes the ideas down to the waiting consumers, who are passive.
...
More \textbf{special} people, more \textbf{special} places.
...
When the \textbf{mobile} telephone companies invented SMS, they had no idea what it was for ; it was only when that technology got into the hands of teenage users that they invented the use.
...
Emerging new markets, then, are the breeding grounds for \textbf{passionate} users.
...
They do it on their own tapes, with their own recording equipment ; they distribute it themselves. 30 years later, rap music is the dominant musical form of popular culture â would never have come from the big companies.
Had to start â this is the third point â with these pro-ams.
This is the phrase that I ' ve used in some stuff which I ' ve done with a think tank in London called Demos, where we ' ve been looking at these people who are amateurs â i. e., they do it for the love of it â but they want to do it to very high standards.
And across a whole range of fields â from software, astronomy, natural sciences, vast areas of leisure and culture like kite- surfing, so on and so forth â you find people who want to do things because they love it, but they want to do these things to very high standards.
They work at their leisure, if you like.
They take their leisure very seriously : they acquire skills ; they invest time ; they use technology that ' s getting cheaper â it ' s not just the Internet : cameras, design technology, leisure technology, surfboards, so on and so forth.
...
Consumption, in that sense, is an \textbf{expression} of their productive potential.
...
This has huge \textbf{organizational} implications for very large areas of life.
...
And it was huge â it was absolutely enormous.
Now, six amateur astronomers, working with the Internet, with Dobsonian digital telescopes â which are pretty much open source â with some light sensors developed over the last 10 years, the Internet â they can do what Jodrell Bank could only do 30 years ago.
So here in astronomy, you have this vast explosion of new productive resources.
The users can be producers.
What does this mean, then, for our \textbf{organizational} landscape?
Well, just imagine a world, for the moment, divided into two camps.
Over here, you ' ve got the old, traditional corporate model : \textbf{special} people, \textbf{special} places ; patent it, push it down the pipeline to largely waiting, passive consumers.
Over here, let ' s imagine we ' ve got Wikipedia, Linux, and beyond â open source.
This is open ; this is closed.
This is new ; this is traditional.
Well, the first thing you can say, I think with certainty, is what Yochai has said already â is there is a great big \textbf{struggle} between those two \textbf{organizational} forms.
...
And so the debates about copyright, digital rights, so on and so forth â these are all about trying to stifle, in my view, these kinds of organizations.
...
I ' ve invented this brilliant new program that is much, much better than Microsoft Outlook."Which venture capitalist in their right mind is going to give you any money to set up a venture competing with Microsoft, with Microsoft Outlook?
No one.
That is why the competition with Microsoft is bound to come â will only come â from an open-source kind of project.
...
Because the professionals, over here in these closed organizations â they might be academics ; they might be programmers ; they might be doctors ; they might be journalists â my former profession â say,"No, no â you can ' t trust these people over here."When I started in journalism â Financial Times, 20 years ago â it was very, very exciting to see someone reading the newspaper.
...
They ' re not reading my brilliant article!"And we allowed users, readers, two places where they could contribute to the paper : the letters page, where they could write a letter in, and we would condescend to them, cut it in half, and print it three days later.
Or the op-ed page, where if they knew the editor â had been to school with him, slept with his wife â they could write an article for the op-ed page.
...
So, there ' s going to be a tremendous \textbf{struggle}.
...
New \textbf{organizational} models coming about, mixing closed and open in tricky ways.
It won ' t be so clear-cut ; it won ' t be Microsoft versus Linux â there ' ll be all sorts of things in between.
And those \textbf{organizational} models, it turns out, are incredibly powerful, and the people who can understand them will be very, very successful.
Let me just give you one final example of what that means.
I was in Shanghai, in an office block built on what was a rice paddy five years ago â one of the 2, 500 skyscrapers they ' ve built in Shanghai in the last 10 years.
...
How many people does he employ to \textbf{service} that population? 500 people.
Well, how can he \textbf{service} 250 million people from 500 employees?
Because basically, he doesn ' t \textbf{service} them.
He gives them a \textbf{platform} ; he gives them some rules ; he gives them the tools and then he kind of orchestrates the conversation ; he orchestrates the \textbf{action}.
...
Or you can get on a plane, fly to Shanghai, queue up outside Shanda ' s offices â cost probably 600, 700 dollars â and reclaim your character, get your history back.
Every morning, there are 600 people queuing outside their offices to reclaim these characters.
So this is about companies built on communities, that provide communities with tools, resources, \textbf{platforms} in which they can share.
...
If you ' re a games company, and you ' ve got a million players in your game, you only need one percent of them to be co-developers, contributing ideas, and you ' ve got a development \textbf{workforce} of 10, 000 people.
...
The reason why â despite all the efforts to cut it down, to constrain it, to hold it back â why these open models will still start emerging with tremendous force, is that they multiply our productive resources.
And one of the reasons they do that is that they turn users into producers, consumers into designers.
Thank you very much.

% matched lemmas: action, baseball, expression, mobile, organizational, passionate, platform, service, special, struggle, workforce
\end{textsample}
