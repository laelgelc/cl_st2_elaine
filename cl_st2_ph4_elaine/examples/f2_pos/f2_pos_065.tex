\begin{textsample}{POS Dim 2 – 1998 – Score 6.00 – 1998/t000118.txt}  \label{ex:f2_pos_065}
...
And as we thought about our goals — I should say that Interval is really a humanistic institution, in the \textbf{classical} sense that humanism, at its best, finds a way to combine clear-eyed empirical research with a set of core values that fundamentally love and respect people.
...
And sometimes I feel like I can ' t really enjoy myself unless it ' s like a \textbf{vacation}, like when I get Mondays and all those days off.
...
BL : I ' m going to \textbf{fast-forward} to the decision point because I know I don ' t have a lot of time.
...
BL : OK, so we ' re going to emotionally \textbf{navigate}.
...
% matched lemmas: academia, classical, fast-forward, navigate, vacation
\end{textsample}
