\begin{textsample}{POS Dim 2 – 2011 – Score 12.00 – 2011/t002711.txt}  \label{ex:f2_pos_082}
...
So there is among many people â certainly me and most of the people I talk to â a kind of collective dissatisfaction with the way things are working, with the way our institutions run.
...
They almost brought the entire \textbf{financial} system down.
...
Give \textbf{judges} a list of mandatory sentences to impose for crimes, so that you don ' t need to rely on \textbf{judges} using their judgment.
...
Or â or maybe and â in addition to rules, let ' s see if we can come up with some really clever incentives so that, even if the people we deal with don ' t particularly want to serve our interests, it is in their interest to serve our interest â the magic incentives that will get people to do the right thing even out of pure selfishness.
So we offer teachers bonuses if the kids they teach \textbf{score} passing grades on these big test \textbf{scores} that are used to evaluate the quality of school systems.
Rules and incentives â"sticks"and"carrots."We passed a bunch of rules to regulate the \textbf{financial} industry in response to the recent collapse.
...
Maybe these rules will actually improve the way these \textbf{financial} \textbf{services} companies behave.
We ' ll see.
In addition, we are \textbf{struggling} to find some way to create incentives for people in the \textbf{financial} \textbf{services} industry that will have them more interested in serving the long-term interests even of their own companies, rather than securing short-term profits.
So if we find just the right incentives, they ' ll do the right thing â as I said â selfishly, and if we come up with the right rules and regulations, they won ' t drive us all over a cliff.
And Ken [ Sharpe ] and I certainly know that you need to reign in the bankers.
If there is a lesson to be learned from the \textbf{financial} collapse it is that.
...
You design a set of rules that will make sure that the particular reason why the \textbf{financial} system"almost-collapse"can ' t happen again.
It is naive beyond description to think that having blocked this source of \textbf{financial} collapse, you have blocked all possible sources of \textbf{financial} collapse.
...
And in particular, the virtue that we need most of all is the virtue that Aristotle called"practical wisdom."Practical wisdom is the moral will to do the right thing and the moral skill to figure out what the right thing is.
So Aristotle was very interested in watching how the craftsmen around him worked.
And he was impressed at how they would improvise novel solutions to novel problems â problems that they hadn ' t anticipated.
...
They created a ruler that bends, what we would call these days a tape measure â a flexible rule, a rule that bends.
And Aristotle said,"Hah, they appreciated that sometimes to design rounded columns, you need to bend the rule."And Aristotle said often in dealing with other people, we need to bend the rules.
...
And most important, a wise person does this improvising and rule- bending in the \textbf{service} of the right aims.
...
So it matters that you do this wise \textbf{practice} in the \textbf{service} of others and not in the \textbf{service} of yourself.
...
So I ' ll give you an example of wise \textbf{practice} in \textbf{action}.
...
One night, he drank a little too much, and he robbed a \textbf{cab} driver â stole 50 dollars.
...
The \textbf{judge} on the case, Judge Lois Forer thought that this made no sense.
He had never committed a crime before.
He was a responsible husband and father.
He had been faced with desperate circumstances.
All this would do is wreck a family.
And so she improvised a sentence â 11 months, and not only that, but release every day to go to work.
Spend your night in jail, spend your day holding down a job.
He did.
He served out his sentence.
He made restitution and found himself a new job.
And the family was united.
And it seemed on the road to some sort of a decent life â a happy ending to a story involving wise improvisation from a wise \textbf{judge}.
...
He won the appeal.
Michael was sentenced to five years in prison. \textbf{Judge} Forer had to follow the law.
And by the way, this appeal went through after he had finished serving his sentence, so he was out and working at a job and taking care of his family and he had to go back into jail. \textbf{Judge} Forer did what she was required to do, and then she quit the bench.
And Michael disappeared.
So that is an example, both of wisdom in \textbf{practice} and the subversion of wisdom by rules that are meant, of course, to make things better.
Now consider Ms.
Dewey.
Ms.
Dewey ' s a teacher in a Texas elementary school.
She found herself listening to a consultant one day who was trying to help teachers boost the test \textbf{scores} of the kids, so that the school would reach the elite category in percentage of kids passing big tests.
...
Third, don ' t waste your time on kids who moved into the district too late for their \textbf{scores} to be counted.
Focus all of your time and attention on the kids who are on the bubble, the so-called"bubble kids"â kids where your intervention can get them just maybe over the line from failing to passing.
So Ms.
Dewey heard this, and she shook her head in despair while fellow teachers were sort of cheering each other on and nodding approvingly.
It ' s like they were about to go play a football game.
For Ms.
Dewey, this isn ' t why she became a teacher.
...
First, they demoralize the people who are engaged in the activity. \textbf{Judge} Forer quits, and Ms.
Dewey in completely disheartened.
And second, they demoralize the activity itself.
The very \textbf{practice} is demoralized, and the practitioners are demoralized.
It creates people â when you manipulate incentives to get people to do the right thing â it creates people who are addicted to incentives.
...
If you reward teachers for kids ' test \textbf{scores}, they stop caring about educating and only care about test preparation.
If you were to reward doctors for doing more procedures â which is the current system â they would do more.
If instead you reward doctors for doing fewer procedures, they will do fewer.
What we want, of course, is doctors who do just the right amount of procedures and do the right amount for the right reason â namely, to serve the welfare of their patients.
...
We identify one set of people in all of these \textbf{practices} who we call canny outlaws.
...
One in particular is a \textbf{judge} named Robert Russell.
...
And that ' s because he was in a \textbf{special} court.
He was in a court called the Veterans ' Court.
In the Veterans ' Court â this was the first of its kind in the United States.
Judge Russell created the Veterans ' Court.
It was a court only for veterans who had broken the law.
And he had created it exactly because mandatory sentencing laws were taking the judgment out of \textbf{judging}.
No one wanted non-violent offenders â and especially non-violent offenders who were veterans to boot â to be thrown into prison.
...
There ' s a banker who created a for-profit community bank that encouraged bankers â I know this is hard to believe â encouraged bankers who worked there to do well by doing good for their low-income clients.
...
So there are examples like this in medicine â doctors at Harvard who are trying to transform medical education, so that you don ' t get a kind of ethical erosion and loss of \textbf{empathy}, which characterizes most medical students in the course of their medical training.
...
In addition to which there ' s an enormous amount of back and forth, mentoring of one student by another, of all the students by the doctors, and the result is a generation â we hope â of doctors who do have time for the people they treat.
We ' ll see.
So there are lots of examples like this that we talk about.
Each of them shows that it is possible to build on and nurture character and keep a profession true to its proper \textbf{mission} â what Aristotle would have called its proper telos.
...
Aristotle thought that practical wisdom was the key to \textbf{happiness}, and he was right.
There ' s now a lot of research being done in psychology on what makes people happy, and the two things that jump out in study after study â I know this will come as a shock to all of you â the two things that matter most to \textbf{happiness} are love and work.
...
In giving us the will and the skill to do the right thing â to do right by others â practical wisdom also gives us the will and the skill to do right by ourselves.
Thanks.

% matched lemmas: action, cab, empathy, financial, happiness, judge, mission, practice, score, service, special, struggle
\end{textsample}
