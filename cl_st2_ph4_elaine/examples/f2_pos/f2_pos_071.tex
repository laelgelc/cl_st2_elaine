\begin{textsample}{POS Dim 2 – 2012 – Score 11.00 – 2012/t002290.txt}  \label{ex:f2_pos_071}
...
I started \textbf{observing} technology and how criminals were using it as a young patrol officer.
...
Twenty years later, criminals are still using \textbf{mobile} phones, but they ' re also building their own \textbf{mobile} phone networks, like this one, which has been deployed in all 31 states of Mexico by the narcos.
...
They were armed with \textbf{mobile} phones.
...
And they said to him,"Who are you, and what are you doing here?"And the man replied,"I ' m just an innocent schoolteacher."Of course, the terrorists knew that no Indian schoolteacher stays at a suite in the Taj.
...
Is he bald in front?
Does he wear glasses?""Yes, yes, yes,"came the answers.
...
We all worry about our \textbf{privacy} \textbf{settings} on Facebook, but the fact of the matter is, our openness can be used against us.
Terrorists are doing this.
A search engine can determine who shall live and who shall die.
This is the world that we live in.
During the Mumbai siege, terrorists were so dependent on technology that several witnesses reported that as the terrorists were shooting hostages with one hand, they were checking their \textbf{mobile} phone messages in the very other hand.
...
Many of you will remember this \textbf{super} cute video from the last TED, but not all quadcopter swarms are so nice and cute.
...
It will be easy for anybody to go ahead and print their own bio-virus, enhanced versions of ebola or anthrax, weaponized \textbf{flu}.
We recently saw a case where some \textbf{researchers} made the H5N1 avian influenza virus more potent.
...
You see, you can go ahead and create new pandemics, and the \textbf{researchers} who did this were so proud of their accomplishments, they wanted to publish it openly so that everybody could see this and get access to this information.
But it goes deeper than that.
DNA \textbf{researcher} Andrew Hessel has pointed out quite rightly that if you can use cancer treatments, modern cancer treatments, to go after one cell while leaving all the other cells around it \textbf{intact}, then you can also go after any one person ' s cell.
...
For those of you who follow me on Twitter, I will be \textbf{tweeting} out the answer later on today.
...
If you ' re expecting the people who built this to protect you from the coming robopocalypse — — uh, you may want to have a backup plan.
Just saying.
...
The cost of doing a DNA sequence is going to be \textbf{trivial}.
Anybody will have it and we will all have them in the future.
So maybe there ' s a more radical way that we can look at this.
What happens if we were to take the President ' s DNA, or a king or queen ' s, and put it out to a group of a few hundred trusted \textbf{researchers} so they could study that DNA and do penetration testing against it as a means of helping our leaders?
...
The government has proven \textbf{ineffective}.
...
% matched lemmas: flu, ineffective, intact, mobile, observe, privacy, researcher, setting, super, trivial, tweet
\end{textsample}
