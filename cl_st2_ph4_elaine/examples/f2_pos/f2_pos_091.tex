\begin{textsample}{POS Dim 2 – 2009 – Score 9.00 – 2009/t002967.txt}  \label{ex:f2_pos_091}
...
Over a five year period following September 11th, when the American media and government were seeking hidden and unknown sites beyond its borders, most notably weapons of mass destruction, I chose to look inward at that which was integral to America ' s foundation, mythology and \textbf{daily} functioning.
...
And it ' s just another place from which to \textbf{observe}, and the understanding that there are no absolute, all-knowing insiders.
...
And they \textbf{observe} deliberations after mock \textbf{trial} proceedings so that they can better advise their clients how to adjust their \textbf{trial} strategy to have the outcome that they ' re hoping for.
...
This is the Forensic Anthropology Research Facility, and on a six acre plot there are approximately 75 cadavers at any given time that are being studied by forensic anthropologists and \textbf{researchers} who are interested in monitoring a rate of corpse decomposition.
...
And this is... a division of the Library of Congress produces a free national library \textbf{service} for the blind and visually impaired, and the \textbf{publications} they choose to publish are based on reader popularity.
And Playboy is always in the top few.
But you ' d be surprised, they don ' t do the photographs.
It ' s just the text.
This is an avian \textbf{quarantine} facility where all imported birds coming into America are required to undergo a 30-day \textbf{quarantine}, where they are tested for diseases including Exotic Newcastle Disease and Avian Influenza.
...
And I worked with Mehta Vihar who creates virtual simulations for the army for tactical \textbf{practice}.
...
It ' s titled"The Innocents."And for the men in these photographs, photography had been used to create a fantasy.
...
I photographed Ron at a \textbf{baseball} field because he had been drafted to the Oakland A ' s to play professional \textbf{baseball} just before his conviction.
...
% matched lemmas: baseball, daily, observe, practice, publication, quarantine, researcher, service, trial
\end{textsample}
