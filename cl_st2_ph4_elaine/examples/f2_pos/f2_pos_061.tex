\begin{textsample}{POS Dim 2 – 2014 – Score 12.00 – 2014/t001880.txt}  \label{ex:f2_pos_061}
...
ES : You know, everybody who is involved with this debate has been \textbf{struggling} over me and my personality and how to describe me.
But when I think about it, this isn ' t the question that we should be \textbf{struggling} with.
...
When I really came to \textbf{struggle} with these issues, I thought to myself, how can I do this in the most responsible way, that \textbf{maximizes} the public benefit while minimizing the risks?
...
And by working with journalists, by giving all of my information back to the American people, rather than trusting myself to make the decisions about \textbf{publication}, we ' ve had a robust debate with a deep investment by the government that I think has resulted in a benefit for everyone.
...
S. government where they ' ve said 15 federal \textbf{judges} have reviewed these programs and found them to be lawful, but what they don ' t tell you is those are secret \textbf{judges} in a secret court based on secret interpretations of law that ' s considered 34, 000 warrant requests over 33 years, and in 33 years only rejected 11 government requests.
...
The reason this matters is today, if you go to look at a copy of"1984"on Amazon. com, the NSA can see a record of that, the Russian intelligence \textbf{service} can see a record of that, the Chinese \textbf{service} can see a record of that, the French \textbf{service}, the German \textbf{service}, the \textbf{services} of Andorra.
...
All companies need to move to an encrypted browsing habit by default for all users who haven ' t taken any \textbf{action} or picked any \textbf{special} methods on their own.
That ' ll increase the \textbf{privacy} and the rights that people enjoy worldwide.
...
We can ' t tell you how many communications we ' re intercepting around the world, because to tell you that would be to invade your \textbf{privacy}.
...
The headline says,"NSA broke \textbf{privacy} rules thousands of times per year."Tell us about that.
...
We have a right to \textbf{privacy}.
...
They say hey, we need to work with you to secure your systems, but in reality, they ' re giving bad advice to these companies that makes them degrade the security of their \textbf{services}.
...
ES : Yeah.
The bottom line is that terrorism has always been what we in the intelligence world would call a cover for \textbf{action}.
...
I want to help my government, but the fact that they are willing to completely ignore due process, they ' re willing to declare guilt without ever seeing a \textbf{trial}, these are things that we need to work against as a society, and say hey, this is not appropriate.
...
Tim, actually, would you like to come up and say, do we have a \textbf{microphone} for Tim?
Tim, good to see you.
Come up there.
...
ES : Absolutely.
I mean, my generation, I grew up not just thinking about the Internet, but I grew up in the Internet, and although I never expected to have the chance to defend it in such a direct and practical manner and to embody it in this unusual, almost avatar manner, I think there ' s something poetic about the fact that one of the sons of the Internet has actually become close to the Internet as a result of their political \textbf{expression}.
...
There was a recent legal article at Yale that established something called the Bankston-Soltani Principle, which is that our expectation of \textbf{privacy} is violated when the capabilities of government surveillance have become cheaper by an order of magnitude, and each time that occurs, we need to revisit and rebalance our \textbf{privacy} rights.
...
It ' s a lot warmer.
CA : At TED, the \textbf{mission} is"ideas worth spreading."If you could encapsulate it in a single idea, what is your idea worth spreading right now at this moment?
ES : I would say the last year has been a reminder that democracy may die behind closed doors, but we as individuals are born behind those same closed doors, and we don ' t have to give up our \textbf{privacy} to have good government.
...
% matched lemmas: action, expression, judge, maximize, microphone, mission, privacy, publication, service, special, struggle, trial
\end{textsample}
