\begin{textsample}{POS Dim 2 – 2017 – Score 13.00 – 2017/t001157.txt}  \label{ex:f2_pos_047}
...
And here ' s the \textbf{follow-up}, which I think is being published in the US next week.
YNH : Yeah, next week.
...
And you see it again all over the world that this is now the main \textbf{struggle}.
...
This makes the political system \textbf{ineffective}, because it has no control over the forces that shape our life.
...
There are also many, many positive things about patriotism, and the ability to have a large number of people care about each other, sympathize with one another, and come together for collective \textbf{action}.
...
We are all living together on a single planet, which is threatened by our own \textbf{actions}.
...
CA : So it was a beautiful idea in a world where most of the \textbf{action}, most of the issues, took place on national scale, but your argument is that the issues that matter most today no longer take place on a national scale but on a global scale.
YNH : Exactly.
...
So unless you plan to build a big wall on the border of California — the wall on the border with Mexico is going to be very \textbf{ineffective}.
...
They might be cyborgs or — YNH : Yeah, they could be enhanced \textbf{super} humans.
...
If you accept the reality of the problem, then you must accept that, yes, there is still room in the world for patriotism, there is still room in the world for having \textbf{special} loyalties and obligations towards your own people, towards your own country.
...
We ' ve got a \textbf{microphone} here.
...
So, Kat Hebron on Facebook, calling in from Vail :"How would developed nations manage the millions of climate migrants?"YNH : I don ' t know.
...
So there is a built-in imbalance in the political system today which is very \textbf{frustrating}, where you cannot do a lot of good but you can still do a lot of harm.
...
CA : Can we have the \textbf{microphone} here, please, to Andrew?
...
So you didn ' t need any more agricultural workers, so people moved to working in low-skill industrial jobs, and when this was taken away by more and more machines, people moved to low- skill \textbf{service} jobs.
...
I mean, in your own thinking, isn ' t there a chance that what humans are for is to be the universe ' s sentient things, to be the centers of joy and love and \textbf{happiness} and hope?
...
CA : I want to hear more on this, because the very words"global governance"are almost the epitome of evil in the \textbf{mindset} of a lot of people on the alt-right right now.
...
% matched lemmas: action, follow-up, frustrating, happiness, ineffective, microphone, mindset, service, special, struggle, super
\end{textsample}
