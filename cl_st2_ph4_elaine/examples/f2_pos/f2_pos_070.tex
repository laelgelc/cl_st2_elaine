\begin{textsample}{POS Dim 2 – 2012 – Score 14.00 – 2012/t002277.txt}  \label{ex:f2_pos_070}
...
When the gates opened, there was a stampede, and 20 people were \textbf{injured} and one woman died.
...
It ' s a Machine Learning class, and it has 400 people \textbf{enrolled} every time it ' s offered.
...
We currently have 43 courses on the \textbf{platform} from four universities across a range of disciplines, and let me show you a little bit of an overview of what that looks like.
...
Dan Jurafsky : Does Lufthansa serve breakfast and San Jose?
...
And these would be real homework assignments for a real grade, with a real \textbf{deadline}.
You can see the \textbf{deadlines} and the usage graph.
...
Some students took their certificate and presented this to an educational institution at which they were \textbf{enrolled} for actual college credit.
...
Perhaps one of the biggest components of this effort is that we need to have students who \textbf{practice} with the material in order to really understand it.
There ' s been a range of studies that demonstrate the importance of this.
This one that appeared in Science last year, for example, demonstrates that even simple retrieval \textbf{practice}, where students are just supposed to repeat what they already learned gives considerably improved results on various achievement tests down the line than many other educational interventions.
We ' ve tried to build in retrieval \textbf{practice} into the \textbf{platform}, as well as other forms of \textbf{practice} in many ways.
For example, even our videos are not just videos.
Every few minutes, the video pauses and the students get asked a question.
SP :...
These four things.
Prospect theory, hyperbolic discounting, status quo \textbf{bias}, base rate \textbf{bias}.
...
One needs to build in much more meaningful \textbf{practice} questions, and one also needs to provide the students with feedback on those questions.
...
In addition to multiple choice and the kinds of short answer questions that you saw in the video, we can also grade math, mathematical \textbf{expressions} as well as mathematical derivations.
We can grade models, whether it ' s \textbf{financial} models in a business class or physical models in a science or engineering class and we can grade some pretty sophisticated programming assignments.
...
What ' s even more surprising is that self-grades, where the students grade their own work critically — so long as you incentivize them properly so they can ' t give themselves a perfect \textbf{score} — are actually even better correlated with the teacher grades.
...
Which is not a level of \textbf{service} I have ever offered to my Stanford students.
...
Educational \textbf{researcher} Benjamin Bloom, in 1984, posed what ' s called the 2 sigma problem, which he \textbf{observed} by studying three populations.
...
The mastery-based population was a full standard deviation, or sigma, in achievement \textbf{scores} better than the standard lecture-based class, and the individual tutoring gives you 2 sigma improvement in performance.
...
He said that,"College is a place where a professor ' s lecture notes go straight to the students ' lecture notes, without passing through the brains of either."I beg to differ with Mark Twain, though.
I think what he was \textbf{complaining} about is not universities but rather the lecture-based format that so many universities spend so much time on.
...
You can see, for example, that the achievement \textbf{score} almost doubles in this particular experiment.
...
% matched lemmas: bias, complain, deadline, enroll, expression, financial, injure, observe, platform, practice, researcher, row, score, service
\end{textsample}
