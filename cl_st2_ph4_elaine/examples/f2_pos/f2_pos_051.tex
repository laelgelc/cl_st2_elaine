\begin{textsample}{POS Dim 2 – 2023 – Score 11.00 – 2023/t003364.txt}  \label{ex:f2_pos_051}
Isn ' t learning fun?
I absolutely love it.
For the past 15 years, I have been an academic writing instructor, and I ' ve been a coach for the last five.
The people that I usually work with are adults who ' ve returned to school, and I really love working with these folks because, like them, I ' m a lifelong learner, and I ' ve been to school three times, so far, in the past 20 years.
...
The real issue lies in how they think about themselves as learners and what they believe to be true about their abilities.
Now, this might seem like a \textbf{bold} claim, so let me explain.
...
But it needs addressing because that is what is getting in the way of our academic success in learning situations.
...
The first one is that we \textbf{struggle} with a lot of self doubt and uncertainty.
...
All of a sudden, we find ourselves having to \textbf{navigate} online \textbf{platforms} and figure out study habits, and this whole academic writing thing is a whole next level.
And then, we have to read critically.
It ' s a lot.
And then add to this that when we return to school, we often bring with us all the old patterns and beliefs that we ' ve been carrying for the past ten, maybe 20 years, about who we are as learners.
In the past, if we thought that we were weak students, we ' ve already got bags of doubts and insecurities and anxieties, and we \textbf{judge} ourselves harshly right out of the gate.
Now if you ' re thinking,"I was a good student, I got this,"-- no, no.
We \textbf{struggle} because we can set the bar unreasonably high and then \textbf{judge} ourselves just as harshly and as quickly.
And it ' s difficult.
...
We ' re \textbf{juggling} a job and family responsibilities alongside school.
Plus, we want to do well, because we ' re usually there to up-level our career or hit a career goal in some way, to say nothing of the time and the \textbf{financial} investments involved.
So being afraid of failing, well, it ' s understandable, right?
But it is an \textbf{obstacle} to getting the very thing that we want.
So those are the challenges.
There is good news, though.
These can be overcome by making three important \textbf{mindset} shifts when we are in learning situations.
...
Our brain \textbf{interprets} the challenges and discomforts that come with learning and trying new things as dangerous, and it wants to move us into what is familiar and safe.
...
We just are.
Rather than making them mean something about our current or our future ability, or our self-worth, for that matter, we need to get curious and look at these setbacks as offering data that we can use to improve.
...
When we release ourselves from the need to know it all, be perfect and do it all perfectly, we are much better able to evaluate our progress and actually identify the skills we need to build for the outcome that we want.
And then finally, the third shift we need to make is to \textbf{practice} self-compassion, not self-criticism.
...
When we stop criticizing ourselves and start showing ourselves the kindness and the compassion that we so easily give everyone else... we are much more likely to take risks, because we create a sense of safety inside ourselves, that it ' s OK to make mistakes and learn from them.
...
My experience and my work has convinced me that when we build a positive growth \textbf{mindset} alongside our skills in learning situations, not only do we increase our success -- like, intensely -- we uncage our fullest potential, and our possibilities for change and growth are limitless.
Thank you very much.

% matched lemmas: bold, financial, interpret, judge, juggle, mindset, navigate, obstacle, platform, practice, struggle
\end{textsample}
