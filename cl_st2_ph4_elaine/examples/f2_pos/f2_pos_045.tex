\begin{textsample}{POS Dim 2 – 2016 – Score 11.00 – 2016/t001113.txt}  \label{ex:f2_pos_045}
...
For the last 25 years, I have been on a \textbf{mission} to understand why does race matter so profoundly for health.
...
All of these \textbf{researchers} were stating that racism was a factor adversely impacting blacks, but they provided no evidence.
...
A white gentleman stood in the audience and said that while he agreed with me that racism was important, we could never measure racism."We measure self-esteem,"I said."There ' s no reason why we can ' t measure racism if we put our minds to it."And so I put my mind to it and developed three scales.
...
But discrimination also occurs in more minor and subtle experiences, and so my second scale, called the Everyday Discrimination Scale, captures nine items that captures experiences like you ' re treated with less courtesy than others, you receive poorer \textbf{service} than others in restaurants or stores, or people act as if they ' re afraid of you.
This scale captures ways in which the dignity and the respect of people who society does not value is chipped away on a \textbf{daily} basis.
...
Strikingly, some of the effects are \textbf{observed} at a very young age.
For example, a study of black teens found that those who reported higher levels of discrimination as teenagers had higher levels of \textbf{stress} hormones, of blood pressure and of weight at age 20.
However, the \textbf{stress} of discrimination is only one aspect.
...
One explanation for this pattern was a phenomenon that ' s called"implicit \textbf{bias}"or"unconscious discrimination."Research for decades by social psychologists indicates that if you hold a negative stereotype about a group in your subconscious mind and you meet someone from that group, you will \textbf{discriminate} against that person.
...
A group of \textbf{researchers} have put together a database that contains the books, magazines and articles that an average college-educated American would read over their lifetime.
...
Yes.
I am an affirmative \textbf{action} baby.
Without affirmative \textbf{action}, I would not be here.
...
Robert Kennedy said,"Each time a man"— or woman, I would add —"stands up for an ideal or acts to improve the lot of others or strikes out against injustice, he sends forth a tiny ripple of hope, and those ripples can build a current that can sweep down the mightiest walls of oppression and resistance."I am optimistic today because all across America, I have seen ripples of hope.
...
Loma Linda University has built a gateway college in \textbf{nearby} San Bernardino so that in addition to delivering medical care, they can provide job skills and job training to a predominantly minority, low-income community members so that they will have the skills they need to get a decent job.
...
And finally, there is the Devine solution.
Professor Patricia Devine of the University of Wisconsin has shown us how we can attack our hidden \textbf{biases} head on and effectively reduce them.
...
We must dissent because America can do better, because America has no choice but to do better."Thank you.

% matched lemmas: action, bias, daily, discriminate, mission, nearby, observe, researcher, service, stress
\end{textsample}
