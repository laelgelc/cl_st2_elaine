\begin{textsample}{POS Dim 2 – 2023 – Score 18.00 – 2023/t003333.txt}  \label{ex:f2_pos_049}
...
And today, we want to bring you something \textbf{special} : an hour of nuance, of real people and clarity about what is happening to our planet and what we ' re doing about it.
...
There are other greenhouse gases, but these three make up the bulk of the climate challenge.
...
This is the climate challenge we face : going from adding billions of metric tons of greenhouse gases to the air each year to adding zero.
Will it be easy?
No.
Can we do it?
Yes, if we choose to.
...
Well, the UN ' s climate chief, Simon Stiell, believes we are almost at a tipping point for massive \textbf{action} on climate change.
...
She tells you that \textbf{mobile} phone text messaging is going to fundamentally change the way we communicate.
You think, why on Earth am I going to go from this to tapping on a screen with my fingers and my thumbs?
But then, after a slow start, text-based \textbf{services} exploded.
Today, over 23 billion messages are sent every single day.
This paved the way for the smartphone revolution.
I know how much we \textbf{struggle} to comprehend and predict what exponential change means, because I was at Nokia in 1993 when that technological revolution started.
And now, as head of UN climate change, I ' m here to tell you that what was true for \textbf{mobile} phones is also true for climate \textbf{action} today.
...
Jennie Dodson : So my moment of \textbf{mindset} shift was in 2019.
...
It ' s going to be hard, but some of us are already doing it, so learn from us. [ Chapter 2 : The Electric Vehicle Revolution ] OK, we are in an exponential \textbf{mindset}.
And as you heard, one example of exponential growth might be sitting in your driveway right now.
Electric vehicles are finally really happening, which means that people here in Detroit are \textbf{rethinking} the auto industry.
They ' re \textbf{rethinking} their jobs, their identity.
...
MI : Electric vehicles were able to deal with mobility in urban areas, but there were charging deserts where rural \textbf{driving} resulted in no way to get back because you couldn ' t find electric charging everywhere.
...
The creation was celebrated as the dawn of a new era, as \textbf{reporters} touted that civilization would soon run on the sun ' s limitless energy.
...
Hongquiao Liu : China ' s coal demand might not have \textbf{peaked}, and China will continue to consume quite a lot of coal in the next few years.
...
Eduarda Zoghbi : I think one of the biggest \textbf{obstacles} today are natural resources, in the sense that we ' re talking more and more about critical minerals and the role that they have.
...
Everything ' s the same, it ' s just clean, but it costs a lot of money and it ' s \textbf{super} hard to do.
...
And there ' s nothing in the physics, chemistry or biology that says we can ' t have a \textbf{super} interesting, exciting, vibrant world.
...
Collective \textbf{action}, building together is what makes the difficult possible and nourishes the soul through \textbf{mission} and purpose.
...
She owned a home and knew that home \textbf{ownership} would create wealth and opportunity for her growing family.
...
MZ : Do you remember if there was a moment when the two of you thought, like, what we ' re doing, it shouldn ' t be \textbf{special} to us.
...
JWA : I feel like almost every day I ' m getting a notification from the weather Channel of an excessive heat \textbf{warning} or thunderstorm \textbf{warning} or hail threat.
...
So if we ' re able to do this, in five years, everybody ' s doing these \textbf{practices}, the US rice industry will be the most sustainable industry in the world.
MZ : Can you do it?
JW : Oh, yeah.
...
AC : I ' m constantly surrounded by young people just like me who are really, really, really \textbf{passionate} about the world that we live in.
For obvious reasons.
...
% matched lemmas: action, driving, mindset, mission, mobile, obstacle, ownership, passionate, peak, practice, reporter, rethink, service, special, struggle, super, warning
\end{textsample}
