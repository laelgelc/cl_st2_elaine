\begin{textsample}{POS Dim 2 – 2009 – Score 9.00 – 2009/t002966.txt}  \label{ex:f2_pos_092}
I believe that there are new, hidden tensions that are actually happening between people and institutions â institutions that are the institutions that people inhabit in their \textbf{daily} life : schools, hospitals, \textbf{workplaces}, factories, offices, etc.
And something that I see happening is something that I would like to call a sort of"democratization of intimacy."And what do I mean by that?
I mean that what people are doing is, in fact, they are sort of, with their communication channels, they are breaking an imposed \textbf{isolation} that these institutions are imposing on them.
...
For 20 years, I ' ve been looking at how people use channels such as email, the \textbf{mobile} phone, texting, etc.
...
Facebook.
Recently some sociologists from Facebook â Facebook is the channel that you would expect is the most enlargening of all channels.
...
Academic research on \textbf{instant} messaging also shows 100 people on buddy lists, but fundamentally people chat with two, three, four â anyway, less than five.
...
And finally, finally, they ' ve managed to put \textbf{instant} messaging on their computers at work.
...
But what is really exceptional is the \textbf{setting}.
So, think of the three \textbf{settings} I ' ve talked to you about : factory, migration, office.
But it could be in a school, it could be an administration, it could be a hospital.
Three \textbf{settings} that, if we just step back 15 years, if you just think back 15 years, when you clocked in, when you clocked in to an office, when you clocked in to a factory, there was no contact for the whole duration of the time, there was no contact with your private sphere.
...
And this has become such a \textbf{norm} of our professional lives, such a \textbf{norm} and such an expectation.
...
And this has become such a cultural \textbf{norm} that we actually school our children for them to be capable to do this cleavage.
...
The Pew Institute, which produces good data on a regular basis on, for instance, in the States, says that â and I think that this number is conservative â 50 percent of anybody with email access at work is actually doing private email from his office.
I really think that the number is conservative.
In my own research, we saw that the \textbf{peak} for private email is actually 11 o ' clock in the morning, whatever the country. 75 percent of people admit doing private conversations from work on their \textbf{mobile} phones. 100 percent are using text.
The point is that this re-appropriation of the personal sphere is not terribly successful with all institutions.
I ' m always surprised the U.
S.
Army sociologists are discussing of the impact for instance, of soldiers in Iraq having \textbf{daily} contact with their families.
But there are many institutions that are actually blocking this access.
And every day, every single day, I read news that makes me cringe, like a \$15 fine to kids in Texas, for using, every time they take out their \textbf{mobile} phone in school.
Immediate dismissal to bus drivers in New York, if seen with a \textbf{mobile} phone in a hand.
...
% matched lemmas: daily, instant, isolation, mobile, norm, peak, setting, workplace
\end{textsample}
