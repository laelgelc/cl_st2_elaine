\begin{textsample}{POS Dim 2 – 2007 – Score 9.00 – 2007/t000238.txt}  \label{ex:f2_pos_088}
Well, good morning.
...
Girl 2 : That would be so \textbf{stressful}.
Girl 5 : No.
PH : How come?
...
Of course, the first computer was built just after World War II to solve military problems, but things got really interesting just a couple of years later — 1949 with Whirlwind, built at MIT ' s Lincoln Lab.
...
Now, at the standard rate of fuel consumption, I would like to see the computer trace the flight path of this rocket and see how it can determine, at any \textbf{instant}, say at the end of 40 seconds, the amount of fuel remaining, and the velocity at that set \textbf{instant}.
...
And as it reaches the \textbf{peak} of its trajectory, the velocity, you will notice, has dropped off to a minimum.
...
Marshall McLuhan : If the audience can become involved in the actual process of making the \textbf{ad}, then it ' s happy.
...
You know, the \textbf{expression} of technology reflects the people and the time of the culture it was built in.
...
In the midst of revolution in the streets and rock and roll concerts in the parks, a group of \textbf{researchers} led by people like John McCarthy, a computer scientist at the Stanford Artificial Intelligence Lab, and Doug Engelbart, a computer scientist at SRI, changed the world.
...
What the entertainment business is \textbf{struggling} with, the world of brands is figuring out.
...
% matched lemmas: ad, expression, instant, peak, researcher, stressful, struggle
\end{textsample}
