\begin{textsample}{POS Dim 2 – 1998 – Score 4.00 – 1998/t000200.txt}  \label{ex:f2_pos_066}
...
With onboard GPS, it can \textbf{navigate} autonomously, and it is rugged enough to self-land without damage.
...
It ' s amazing : just on the puny power of the sun â by having a \textbf{super} lightweight plane, you ' re able to get it up there.
...
And we ' ll fly it, we hope, with the same success that we had last night when we did the \textbf{practice}.
...
This is a \textbf{warning}, and we have to think seriously about it.
...
Now, I said this was a \textbf{warning}, not a forecast.
...
% matched lemmas: navigate, practice, super, warning
\end{textsample}
