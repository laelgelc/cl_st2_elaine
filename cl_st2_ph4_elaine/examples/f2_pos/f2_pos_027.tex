\begin{textsample}{POS Dim 2 – 2004 – Score 7.00 – 2004/t000459.txt}  \label{ex:f2_pos_027}
...
And one of the main reasons our brain got so big is because it got a new part, called the"frontal lobe,"particularly, a part called the"prefrontal cortex."What does a prefrontal cortex do for you that should justify the entire architectural overhaul of the human skull in the blink of evolutionary time?
...
Pilots \textbf{practice} in flight simulators so that they don ' t make real mistakes in planes.
...
A recent study — this almost floors me — a recent study showing how major life traumas affect people suggests that if it happened over three months ago, with only a few exceptions, it has no impact whatsoever on your \textbf{happiness}.
Why?
Because \textbf{happiness} can be synthesized.
...
We synthesize \textbf{happiness}, but we think \textbf{happiness} is a thing to be found.
Now, you don ' t need me to give you too many examples of people synthesizing \textbf{happiness}, I suspect, though I ' m going to show you some experimental evidence.
You don ' t have to look very far for evidence.
I took a copy of the"New York Times"and tried to find some instances of people synthesizing \textbf{happiness}.
Here are three guys synthesizing \textbf{happiness}."I ' m better off physically, financially, mentally...""I don ' t have one minute ' s regret.
It was a glorious experience.""I believe it turned out for the best."Who are these characters who are so damn happy?
...
What does he have to say all these years later about it?"I am so much better off physically, financially, mentally and in almost every other way."What other way would there be to be better off?
Vegetably?
Minerally?
Animally?
...
He was ultimately [ released for good behavior halfway through his sentence. ] What did he have to say about his experience?"I don ' t have one minute ' s regret.
It was a glorious experience."Glorious!
This guy ' s not saying,"There were some nice guys.
They had a gym.""Glorious"— a word we usually reserve for something like a religious experience.
Harry S.
Langerman uttered these words.
...
They said,"We can give you a franchise on this for 3, 000 bucks."Harry went back to New York, asked his brother, an investment banker, to loan him 3, 000 dollars, and his brother ' s immortal words were,"You idiot, nobody eats hamburgers."He wouldn ' t lend him the money.
...
Well, in 1994, when Pete Best was interviewed — yes, he ' s still a drummer ; yes, he ' s a studio musician — he had this to say :"I ' m happier than I would have been with the Beatles."OK, there ' s something important to be learned from these people, and it is the secret of \textbf{happiness}.
...
Yeah, right.
Because when people synthesize \textbf{happiness}, as these gentlemen seem to have done, we all smile at them, but we kind of roll our eyes and say,"Yeah, right, you never really wanted the job.""Oh yeah, right — you really didn ' t have that much in common with her, and you figured that out just about the time she threw the engagement ring in your face."We smirk, because we believe that synthetic \textbf{happiness} is not of the same quality as what we might call"natural \textbf{happiness}."What are these terms?
Natural \textbf{happiness} is what we get when we get what we wanted, and synthetic \textbf{happiness} is what we make when we don ' t get what we wanted.
And in our society, we have a strong belief that synthetic \textbf{happiness} is of an inferior kind.
...
I want to suggest to you that synthetic \textbf{happiness} is every bit as real and enduring as the kind of \textbf{happiness} you stumble upon when you get exactly what you were aiming for.
Now, I ' m a scientist, so I ' m going to do this not with rhetoric, but by marinating you in a little bit of data.
Let me first show you an experimental paradigm that ' s used to demonstrate the synthesis of \textbf{happiness} among regular old folks.
This isn ' t mine, it ' s a 50- year-old paradigm called the"free choice paradigm."It ' s very simple.
...
Sometime later — it could be 15 minutes, it could be 15 days — the same stimuli are put before the subject, and the subject is asked to re-rank the stimuli."Tell us how much you like them now."What happens?
Watch as \textbf{happiness} is synthesized.
This is the result that ' s been replicated over and over again.
You ' re watching \textbf{happiness} be synthesized.
Would you like to see it again? \textbf{Happiness}!"The one I got is really better than I thought!
That other one I didn ' t get sucks!"That ' s the synthesis of \textbf{happiness}.
...
Like everybody else, they said,"Gee, thanks Doc!
That ' s great!
...
Back into the room, we say,"Hi, we ' re back."The patients, bless them, say,"Ah, Doc, I ' m sorry, I ' ve got a memory problem ; that ' s why I ' m here.
If I ' ve met you before, I don ' t remember.""Really, Jim, you don ' t remember?
...
Here ' s what normal controls do : they synthesize \textbf{happiness}.
Right?
This is the change in liking \textbf{score}, the change from the first time they ranked to the second time they ranked.
...
What these people did when they synthesized \textbf{happiness} is they really, truly changed their affective, hedonic, aesthetic reactions to that poster.
...
And yet, all of us have this psychological immune system, this capacity to synthesize \textbf{happiness}, but some of us do this trick better than others.
And some situations allow anybody to do it more effectively than other situations do.
It turns out that freedom, the ability to make up your mind and change your mind, is the friend of natural \textbf{happiness}, because it allows you to choose among all those delicious futures and find the one that you would most enjoy.
But freedom to choose, to change and make up your mind, is the enemy of synthetic \textbf{happiness}, and I ' m going to show you why.
Dilbert already knows, of course."Dogbert ' s tech support.
How may I abuse you?""My printer prints a blank page after every document.""Why \textbf{complain} about getting free paper?""Free?
Aren ' t you just giving me my own paper?""Look at the quality of the free paper compared to your lousy regular paper!
Only a \textbf{fool} or a liar would say that they look the same!""Now that you mention it, it does seem a little silkier!""What are you doing?""I ' m helping people accept the things they cannot change."Indeed.
...
They have two gorgeous 8 x 10 glossies of meaningful things to them, and we say,"Which one would you like to give up?""I have to give one up?""Yes, we need one as evidence of the class project.
...
You ever want to change your mind, it ' s totally returnable."The other half of the students are told exactly the opposite :"Make your choice, and by the way, the mail is going out, gosh, in two minutes, to England.
...
Why?
Because the [ reversible ] condition is not conducive to the synthesis of \textbf{happiness}.
...
Hello?
Sixty-six percent of the students choose to be in the course in which they will ultimately be deeply dissatisfied with the picture — because they do not know the conditions under which synthetic \textbf{happiness} grows.
The Bard said everything best, of course, and he ' s making my point here but he ' s making it hyperbolically :"' Tis nothing good or bad But thinking makes it so."It ' s nice poetry, but that can ' t exactly be right.
...
Some of these situations may, no doubt, deserve to be preferred to others, but none of them can deserve to be pursued with that \textbf{passionate} ardor which drives us to violate the rules either of prudence or of justice, or to corrupt the future tranquility of our minds, either by shame from the remembrance of our own folly, or by remorse for the horror of our own injustice."In other words : yes, some things are better than others.
...
% matched lemmas: bias, complain, fool, happiness, passionate, practice, score
\end{textsample}
