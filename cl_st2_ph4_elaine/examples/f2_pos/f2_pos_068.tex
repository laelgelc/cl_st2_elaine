\begin{textsample}{POS Dim 2 – 2013 – Score 11.00 – 2013/t001986.txt}  \label{ex:f2_pos_068}
...
Right?
Well, actually, statistically speaking, if you only visit porn sites, you ' re safer.
People normally write that down, by the way.
Actually, about 80 percent of these are small business websites getting infected.
...
You can go online and buy a hacking \textbf{service} to knock your business competitor offline.
...
Not only that, we are providing a short- term-to-long-term DDOS \textbf{service} or scheduled attack, starting five dollars per hour for small personal websites to 10 to 50 dollars per hour.
...
But regardless, it ' s amazing how many products and \textbf{services} are available now to cybercriminals.
For example, this testing \textbf{platform}, which enables the cybercriminals to test the quality of their viruses before they release them on the world.
...
Maybe some of you have received an email that says something like,"Hi, I ' m a Nigerian banker, and I ' d like to give you 53 billion dollars because I like your face."Or funnycats. exe, which rumor has it was quite successful in China ' s recent campaign against America.
Now there are many ways you can get infected.
...
So imagine this scenario : I walk into one of your businesses, looking very awkward and pathetic, with a copy of my C.
V. which I ' ve covered in coffee, and I ask the receptionist to plug in this USB key and print me a new one.
...
Now if I place the mouse cursor over it, this is what we call a command prompt, and using this we can \textbf{navigate} around the computer.
...
It ' s got really awful graphics.
...
Unfortunately, when this was implemented, the developer was slightly inebriated and managed to forget all of the secure coding \textbf{practices} he had learned.
So let ' s imagine that our attacker, called Evil Hacker just for comedy value, inserts something a little nasty.
This is a script.
It ' s code which will be \textbf{interpreted} on the webpage.
...
Chasing 250, 000 pieces of malware a day is a massive challenge, and those numbers are only growing directly in proportion to the length of my \textbf{stress} line, you ' ll note here.
...
Now this was a cross-industry collaboration, people from Facebook, independent \textbf{researchers}, guys from Sophos.
So here we have a couple of documents which our cybercriminals had uploaded to a cloud \textbf{service}, kind of like Dropbox or SkyDrive, like many of you might use.
...
Down below, highlighted in red, in the other section of source code, is this bit"leded:leded."That ' s a username, kind of like you might have on Twitter.
...
So here ' s a photo which resolves to St.
Petersburg.
...
And herein is the greatest lesson of social media and \textbf{mobile} devices for all of us right now.
...
And it ' s kind of like she went into her social media \textbf{settings} and clicked on every option imaginable to make herself really, really insecure.
...
I was relatively inhibited compared to the cybercriminals, who wouldn ' t be so concerned by law, and here you can see my \textbf{mobile} device.
Okay?
So you can see a list of wireless networks.
TEDAttendees, HyattLB.
Where do you think I ' m staying?
My home network, PrettyFlyForAWifi, which I think is a great name.
Sophos\_Visitors, SANSEMEA, companies I work with.
Loganwifi, that ' s in Boston.
HiltonLondon.
CIASurveillanceVan.
...
So something for you to think about : As we adopt these new applications and \textbf{mobile} devices, as we play with these shiny new toys, how much are we trading off convenience for \textbf{privacy} and security?
Next time you install something, look at the \textbf{settings} and ask yourself,"Is this information that I want to share?
...
In the U.
K., a 60 percent reduction since 2003, and there are similar statistics all over the world.
...
So my ask is this : Go online, find these simple best \textbf{practices}, find out how to update and patch your computer.
Get a secure password.
Make sure you use a different password on each of your sites and \textbf{services} online.
Find these resources.
Apply them.
The Internet is a fantastic resource for business, for political \textbf{expression}, for art and for learning.
Help me and the security community make life much, much more difficult for cybercriminals.
Thank you.

% matched lemmas: expression, interpret, mobile, navigate, platform, practice, privacy, researcher, service, setting, stress
\end{textsample}
