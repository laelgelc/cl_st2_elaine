\begin{textsample}{POS Dim 2 – 2007 – Score 9.00 – 2007/t000370.txt}  \label{ex:f2_pos_089}
...
During the twentieth century, we witnessed the atrocities of Stalin, Hitler, Mao, Pol Pot, Rwanda and other genocides, and even though the twenty-first century is only seven years old, we have already witnessed an ongoing genocide in Darfur and the \textbf{daily} horrors of Iraq.
...
And in this supposed source of our moral values, one can read descriptions of what was expected in warfare, such as the following from Numbers 31 :"And they warred against the Midianites as the Lord commanded Moses, and they slew all the males.
...
Also in the Bible, one sees that the death \textbf{penalty} was the accepted punishment for crimes such as homosexuality, adultery, blasphemy, idolatry, talking back to your parents — — and picking up sticks on the Sabbath.
...
The death \textbf{penalty} was a sanction for a long list of non-violent crimes : criticizing the king, stealing a loaf of bread.
Slavery, of course, was the preferred labor-saving device, and cruelty was a popular form of entertainment.
Perhaps the most vivid example was the \textbf{practice} of cat burning, in which a cat was hoisted on a stage and lowered in a sling into a fire, and the spectators shrieked in laughter as the cat, howling in pain, was burned to death.
...
We don ' t consider that a couple of hundred years ago, they may have been burned at the stake for criticizing the king after a \textbf{trial} that lasted 10 minutes, and indeed, that that would have been repeated over and over again.
...
To make it credible, you must avenge all insults and settle all \textbf{scores}, which leads to the cycles of bloody vendetta.
Life becomes an episode of"The Sopranos."Hobbes ' solution, the"Leviathan,"was that if authority for the legitimate use of violence was vested in a single democratic agency — a leviathan — then such a state can reduce the temptation of attack, because any kind of aggression will be punished, leaving its profitability as zero.
...
And as technology and economic efficiency make life longer and more \textbf{pleasant}, one puts a higher value on life in general.
...
You can ' t say that my interests are \textbf{special} compared to yours, anymore than you can say that the particular spot that I ' m standing on is a unique part of the universe because I happen to be standing on it that very minute.
...
CA : Well, Steve, I would love every news media owner to hear that talk at some point in the next year.
I think it ' s really important.
Thank you so much.
SP : My pleasure.

% matched lemmas: daily, empathy, penalty, pleasant, practice, score, service, special, trial
\end{textsample}
