\begin{textsample}{POS Dim 2 – 2020 – Score 15.00 – 2020/t004255.txt}  \label{ex:f2_pos_020}
...
But the events of this past week, the horrific death of George Floyd and the \textbf{daily} protests that have followed, I mean, they provided a new urgency which we, of course, simply have to address.
...
They work with police departments across America, including in Minneapolis, to seek measurable responses to racial \textbf{bias}.
Phil, I can scarcely imagine how the \textbf{stress} in the last week must have been for you.
...
How you can take \textbf{action}, because right now, strategic \textbf{action} is critical for all of us to do the work to change the rules that far too often keep the systems in place that hold us back.
...
Far too often we mistake presence and visibility for power, presence retweets the stories of the movement, people feeling passion about change could sometimes make us feel like change is inevitable, but power is actually the ability to change the rules.
And right now, every day, people are taking \textbf{action}, and what we ' re trying to channel that energy into is a couple of things.
...
So at Color Of Change, we ' ve built a whole \textbf{platform} around a set of demands and are working to build more energy for everyday people to take \textbf{action}.
...
And through the Winning Justice \textbf{platform} at Color Of Change, www. winningjustice. org, what we have worked to do is channel the energy of everyday people to take \textbf{action}.
...
We oftentimes are engaged in \textbf{practices} inside of our companies or in our \textbf{daily} lives supporting media properties and others that are harming our communities, are telling stories.
...
We ' ve got to deconstruct the way in which we see people and deconstruct the way in which we operate, \textbf{practice} and engage and set policy.
...
And as my mother said, \textbf{struggle} is a never-ending process, freedom is never really won.
You earn it and win it in every generation.
Every generation is called to this freedom \textbf{struggle}.
...
How we can bring our allies into the mix, to better support ending systemic violence and racism against the black communities, is a question top of mind for a lot of us.
...
And I think for allies in this \textbf{struggle}, those of us who don ' t live this experience every day, it is time for us to lean in.
...
We opened up our first door fronts after the riots in Watts, so that we can bring legal \textbf{services} and lawyers to the communities so they could demand justice from the police departments.
...
It ain ' t working.
We don ' t need another pattern and \textbf{practice} lawsuit.
We don ' t need another training program on racial \textbf{bias} or implicit \textbf{bias} in police departments, we don ' t need to file another lawsuit on qualified immunity, we don ' t need to, kind of, bring another race discrimination or gender discrimination lawsuit to integrate the police department.
...
We will continue to bring the litigation on qualified immunity, we will do the efforts to hold unaccountable law enforcement officials accountable, we will bring pattern and \textbf{practice} lawsuits, because the justice department is not doing that, so we will continue to do all that good work.
...
That when you have New York City police department spend more money on policing than it does on housing and preservation development, community youth \textbf{services}, homelessness.
...
That ' s not \textbf{worthy} of spending our dollars on police.
...
You know, with that, I \textbf{struggle} with, how do you find the optimism in this moment, because you have to find the optimism.
...
But if you can channel that anger, connect it with \textbf{action} that is toward creating the social and economic change, then it begins to build you up, and then you can begin to become more constructive with the anger.
...
And has kind of -- no, not kind of, has given \textbf{license} to certain things.
...
How do we purge law enforcement of white supremacists?"PAG : So I guess that ' s partially to me, being the psychologist of \textbf{bias}.
...
But the second thing is we need to arm municipalities, that ' s law enforcement, but even more so communities, with the ability to take \textbf{action} when someone violates their values.
...
Concerns about racial \textbf{bias} and concerns about police brutality, and those six officers were back on the same job inside of three months.
...
Because we understood that the incarcerated folks who were being denied access to masks, social \textbf{distancing} and the conditions and lack of testing, and lack of PP, that the people who were also going to be in harm ' s way were going to be the guards as well.
...
And then we have a whole set of politicians that may sometimes say that he said something that was wrong, but then allow for -- but support his \textbf{platform} in other ways.
You know, true co-conspiracy in the effort to dismantle white supremacy and white nationalism is not a thing that people can do on \textbf{vacation}.
...
One of the things I ' m most worried about, and have been worried about since the beginning, what I ' ve been talking to our chiefs about, is say, you must be out of the social \textbf{distancing} policing game.
...
RR : The thing I want to say is that now is the time for \textbf{action}.
And I want to invite people in to join us at Color Of Change to make justice real.
And in so many ways, you can visit us at Color Of Change, you can take \textbf{action}.
...
And as the other speakers have said, now is not the time for reform around the edges, now is time for dismantling the policies and \textbf{practices} that have held us back, and championing solutions and new rules that will move us forward.
...
This one is from David Fenton."How can the movement unite around a clear, simple \textbf{platform} of policies to enshrine in legislation?
...
And in doing it, one of the things that my father said, and I know people sometimes get tired of hearing me say,"My father said,"but I just think, I wish, should I say, we had really listened to him, because we wouldn ' t be on this \textbf{platform} right now having this type of conversation.
...
And then that SWAT analysis has to happen across organizations, so that we can make sure that we are moving in a united manner, off of the strengths that each organization brings, so that we can \textbf{maximize} the impact and the effectiveness to do things like this, in terms of getting the legislation in place that is needed in this hour.
CA : Thanks so much.
...
% matched lemmas: action, bias, bold, daily, distancing, frustrating, license, maximize, platform, practice, service, stress, struggle, vacation, worthy
\end{textsample}
