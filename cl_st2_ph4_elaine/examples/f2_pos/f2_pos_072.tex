\begin{textsample}{POS Dim 2 – 2012 – Score 11.00 – 2012/t002367.txt}  \label{ex:f2_pos_072}
I ' m going to talk to you about optimism â or more precisely, the optimism \textbf{bias}.
...
In the words of Samuel Johnson,"Remarriage is the triumph of hope over experience."So if we ' re married, we ' re more likely to have kids.
And we all think our kids will be especially talented.
This, by the way, is my two-year-old nephew, Guy.
And I just want to make it absolutely clear that he ' s a really bad example of the optimism \textbf{bias}, because he is in fact uniquely talented.
And I ' m not alone.
...
Okay, now do the same for your \textbf{driving} ability.
...
The optimism \textbf{bias} has been \textbf{observed} in many different countries â in Western cultures, in non-Western cultures, in females and males, in kids, in the elderly.
It ' s quite widespread.
But the question is, is it good for us?
So some people say no.
Some people say the secret to \textbf{happiness} is low expectations.
...
Because how we feel when we get dumped or win employee of the month depends on how we \textbf{interpret} that event.
The psychologists Margaret Marshall and John Brown studied students with high and low expectations.
And they found that when people with high expectations succeed, they attribute that success to their own traits."I ' m a genius, therefore I got an A, therefore I ' ll get an A again and again in the future."When they failed, it wasn ' t because they were dumb, but because the exam just happened to be unfair.
...
The behavioral economist George Lowenstein asked students in his university to imagine getting a \textbf{passionate} kiss from a celebrity, any celebrity.
...
In fact, without the optimism \textbf{bias}, we would all be slightly depressed.
People with mild depression, they don ' t have a \textbf{bias} when they look into the future.
They ' re actually more realistic than healthy individuals.
But individuals with severe depression, they have a pessimistic \textbf{bias}.
...
Optimism leads to success in \textbf{academia} and sports and politics.
And maybe the most surprising benefit of optimism is health.
If we expect the future to be bright, \textbf{stress} and anxiety are reduced.
...
And then we asked them again,"How likely are you to suffer from cancer?"What we wanted to know was whether people will take the information that we gave them to change their beliefs.
And indeed they did â but mostly when the information we gave them was better than what they expected.
So for example, if someone said,"My likelihood of suffering from cancer is about 50 percent,"and we said,"Hey, good news.
The average likelihood is only 30 percent,"the next time around they would say,"Well maybe my likelihood is about 35 percent."So they learned quickly and efficiently.
...
The average likelihood is about 30 percent,"the next time around they would say,"Yep.
Still think it ' s about 11 percent."So it ' s not that they didn ' t learn at all â they did â but much, much less than when we gave them positive information about the future.
...
What this means is that \textbf{warning} signs such as these may only have limited impact.
Yes, smoking kills, but mostly it kills the other guy.
What I wanted to know was what was going on inside the human brain that prevented us from taking these \textbf{warning} signs personally.
But at the same time, when we hear that the housing market is hopeful, we think,"Oh, my house is definitely going to double in price."To try and figure that out, I asked the participants in the experiment to lie in a brain imaging scanner.
It looks like this.
...
The more optimistic you were, the less likely this region was to respond to \textbf{unexpected} negative information.
...
Could we alter people ' s optimism \textbf{bias} by interfering with the brain activity in these regions?
...
First of all, I ' m going to show you the average amount of \textbf{bias} that we see.
So if I was to test all of you now, this is the amount that you would learn more from good news relative to bad news.
Now we interfere with the region that we found to integrate negative information in this task, and the optimism \textbf{bias} grew even larger.
We made people more \textbf{biased} in the way that they process information.
Then we interfered with the brain region that we found to integrate good news in this task, and the optimism \textbf{bias} disappeared.
We were quite amazed by these results because we were able to eliminate a deep-rooted \textbf{bias} in humans.
And at this point we stopped and we asked ourselves, would we want to shatter the optimism illusion into tiny little bits?
If we could do that, would we want to take people ' s optimism \textbf{bias} away?
Well I ' ve already told you about all of the benefits of the optimism \textbf{bias}, which probably makes you want to hold onto it for dear life.
...
He says,"Fatality investigations for firefighters often include ' We didn ' t think the fire was going to do that, ' even when all of the available information was there to make safe decisions."This captain is going to use our findings on the optimism \textbf{bias} to try to explain to the firefighters why they think the way they do, to make them acutely aware of this very optimistic \textbf{bias} in humans.
So unrealistic optimism can lead to risky behavior, to \textbf{financial} collapse, to faulty planning.
The British government, for example, has acknowledged that the optimism \textbf{bias} can make individuals more likely to underestimate the costs and durations of projects.
So they have adjusted the 2012 Olympic budget for the optimism \textbf{bias}.
...
We ' re not born with an innate understanding of our \textbf{biases}.
These have to be identified by scientific investigation.
But the good news is that becoming aware of the optimism \textbf{bias} does not shatter the illusion.
...
% matched lemmas: academia, bias, driving, financial, happiness, interpret, observe, passionate, stress, unexpected, warning
\end{textsample}
