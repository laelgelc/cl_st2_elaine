\begin{textsample}{NEG Dim 4 – 2012 – Score -1.00 – 2012/t002163.txt}  \label{ex:f4_neg_012}
...
Well it requires software, it requires hardware and it requires chemical \textbf{inks}.
And so the really cool bit is, the idea is that we want to have a universal set of \textbf{inks} that we put out with the printer, and you download the blueprint, the organic chemistry for that molecule and you make it in the device.
