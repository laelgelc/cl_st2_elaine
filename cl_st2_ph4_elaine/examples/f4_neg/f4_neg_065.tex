\begin{textsample}{NEG Dim 4 – 2007 – Score 2.00 – 2007/t000413.txt}  \label{ex:f4_neg_065}
...
As we move to search, we rely on the relevance rankings, the Web matching, the index \textbf{crawling}.
But we want to use our \textbf{brain}!
...
It ' s actually four color cones.
...
You can see the camera on the front.
...
We imaged it.
We sent in people.
We took pictures of interiors, disaster areas.
...
They ' d collected information with photos.
They ' d manually build each building.
...
It ' s this high resolution data.
