\begin{textsample}{NEG Dim 4 – 2003 – Score 4.00 – 2003/t000124.txt}  \label{ex:f4_neg_048}
...
It actually affects the way the \textbf{brain} works.
...
And it turns out that when you ' re anxious you squirt neural transmitters in the \textbf{brain}, which focuses you makes you depth-first.
...
The \textbf{brain} works differently if you ' re happy.
...
There ' s an amazing amount of stuff that ' s built into the \textbf{brain}.
...
And the third level is reflective, which is, if you like the superego, it ' s a little part of the \textbf{brain} that has no control over what you do, no control over the — doesn ' t see the senses, doesn ' t control the muscles.
