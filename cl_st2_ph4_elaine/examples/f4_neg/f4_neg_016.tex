\begin{textsample}{NEG Dim 4 – 2014 – Score -1.00 – 2014/t001856.txt}  \label{ex:f4_neg_016}
...
It blocks out most of the light so we can see that \textbf{dim} corona around it.
...
We put a telescope or a camera in that shadow, we look back at the sun, and most of the light ' s been removed and we can see that \textbf{dim}, fine structure in the corona.
...
It ' s about 10 billion times \textbf{dimmer} than it was before, and we can see the planets beam out just like that.
