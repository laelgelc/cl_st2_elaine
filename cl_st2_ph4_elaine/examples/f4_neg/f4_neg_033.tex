\begin{textsample}{NEG Dim 4 – 2019 – Score 1.00 – 2019/t002074.txt}  \label{ex:f4_neg_033}
...
That ' s where photons literally move around the black hole, and around that is this hot gas that ' s drawn to the black hole, and it ' s hot because of friction.
...
And I guess you took — you focused on this galaxy way out there.
...
CA : But even though that thing is so huge, because it ' s so far away, to actually dream of getting an image of it, that ' s incredibly hard.
...
SD : Exactly.
What you ' re seeing here is we used telescopes all around the world, we synchronized them perfectly with atomic clocks, so they received the light waves from this black hole, and then we stitched all of that data together to make an image.
...
CA : And so, I guess a few weeks or a few months ago, on a computer screen somewhere, this started to come into view.
This moment.
...
SD : You ' ll see here that some light from behind it gets lensed, and some light does a loop-the-loop around the entire orbit of the black hole.
...
And somewhere in the middle of that there ' s another one, which you ' re trying to find as well.
...
We ' re 200 people strong with 60 institutes and 20 countries and regions.
