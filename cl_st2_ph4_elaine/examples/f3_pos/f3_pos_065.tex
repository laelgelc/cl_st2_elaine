\begin{textsample}{POS Dim 3 – 1990 – Score 2.00 – 1990/t000287.txt}  \label{ex:f3_pos_065}
...
And so the whole idea here was to create that kind of space in downtown, in a \textbf{neighborhood} that was difficult to fit into.
And it was my theory, or my point of view, that one didn ' t upstage the \textbf{neighborhood} â one made accommodations.
I tried to be inclusive, to include the buildings in the \textbf{neighborhood}, whether they were buildings I liked or not.
...
It was a very prominent building off the freeway, and we added a floor and cleaned it up and fixed it up and used the kind of â I thought â the language of the \textbf{neighborhood}, which had these cornices, projecting cornices.
...
But out of it came finally this resolution, where the elevator piece worked frontally to this, parallel to this \textbf{street}, and also parallel to here.
...
On the side facing the \textbf{street} it ' s much more normal, except I slipped a few mansards down, so that coming on the point, these housing units made a gesture to the corner.
...
And as you pass by it ' s always part â you see it as all of these pieces accrue and become part of an overall \textbf{neighborhood}.
...
% matched lemmas: neighborhood, street
\end{textsample}
