\begin{textsample}{POS Dim 3 – 2014 – Score 15.00 – 2014/t001790.txt}  \label{ex:f3_pos_036}
...
So my father tried to get the police on the phone, but perhaps terrified by the rising tide of \textbf{armed} extremism that had already claimed the lives of so many Algerian officers, they didn ' t even answer.
...
In any case, someone would return a few months later and leave a note on Dad ' s kitchen table, which simply said,"Consider yourself dead."Subsequently, Algeria ' s fundamentalist \textbf{armed} groups would murder as many as 200, 000 civilians in what came to be known as the dark decade of the 1990s, including every single one of the women that you see here.
...
You see, in every country where you hear about \textbf{armed} jihadis targeting civilians, there are also unarmed people defying those militants that you don ' t hear about, and those people need our support to succeed.
In the West, it ' s often assumed that Muslims generally condone terrorism.
Some on the right think this because they view Muslim culture as inherently \textbf{violent}, and some on the left imagine this because they view Muslim \textbf{violence}, fundamentalist \textbf{violence}, solely as a product of legitimate grievances.
...
You see, they ' re much more likely to be \textbf{victims} of this \textbf{violence} than its \textbf{perpetrators}.
Let me just give you one example.
According to a 2009 survey of Arabic language media resources, between 2004 and 2008, no more than 15 percent of al Qaeda ' s \textbf{victims} were Westerners.
...
Some use and advocate \textbf{violence}.
...
But what I am saying is that we must challenge these Muslim fundamentalist movements because they threaten human rights across Muslim- majority contexts, and they do this in a range of ways, most obviously with the direct attacks on civilians by the \textbf{armed} groups that carry those out.
But that \textbf{violence} is just the tip of the iceberg.
These movements as a whole purvey \textbf{discrimination} against religious minorities and \textbf{sexual} minorities.
...
I ' m painfully aware that there has been an increase in \textbf{discrimination} against Muslims in recent years in countries like the U.
K. and the U.
S., and that too is a matter of grave concern, but I firmly believe that telling these counter- stereotypical stories of people of Muslim heritage who have confronted the fundamentalists and been their primary \textbf{victims} is also a great way of countering that \textbf{discrimination}.
...
With the rise of jihadist \textbf{violence}, they began to receive threats to call off their events, which they refused to heed.
...
We have to be here."With stalwart audiences like this, the Peerzadas were able to conclude their festival on schedule.
...
They \textbf{sang} and danced, they played the mice and the water buffalo, and I held my breath, wondering, would we get to the end of this amazing show?
...
She ' s been in the post since 2008 and actually opened an office to investigate cases of \textbf{violence} against women, which she says is the most important area in her mandate.
...
She says with a smile that that is the question that everyone asks — as she puts it,"Why you risk not living?"And it is simply that for her, a better future for all the Maria Bashirs to come is worth the risk, and she knows that if people like her do not take the risk, there will be no better future.
Later on in our interview, Prosecutor Bashir tells me how worried she is about the possible outcome of government negotiations with the Taliban, the people who have been trying to kill her."If we give them a place in the government,"she asks,"Who will protect women ' s rights?"And she urges the international community not to forget its promise about women because now they want peace with Taliban.
A few weeks after I leave Afghanistan, I see a headline on the Internet.
An Afghan prosecutor has been assassinated.
I google desperately, and thankfully that day I find out that Maria was not the \textbf{victim}, though sadly, another Afghan prosecutor was gunned down on his way to work.
...
We should prepare the ground for this, even if we are killed."There are no words adequate to denounce the al Shabaab terrorists who attacked the Westgate Mall in Nairobi on the same day as a children ' s cooking competition in September of 2013.
...
Since that time, Mr.
Bihi, who directs the no- budget Somali Education and Advocacy Center, has been vocally denouncing the recruitment and the failures of government and Somali-American institutions like the Abubakar As-Saddique Islamic Center where he believes his nephew was radicalized during a youth program.
But he doesn ' t just criticize the \textbf{mosque}.
He also takes on the government for its failure to do more to prevent poverty in his community.
Given his own lack of financial resources, Mr.
Bihi has had to be creative.
...
For his efforts, Mr.
Bihi has been ostracized by the leadership of the Abubakar As-Saddique Islamic Center, with which he used to have good relations.
He told me,"One day we saw the imam on TV calling us infidels and saying, ' These families are trying to destroy the \textbf{mosque}. '"This is at complete odds with how Abdirizak Bihi understands what he is trying to do by exposing al Shabaab recruitment, which is to save the religion I love from a small number of extremists.
...
Carrying her schoolbag, Amel was taken off the bus and killed in the \textbf{street}.
The men who cut her throat then told everyone else,"If you go to university, the day will come when we will kill all of you just like this."Amel died at exactly 5:17 p. m., which we know because when she fell in the \textbf{street}, her watch broke.
...
You and father must keep your heads held high."The loss of such a young woman is unfathomable, and so as I did my research I found myself searching for Amel ' s hope again and her name even means"hope"in Arabic.
...
In fact, Amel ' s sister Lamia overcame her \textbf{grief}, went to law school, and practices as a lawyer in Algiers today, something which is only possible because the \textbf{armed} fundamentalists were largely defeated in the country.
...
It is not enough, as the \textbf{victims} rights advocate Cherifa Kheddar told me in Algiers, it is not enough just to battle terrorism.
...
% matched lemmas: apologize, armed, discrimination, grief, mosque, perpetrator, sexual, sing, street, victim, violence, violent
\end{textsample}
