\begin{textsample}{POS Dim 3 – 2005 – Score 11.00 – 2005/t000220.txt}  \label{ex:f3_pos_048}
...
You become whatever it is that will freeze you, \textbf{numb} you and protect you from doubt or change.
...
There are evildoers and saints, criminals and \textbf{victims}.
...
In six years, I ' ve had the extraordinary privilege through V-Day, a global movement against [ \textbf{violence} against ] women, to travel probably to 60 countries, and spend a great deal of time in different portions.
I ' ve met women and men all over this planet, who through various circumstances — war, poverty, racism, multiple forms of \textbf{violence} — have never known security, or have had their illusion of security forever devastated.
...
They have broken out of the existing frame of \textbf{victim} and \textbf{perpetrator}.
Their own personal security is not their end goal, and because of that, because, rather than worrying about security, because the transformation of \textbf{suffering} is their end goal, I actually believe they are creating real \textbf{safety} and a whole new idea of security.
...
That will happen because women in Cairo made a decision to stand up and put themselves on the line, and talk about the degree of \textbf{violence} that is happening in Egypt, and were willing to be attacked and criticized.
...
She had seen"The Vagina Monologues"and she was really moved.
And as a result, she wore an"I heart my vagina"button to her high school in Minnesota.
...
Not running from loss, but entering \textbf{grief}, surrendering to sorrow.
...
In the \textbf{shared} future, it will be just that, shared.
...
And I think part of what I ' m learning in this process is that one must allow oneself to feel \textbf{grief}.
...
If you think that the U.
N. now says that one out of three women on the planet will be raped or beaten in their lifetime, we ' re talking about the desecration of the primary resource of the planet, we ' re talking about the place where we come from, we ' re talking about parenting.
...
What I believe is if we could figure out how to make women safe and honor women, it would be parallel or \textbf{equal} to honoring life itself.

% matched lemmas: equal, grief, numb, perpetrator, safety, shared, suffering, victim, violence
\end{textsample}
