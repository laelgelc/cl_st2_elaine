\begin{textsample}{POS Dim 3 – 2020 – Score 27.00 – 2020/t004255.txt}  \label{ex:f3_pos_014}
...
And as we ' ve seen, \textbf{violence} like this unfolds for many, many years.
...
We ' re so grateful to have them here to engage in a discussion about racial injustice in America, the unbearable acts of \textbf{violence} that we ' ve -- Acts of \textbf{violence} against the black community that we ' ve witnessed, the dangers to a nation riven by anger and fear.
...
And then we ' ll engage as a group, including you, the TED community.
WPR : And we ' d like to thank our partner, the Project Management Institute.
Their generous support has helped make today ' s interviews possible, and of course, as Chris mentioned, we want you to take part in the conversation, so please share your questions using our Ask a question feature and continue to share your thoughts in the discussion thread.
CA : Thanks, Whitney.
...
Yeah, this week has been a gut punch to anybody who felt like we could be making progress in the way that we put forward public \textbf{safety} that empowers particularly vulnerable communities.
We started working in Minneapolis about five years ago.
At the time, it was, like most major cities in the United States, a department that had a long history of unaccounted for \textbf{violence} from law \textbf{enforcement}, targeting the most vulnerable black communities.
...
A lynching.
It ' s not just the reaction to three of them : Ahmaud Arbery, Breonna Taylor and then George Floyd.
...
It was Ferguson just six years ago, but about 30 years before that, it was in the \textbf{streets} of Los Angeles, after the verdict that exonerated the police that beat Rodney King on video.
...
The place is called the suburbs, where we already have enough resources to give to people, so they don ' t need the police for public \textbf{safety} in the first place.
...
If there ' s a \textbf{domestic} dispute, they have friends, they have support.
...
It ' s going to need the kind of \textbf{systemic} change and the management tools that we traditionally offer.
It ' s also going to need a quantum change in the way that we think about public \textbf{safety}.
...
To date, more than four million people have signed their petition to arrest the officers involved in the murder of George Floyd.
...
Far too often we mistake presence and visibility for power, presence retweets the stories of the movement, people feeling \textbf{passion} about change could sometimes make us feel like change is inevitable, but power is actually the ability to change the rules.
...
So at Color Of Change, we ' ve built a whole platform around a set of demands and are working to build more energy for everyday people to take action.
...
We ' re building local squads and communities for folks to be able to engage around efforts that hold DAs accountable.
We ' ve worked with our partners across the movement, from our friends in Black Lives Matter, to folks who do policy work, to our friends at local ACLU chapters around the country, to build six demands.
Six demands that folks can get behind in terms of pushing for reform, and then we ' ve built public education material.
...
We oftentimes are engaged in practices inside of our companies or in our daily lives supporting media properties and others that are \textbf{harming} our communities, are telling stories.
...
They create sort of an incentive for the type of policing we see on the country, and actually serve as a PR arm for law \textbf{enforcement}.
...
Black communities have been exploited, black communities have been targeted, and we need to say that, so we don ' t put the onus on fixing black families and communities, but we put the onus on fixing the structures that have \textbf{harmed} us.
...
The prophet said to us,"We still have a choice today : nonviolent coexistence, or \textbf{violent} coannihilation."What we have witnessed over the last eight days has placed that choice before us.
We have seen literally in the \textbf{streets} of our nation people who have been following the path of nonviolent protest, and people who have been hell-bent on destruction.
Those choices are now looking at us, and we have to make a choice.
The history of this nation was founded in \textbf{violence}.
In fact, my father said America is the greatest purveyor of \textbf{violence}.
And the only way forward is if we repent for being a nation built on \textbf{violence}.
And I ' m not just talking about physical \textbf{violence}.
I ' m talking about \textbf{systemic} \textbf{violence}, I ' m talking about policy \textbf{violence}, I ' m talking about what he spoke of are the triple evils of poverty, racism and militarism.
All \textbf{violent}.
...
And so if we are going to move forward, we are going to have to deconstruct these systems of \textbf{violence} that we have set in America.
...
And not continue on the pathway of \textbf{violent} coannihilation.
So what does that look like?
That looks like some deconstruction work in order to get to the construction.
We have to deconstruct our thinking.
We ' ve got to deconstruct the way in which we see people and deconstruct the way in which we operate, practice and engage and set policy.
...
As one of the nation ' s oldest social justice organizations, the ACLU has advocated for racial \textbf{equality} and shown deep support to the black community in moments of crisis.
And in moments like these, black voices are almost always the loudest and at times the \textbf{silence} from our nonblack brothers and sisters can feel deafening.
How we can bring our allies into the mix, to better support ending \textbf{systemic} \textbf{violence} and racism against the black communities, is a question top of mind for a lot of us.
Anthony, welcome to the show, and thank you so much for being with us.
Anthony Romero : Great.
Thank you, thank you Whitney, thank you, Chris, for inviting me to join this TED community.
...
King.
By hearing the voices of our neighbors and loved ones, by hearing the voices on \textbf{Twitter} of people who we don ' t know.
...
All \textbf{equal} before the law?
...
King told us, this is centuries of \textbf{systemic} \textbf{discrimination}, and the bill has come due.
...
In 1931, we were involved with this report about lawlessness in law \textbf{enforcement}.
...
We fought Bloomberg on"stop-and-frisk,"it took him years and he lost in front of our litigation to finally \textbf{apologize}.
We ' ve been at this for 100 years.
...
We don ' t need another training program on racial bias or implicit bias in police departments, we don ' t need to file another lawsuit on qualified immunity, we don ' t need to, kind of, bring another race \textbf{discrimination} or gender \textbf{discrimination} lawsuit to integrate the police department.
...
We will continue to bring the litigation on qualified immunity, we will do the efforts to hold unaccountable law \textbf{enforcement} officials accountable, we will bring pattern and practice lawsuits, because the justice department is not doing that, so we will continue to do all that good work.
...
That when you have New York City police department spend more money on policing than it does on housing and preservation development, community youth services, \textbf{homelessness}.
...
The ubiquitousness of police \textbf{enforcement} on things that the police do not have a role, should not have a role to play.
...
And we need to listen and lean in, and I thank the TED community, I thank Dr.
...
And so to actually believe that protest, including \textbf{violent} protest, actually is the way right now.
...
CA : I \textbf{apologize}, I \textbf{apologize}.
...
Color Of Change, the work that you ' re doing, the ACLU, the work that they ' re doing, because sometimes, there ' s this disconnection that intensifies the emotion and makes you feel \textbf{helpless}.
...
How do we purge law \textbf{enforcement} of white supremacists?"PAG : So I guess that ' s partially to me, being the psychologist of bias.
...
I worry about all the officers that the FBI has now, for almost half a decade, been warning us, law \textbf{enforcement} and unions being infiltrated by white supremacists.
...
We ' re not talking seriously about the \textbf{domestic} terrorism threat that white supremacy represents.
...
But the second thing is we need to arm municipalities, that ' s law \textbf{enforcement}, but even more so communities, with the ability to take action when someone violates their values.
...
We now have a law \textbf{enforcement} system that says you can lose your job in one jurisdiction, and get the same job as law \textbf{enforcement} in another jurisdiction.
And without the national registry and the capacity for law \textbf{enforcement} to make different decisions, we ' re going to have this exact problem, not just in Mississippi, but in Minneapolis, and Louisville and New York and LA.
...
When I talk to union leadership, that ' s the leadership what wants to talk to Dr.
Blackenstein, right, when I talk to union leadership, what they say is no one hates a bad officer more than a good officer.
...
The bigots?
I ' ll protect even them."So we have this perverse incentive where union leadership ends up not really representing the values even of the rest of the union members.
But they have massive, outsized negotiating power.
So yes, engaging with and appropriate rightsizing of labor protections, for folks whose jobs are difficult, but who should not be protected from the basic values of human rights, human dignity and public \textbf{safety}.
It ' s got to be part of the process.
I mean, when unions are negotiating a two-year ban on keeping of records, so that there ' s no ability even to trace what ' s happening in the state of California, historically in terms of police misconduct, that ' s not in the interest of public \textbf{safety}, public legitimacy, or our democracy.
...
Because we understood that the incarcerated folks who were being denied \textbf{access} to masks, social distancing and the conditions and lack of testing, and lack of PP, that the people who were also going to be in \textbf{harm} ' s way were going to be the guards as well.
...
Because you can ' t just throw them out into the \textbf{street}, and say,"You ' re on your own, you ' re \textbf{homeless}, good luck to you."That ' s not a way to deal with redemption.
...
The targeting of black communities through predatory practices like \textbf{bail}.
...
It is a 365-day project of us constantly working to dismantle all of the structures that have been put in \textbf{harm} ' s way.
...
And having members of the Fraternal Order of Police leadership say things like,"All of this talk of racial profiling is new to us."It is one thing for folks to not agree with you on the policy reforms necessary.
...
You can ' t just \textbf{sing} our songs, use our hashtags and march in our marches, if you are on the other end of supporting the structures that put us in \textbf{harm} ' s way, that literally kill us.
...
PAG : And I ' ve got to add to that -- so, Paul, thank you for the question, but we ' re in a moment where people are looking at what ' s happening on the \textbf{street}, as if a week and a half ago we weren ' t in a midst of a global pandemic as the greatest news story, the biggest new story going on.
...
And we ' ve seen that black communities are two and three and four times more likely to contract this virus, which feels like the manifestation of racial \textbf{discrimination}, because it is.
But very soon, that ' s going to look like black people made bad choices and they need to stay away from us.
And when that happens, that ' s when law \textbf{enforcements} get used to regulate where black movement can be.
...
So we ' re not only dealing with a moment of generational tension, between black communities and law \textbf{enforcement}, we ' re dealing with a moment when people are looking for scapegoats, and black people ' s vulnerability has always been our greatest casting note for being cast as scapegoats.
...
I don ' t want to just see black and white cops on their knees, I want to see the policies.
...
And as the other speakers have said, now is not the time for reform around the edges, now is time for dismantling the policies and practices that have held us back, and championing solutions and new rules that will move us forward.
...
But this is an opportunity to make change, and I believe that we can make justice real, if we find the \textbf{passion} and the energy to work together to achieve it.
...
This one is from David Fenton."How can the movement unite around a clear, simple platform of policies to enshrine in legislation?
Like making all complaints against cops public, banning all choke holds, ensuring independent review boards, etc.?"WPR : That seems like a great place for you to chime in, Dr.
...
And that is so key, because oftentimes we organize merely around \textbf{passion}.
...
I also think that it ' s important at this moment to get, we ' ve got law \textbf{enforcement} ' s chiefs of major cities willing to say, if we emerge from this moment and our profession hasn ' t changed, then we have failed again.
So it ' s a critical time to get behind, I would direct you to LCCHR ' s website for the eight pillars, because I won ' t remember them all right now, and to start calling your local law \textbf{enforcement}, and say,"Yes, own that."You should be signing on, they should be going public with letters that do all of that.
...
Really, so powerful.
This conversation, obviously, continues, I know that there ' s many people listening, you have other questions, this, I think, from TED ' s point of view is just the start of the conversation.
...
% matched lemmas: access, apologize, bail, discrimination, domestic, enforcement, equal, equality, harm, helpless, homeless, homelessness, passion, safety, silence, sing, street, systemic, twitter, violence, violent
\end{textsample}
