\begin{textsample}{POS Dim 3 – 2004 – Score 7.00 – 2004/t000486.txt}  \label{ex:f3_pos_071}
...
Well, let me say one thing : We really got \textbf{access} to everybody in the gang.
...
These are the teenagers, typically, who ' d be standing out on the \textbf{street} corner, selling the drugs.
...
In fact, in these \textbf{neighborhoods}, they ' d be the same people.
...
And that, in some ways, was the best job you could hope to get if you were growing up in one of these \textbf{neighborhoods} as a young black male.
...
We found, in our gang — and admittedly, this was not really a standard situation ; this was a time of intense \textbf{violence}, of a lot of gang wars, as this gang actually became quite successful.
...
Let ' s say that you were a murderer and you were \textbf{convicted} of murder, and you ' re sent to death row.
It turns out, the death rates on death row from all causes, including execution : two percent a year.
So it ' s a lot safer being on death row than it is selling drugs out on the \textbf{street}.
That gives you some pause, for those of you who believe that a death penalty ' s going to have an \textbf{enormous} deterrent effect on crime.
...
And this is \textbf{violent} death — it ' s unbelievable, in some sense.
...
So why in the world, you might ask, would anybody be willing to stand out on a \textbf{street} corner selling drugs for \$3. 50 an hour, with a 25 percent chance of dying over the next four years?
...
They ' re talking about the decision of why they don ' t go shoot — One thing that turns out to be a great business tactic in the gang : if you go and just shoot guns in the air in the other gang ' s territory — people are afraid to go buy drugs there, they ' re going to come into your \textbf{neighborhood}.
...
We had some theories related to cash flow, and lack of \textbf{access} to capital markets, and things like that.
...
% matched lemmas: access, convict, enormous, neighborhood, street, violence, violent
\end{textsample}
