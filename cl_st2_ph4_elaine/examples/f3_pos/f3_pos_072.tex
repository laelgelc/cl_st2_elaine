\begin{textsample}{POS Dim 3 – 2003 – Score 10.00 – 2003/t000244.txt}  \label{ex:f3_pos_072}
...
The foremost is that if we ' re blank slates, then, by definition, we are \textbf{equal}, because zero \textbf{equals} zero \textbf{equals} zero.
But if something is written on the slate, then some people could have more of it than others, and according to this line of thinking, that would justify \textbf{discrimination} and inequality.
...
Whereas, if we ' re born with certain instincts, then perhaps some of them might condemn us to selfishness, \textbf{prejudice} and \textbf{violence}.
Well, in the book, I argue that these are, in fact, non sequiturs.
And just to make a long story short : first of all, the concept of \textbf{fairness} is not the same as the concept of sameness.
And so when Thomas Jefferson wrote in the Declaration of Independence,"We hold these truths to be self-evident, that all men are created \textbf{equal},"he did not mean"We hold these truths to be self- evident, that all men are clones."Rather, that all men are \textbf{equal} in terms of their rights, and that every person ought to be treated as an individual, and not prejudged by the statistics of particular groups that they may belong to.
...
When I wrote a first draft of the book, I circulated it to a number of colleagues for comments, and here are some of the reactions that I got :"Better get a security camera for your house.""Don ' t expect to get any more awards, job offers or positions in scholarly societies.""Tell your publisher not to list your hometown in your author bio.""Do you have tenure?"Well, the book came out in October, and nothing terrible has happened.
...
There are many cases, some of which I talk about in the book, of people who have been slandered, called Nazis, physically \textbf{assaulted}, threatened with criminal prosecution for stumbling across or arguing about controversial findings.
...
It ' s not \textbf{violence} and war, it ' s not race, it ' s not gender, it ' s not Marxism, it ' s not Nazism.
...
By any economic standard, the demand for art of all forms is skyrocketing, as you can tell from the price of \textbf{opera} tickets, by the number of books sold, by the number of books published, the number of musical titles released, the number of new albums and so on.
...
I feel like I could devote my life to figuring out what to play with my kids."I think anyone who ' s recently been a parent can sympathize with this mother.
...
Parents who talk a lot to their kids have kids who grow up to be articulate, parents who spank their kids have kids who grow up to be \textbf{violent} and so on.
And very few of them control for the possibility that parents pass on genes for — that increase the chances a child will be articulate or \textbf{violent} and so on.
...
Wrong.
Identical twins, or any \textbf{siblings}, who are separated at birth are no less similar than if they had grown up together.
...
A complementary finding, from a completely different methodology, is that adopted \textbf{siblings} reared together — the mirror image of identical twins reared apart, they share their parents, their home, their \textbf{neighborhood}, don ' t share their genes — end up not similar at all.
...
% matched lemmas: assault, discrimination, equal, fairness, neighborhood, nonprofit, opera, prejudice, sibling, violence, violent
\end{textsample}
