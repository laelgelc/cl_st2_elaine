\begin{textsample}{POS Dim 3 – 2015 – Score 14.00 – 2015/t001565.txt}  \label{ex:f3_pos_033}
Why do we cheat?
And why do happy people cheat?
And when we say"infidelity,"what exactly do we mean?
Is it a hookup, a love story, paid sex, a \textbf{chat} room, a massage with a happy ending?
...
I mean, many of you probably have said,"I am monogamous in all my relationships."We used to marry, and had sex for the first time.
...
Now, I like this definition of an affair — it brings together the three key elements : a secretive relationship, which is the core structure of an affair ; an emotional connection to one degree or another ; and a \textbf{sexual} alchemy.
...
We have a romantic ideal in which we turn to one person to fulfill an endless list of needs : to be my greatest lover, my best friend, the best parent, my trusted confidant, my emotional companion, my intellectual \textbf{equal}.
...
Now, I question everything."Infidelity — a violation of trust, a crisis of identity."Can I ever trust you again?"he asks."Can I ever trust anyone again?"And this is also what my patient Heather is telling me, when she ' s talking to me about her story with Nick.
Married, two kids.
Nick just left on a business trip, and Heather is playing on his iPad with the boys, when she sees a message appear on the screen :"Can ' t wait to see you."Strange, she thinks, we just saw each other.
And then another message :"Can ' t wait to hold you in my arms."And Heather realizes these are not for her.
...
And if divorce carried all the \textbf{shame}, today, choosing to stay when you can leave is the new \textbf{shame}.
So Heather, she can ' t talk to her friends because she ' s afraid that they will judge her for still \textbf{loving} Nick, and everywhere she turns, she gets the same advice : Leave him.
Throw the dog on the curb.
And if the situation were reversed, Nick would be in the same situation.
Staying is the new \textbf{shame}.
...
But what if \textbf{passion} has a finite shelf life?
...
At the heart of an affair, you will often find a longing and a yearning for an emotional connection, for novelty, for freedom, for autonomy, for \textbf{sexual} intensity, a wish to recapture lost parts of ourselves or an attempt to bring back vitality in the face of loss and tragedy.
...
But she also tells me that she ' s always done what was expected of her : good girl, good wife, good mother, taking care of her \textbf{immigrant} parents.
...
But the fact is that it seems that even when we have the freedom to have other \textbf{sexual} partners, we still seem to be lured by the power of the forbidden, that if we do that which we are not supposed to do, then we feel like we are really doing what we want to.
...
So how do we \textbf{heal} from an affair?
Desire runs deep.
Betrayal runs deep.
But it can be \textbf{healed}.
...
But I ' m not the one who did it."But now that the affair is exposed, they, too, get to claim more, and they no longer have to uphold the status quo that may not have been working for them that well, either.
I ' ve noticed that a lot of couples, in the immediate aftermath of an affair, because of this new disorder that may actually lead to a new order, will have depths of conversations with honesty and \textbf{openness} that they haven ' t had in decades.
...
We know from \textbf{trauma} that healing begins when the \textbf{perpetrator} acknowledges their wrongdoing.
...
But even more important, is to curb the curiosity to mine for the sordid details — Where were you?
Where did you do it?
How often?
Is she better than me in bed? — questions that only inflict more pain, and keep you awake at night.
...
And the dilemmas of love and desire, they don ' t yield just simple answers of black and white and good and bad, and \textbf{victim} and \textbf{perpetrator}.
Betrayal in a relationship comes in many forms.
There are many ways that we betray our partner : with contempt, with neglect, with indifference, with \textbf{violence}. \textbf{Sexual} betrayal is only one way to hurt a partner.
In other words, the \textbf{victim} of an affair is not always the \textbf{victim} of the marriage.
...
Now, I would no more recommend you have an affair than I would recommend you have cancer, and yet we know that people who have been \textbf{ill} often talk about how their illness has yielded them a new perspective.
...
I said,"Yes."I look at affairs from a dual perspective : hurt and betrayal on one side, growth and self-discovery on the other — what it did to you, and what it meant for me.
...
% matched lemmas: chat, equal, heal, ill, immigrant, loving, openness, passion, perpetrator, sexual, shame, trauma, victim, violence
\end{textsample}
